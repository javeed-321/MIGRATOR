...
**Example:** Dear user, your one-time password (OTP) is: \{\{otp_code\}\}. This OTP is valid for the next 10 minutes.

## SMS and Email template

<Callout kind="alert" title="Approval for SMS template">
...
<Image src="https://files.readme.io/b48302e-Flowchart.png" width="25%" height="1080" alt="" />
