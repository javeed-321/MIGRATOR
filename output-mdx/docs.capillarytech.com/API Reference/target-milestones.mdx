...
1. **Milestones**
   ...
   2. Unified milestone: Contains more than 1 target and they are linked together with arithmetic operations like:
...
To know how the target (and its downstream capabilities) works, it is advised to know about the following nuances for better and enhanced understanding. Following are the 4 major components involved here:
...
1. **Target group**
   ...
   2. This will have core properties associated with it like:
      1. Tracking type: Defines what is the nature of the tracking
         ...
         3. Streak
         4. Capping
      2. Start and End date on a whole
      3. Frequency
      4. The number of periods/cycles, etc...
2. **Periods/Cycle**
   1. This will have information on the timelines within which the tracking will happen.
      1. Will have the exact start and end date for each cycle of the target group.
   2. If the frequency and number of cycles are given as weekly, 3 in the target group level info, then this contains what is the exact start and end date for all the 3 cycles:
   ...
   3. A few points to note here are:
      ...
      3. No tracking will happen between point (x, a) and point (d, y). Tracking will always happen within cycles.
      4. <Image src="https://files.readme.io/34ca65052a646b4a5190e7aae8bc23e2ed9a0350b3ed97a72020d1030026cb9f-Screenshot_2024-11-04_at_11.32.00_AM.png" width="70%" height="1080" alt="" />
