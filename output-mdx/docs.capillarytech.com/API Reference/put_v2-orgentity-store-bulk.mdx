...
> | `timeZoneId`      | integer | Optional | [Unique ID](https://docs.capillarytech.com/reference/add-store#country-ids-by-timezone) representing the timezone of the store's geographical location. Example: `191` for Asia/Kolkata. | Yes       |
