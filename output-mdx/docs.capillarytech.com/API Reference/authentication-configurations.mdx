...
| CONF_FALLBACK_CHANNELS | Specifies the fallback communication channel to send the OTP. Supported values: any channel except the defined primary subchannel. See [Fallback channel ](https://docs.capillarytech.com/reference/authentication-configurations#fallback-channel)for more details. | * | Both |
