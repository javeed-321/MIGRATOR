...
| entity_code      | string    | Code of the specified entity_type. For example, to get transactions of a specific zone (with zone code zone01), pass entity_type=zone\ and entity_code=zone01.                                                                                                                                                                          |
...
| start_date       | date-time | Retrieves transactions made on or after a specific date (YYYY-MM-DD). To get transactions of a particular duration, use both start_date and end_date. Example: start_date=2013-12-21+23:45:45\ and end_date=2013-12-29+12:11:45                                                                                                        |
| end_date         | date-time | Retrieves transactions made on or before a specific date (YYYY-MM-DD). To get transactions of a particular duration, use both start_date and end_date. Example: start_date=2013-12-21+23:45:45\ and end_date=2013-12-29+12:11:45                                                                                                       |
