...
<CodeGroup tabs="Sample request,Sample response,Rolling window with includeStatistics=true,Fixed window with includeStatistics=true,Fixed window with includeStatistics=false,Rolling window with includeStatistics=false,Filter by Group ID,With issueId and includeStatistics=true">
