...
|                       |                                                                                     |
| :-------------------- | :---------------------------------------------------------------------------------- |
| URI                   | /api_gateway/intouch-api-v3/v3.1/users/347286146/targetGroups?includeInactive=true |
| HTTP method           | GET                                                                                 |
...
|     **targetEvaluationType**               | Enum             | The type of evaluation for the target group : <br />FIXED_CALENDAR_WINDOW <br />CYCLIC_WINDOW <br />PERIOD_AGNOSTIC_WINDOW <br />Refer to this [API documentation](https://docs.capillarytech.com/reference/create-target-groups#request-body-parameters) for more information.                       |
