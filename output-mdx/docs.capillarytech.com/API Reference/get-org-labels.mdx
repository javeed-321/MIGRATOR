...
| --- | --- | --- | --- |
| `Authorization` | Yes | `Bearer ` | Authentication token (JWT/OAuth). **Note**: The org ID is retrieved automatically based on the [till ID](https://docs.capillarytech.com/docs/basic-authentication-api#/using-till-id-and-password) associated with that organization. |
