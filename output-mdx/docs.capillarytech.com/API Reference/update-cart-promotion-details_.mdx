...
| ...identifiers      | Array  | Conditional | Lists exact payment identifiers. For example, [“VISA_CARD”]. Required when the type is `CARD` or `PAYMENT_VOUCHER`.                                                                                                                                                                                                                                                                            | Yes       |
...
| ...criteriaList        | Array  | Yes         | Defines which products or attributes are part of the condition. Example: Products where entity = PRODUCT_NAME and values = ["Paint Brush"]. You can specify up to 250 SKUs (values) in a single condition.          | Yes       |
...
This condition type combines payment using Points with a combo product condition. For example, "Buy Coke and ChocoBrand biscuit with Points payment mode, and get 50% off on Maggi noodles."
...
| ...type                        | Enum    | Yes         | Specifies how target products are grouped. Supported values: `PRODUCT`, `COMBO_PRODUCT`. Example: COMBO_PRODUCT targets combinations like Paint + Brush.                                                                                                                                                                                                                                                                                                                            | Yes       |
...
| .....criteriaList              | Array   | Yes         | Defines which products or attributes are included in the combo. Example: entity = PRODUCT_NAME, values = [“Paint Brush”].                                                                                                                                                                                                                                                                                                                                                          | Yes       |
...
| ...freeProductAction             | Object  | Conditional | Required when rewardAction.type is FREE_PRODUCT.                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                   | Yes       |
...
The brand wants to set up a cart promotion, "Any Large Pizza for $10," with conditions that if a customer buys any item from the "Large Pizzas" category, its price is set to $$10$ using a FIXED_PRICE reward action. The brand now wants to update the promotion to "Premium Burgers for $12," changing the target category to "Premium Burgers" and updating the fixed price value to $12.
...
| .......cycleReferenceDate              | Long            | Specifies the anchor date from which the N_DAY cycle is calculated. Time format: epoch milliseconds.                                                                                                          |
