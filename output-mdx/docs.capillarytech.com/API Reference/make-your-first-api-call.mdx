...
2. Select an API tool. Below are some suggested tools along with guidance on their usage:
   ...
   2. [https://docs.capillarytech.com/reference/make-your-first-api-call#getting-started-with-try-it-on-readme](https://docs.capillarytech.com/reference/make-your-first-api-call#getting-started-with-try-it-on-readme)
...
<Image src="https://files.readme.io/6eac91c-NEW_IMPORT_POSTMAN.gif" width="45%" height="1080" alt="" />
...
<Image src="https://files.readme.io/98d3529-AUTH.gif" width="40%" height="1080" alt="" />
...
<Image src="https://files.readme.io/1bcc2d0-Basic_auth.png" width="65%" height="1080" alt="" />
...
<Image src="https://files.readme.io/052a6df-Access_token.png" width="1920" height="1080" alt="" />
...
<Image src="https://files.readme.io/96735bf-Type.png" width="40%" height="1080" alt="" />
...
<Image src="https://files.readme.io/6209f2f-API_URL_text_box.png" width="1920" height="1080" alt="" />

5. (a) For **POST** and **PUT** methods, select **Body** tab >  **raw** and enter the body parameters.

<Image src="https://files.readme.io/78b078f-Body.png" width="50%" height="1080" alt="" />

(b)For **GET** / **DELETE** methods, select the **Parameters** tab and enter the query parameters.

<Image src="https://files.readme.io/076535e-GET.png" width="65%" height="1080" alt="" />

5. Click **Send**. The response is displayed on the interface.

<Image src="https://files.readme.io/c15b0f4-save.png" width="1920" height="1080" alt="" />
...
<Image src="https://files.readme.io/95dc9cb-save_as_ex.gif" width="40%" height="1080" alt="" />
...
<Image src="https://files.readme.io/cc7178f-Add_Icon.png" width="55%" height="1080" alt="" />

2. Click **Blank collection**. A new collection is created.

<Image src="https://files.readme.io/e728889-blank_collection.png" width="55%" height="1080" alt="" />

3. Click the three-dot menu, and click **Add a request**.

<Image src="https://files.readme.io/81ad138-Add_request.png" width="45%" height="1080" alt="" />

3. Enter the API information such as HTTP method, API endpoint, and authorization.

<Image src="https://files.readme.io/d408b15-Api_info.png" width="50%" height="1080" alt="" />
...
<Image src="https://files.readme.io/238811a-Add_transaction.png" width="65%" height="1080" alt="" />
...
<Image src="https://files.readme.io/8bb7517-Variable_file.png" width="1920" height="1080" alt="" />
...
<Image src="https://files.readme.io/f62a339-Response.png" width="45%" height="1080" alt="" />
...
<Image src="https://files.readme.io/77e6ae5-Readme_body_parameters.png" width="1920" height="1080" alt="" />
...
<Image src="https://files.readme.io/77866e6-RAW_BODY.png" width="1920" height="1080" alt="" />
...
<Image src="https://files.readme.io/3e55a0a-CURL_examples.png" width="1920" height="1080" alt="" />

To clear an example, select **Clear example**.

<Image src="https://files.readme.io/fab22ce-image.png" width="450px" height="1080" alt="" />

5. In the **URL**, enter the HOST URL.

<Image src="https://files.readme.io/9e19ada-Enter_HOST.png" width="1920" height="1080" alt="" />
...
<Image src="https://files.readme.io/df557a2-image.png" width="45%" height="1080" alt="" />
...
<Image src="https://files.readme.io/d997854-Readme_Authentication.png" width="1920" height="1080" alt="" />

8. Click  **Try it!** . The **Response** section displays the response.

<Image src="https://files.readme.io/a6cbd1a-image.png" width="450px" height="1080" alt="" />

To view other sample responses, click the **RESPONSE** drop-down. The drop-down displays the available example responses.

<Image src="https://files.readme.io/822414c-Response_example.png" width="45%" height="1080" alt="" />

### Testing API using ReadMe Try it

<Image src="https://files.readme.io/faa3d03-try_it-min.gif" width="1920" height="1080" alt="" />

### Viewing example in ReadMe

<Image src="https://files.readme.io/2d7952f-Example.gif" width="1920" height="1080" alt="" />
