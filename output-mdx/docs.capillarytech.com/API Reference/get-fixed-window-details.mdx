...
<CodeGroup tabs="Sample request,Sample response,when includeEarnCount=true and constraintType=ALL,when includeEarnCount= true and constraintType=CUSTOMER,when fixedWindowCycleReferenceId is passed">
