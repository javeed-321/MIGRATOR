...
| 40 API Sections | 99 v1 Endpoints | 77 v1.1 Endpoints | 233 v2 Endpoints | 25 v3 Endpoints | 33 Sections with v2 coverage |
| --- | --- | --- | --- | --- | --- |
...
| 6  | User Group and Fleet            | User group                                                                  | —  | —    | 15 | —  | v2 only        |
| 7  | Organisation Management       | Organization, Company                                                       | 7  | 7    | 12 | —  | v1 · v1.1 · v2 |
| 8  | Behavioural Events and Webhooks | Behavioural events, Event logs                                              | —  | —    | 8  | 3  | v2 · v3        |
| 9  | Requests and Workflows          | Requests, PII deletion                                                      | 6  | 7    | 8  | —  | v1 · v1.1 · v2 |
| 10 | OTP and Authentication          | OTP                                                                         | —  | —    | 3  | —  | v2 only        |
| 11 | Communication and Subscriptions | Communications                                                              | 4  | 4    | 1  | —  | v1 · v1.1 · v2 |
| 12 | Product Catalogue             | Product, Labels                                                             | 10 | 10   | 38 | —  | v1 · v1.1 · v2 |
| 13 | Leads and Partner Program       | Leads, Partner program                                                      | —  | —    | 17 | —  | v2 only        |
| 14 | Staff and Store Management      | Staff, Store                                                                | 9  | 9    | 13 | —  | v1 · v1.1 · v2 |
| 15 | Target Group and Milestones     | Target group                                                                | —  | —    | —  | 14 | v3 only        |
...
| 23 | Global Search and Simulation    | Global Search, Simulation                                                   | —  | —    | 2  | —  | v2 only        |
...
| Retrieve user group members list with cards and status details | v2      | GET    | `v2/userGroup2/members`                 | User Groups           |
| Retrieve Primary and Secondary Member Details                  | v2      | GET    | `v2/userGroup2`                         | User Groups           |
