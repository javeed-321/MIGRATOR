...
<CodeGroup tabs="curl,Update multiple attribute values,Update only name,Update at organization level">
...
<CodeGroup tabs="Tree structure,200 OK,400 Bad Request - Attribute value not found,400 Bad Request - Attribute code not found,207 Partial Success">
