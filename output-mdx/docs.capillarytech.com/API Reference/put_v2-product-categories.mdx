...
<CodeGroup tabs="curl,Update multiple categories,Update only name,Update only description">
...
<CodeGroup tabs="Tree structure,200 OK,400 Bad Request - Category not found,400 Bad Request - Parent code cannot be updated,207 Partial Success">
