...
|                        |                                                                                                                                  |
| :--------------------- | :------------------------------------------------------------------------------------------------------------------------------- |
| URI                    | /api_gateway/rewards/core/v1/reward/brand`\{brandId\}`/available?startDate=`{YYYY-MM-DDTHH:MMZ}`\ and endDate=`{YYYY-MM-DDTHH:MMZ}` |
| HTTP Method            | GET                                                                                                                              |
| Pagination             | No                                                                                                                               |
| Batch support          | No                                                                                                                               |
...
<CodeGroup tabs="curl,200 OK,400 Error: Incorrect format  of startDate or endDate">
