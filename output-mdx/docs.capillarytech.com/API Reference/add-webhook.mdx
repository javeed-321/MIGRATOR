...
| authMechanism | string | Defines the authentication mechanism (e.g., Basic). Supported values: BASIC — Basic authentication OAUTH — OAuth authentication. Mandoty is auth is enabled. |
