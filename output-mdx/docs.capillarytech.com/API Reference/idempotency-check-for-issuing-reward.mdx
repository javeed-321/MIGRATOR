...
* [Create Reward ](https://docs.capillarytech.com/reference/post-create-reward): Create reward using Payment Mode as **POINTS** and redemption value as **INTOUCH_POINTS**.
