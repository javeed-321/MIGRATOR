...
<CodeGroup tabs="Sample request,Sample response,No identifiers,with pointsawardedId + pointsAwardedRefType,with promotionId,with promtionIdentifier + programId,with programId">
