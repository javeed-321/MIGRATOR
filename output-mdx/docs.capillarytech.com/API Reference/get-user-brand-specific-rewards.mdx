...
|                        |                                                                                            |
| :--------------------- | :----------------------------------------------------------------------------------------- |
| URI                    | /api_gateway/rewards/core/v1/user/reward`{reward Id}`/brand`{brand name}`?userId=`\{id\}` |
| HTTP Method            | GET                                                                                        |
| Pagination             | No                                                                                         |
| Batch support          | No                                                                                         |
...
<CodeGroup tabs="curl,With userId,With category=accessories,With groupName=Most Preferred Rewards,With sortOnGroups=true,With 'altText' for images and videos">
