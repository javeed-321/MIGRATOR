...
<CodeGroup tabs="Sample request,Sample response,json,With Segment and Partition ID,With Cards,With Labels,With 'altText' for images and videos,With RichTextcontent,With Frequency restriction">
