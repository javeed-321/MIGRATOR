...
| pointCategoryType                                        | Specify the [point category type](https://docs.capillarytech.com/docs/dimension-tables#points-category) for which you want to fetch ledger details. Supported values: REGULAR, PROMISED, TRIGGER_BASED. By default, it fetches all the points category details.                                                                                                                                                                                                                                                                                                                                                                                                                 |
