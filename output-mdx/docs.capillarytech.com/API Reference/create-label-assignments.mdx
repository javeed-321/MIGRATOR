...
<Callout kind="info" title="Creation of new label">
...
<CodeGroup tabs="Single assignment,Assign to multiple entities,With label name and external ID">
...
<CodeGroup tabs="json,partial success,multiple assignments">
