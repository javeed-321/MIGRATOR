...
For Consumer-end customer applications, Capillary provides basic capabilities only, and recommends using External Customer Identity and Access Management tools for providing more convenient and advanced security features. For more information, refer to the [API Gateway Integration with CIAM Platforms](https://docs.capillarytech.com/v1.0/docs/api-gateway-integration-with-ciam-platforms).
