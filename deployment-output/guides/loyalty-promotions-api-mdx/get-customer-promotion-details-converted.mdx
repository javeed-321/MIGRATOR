...
<ParamField path="customerId" param-type="Long" required="true">
  Unique system-generated identifier of the customer.
</ParamField>

## Query parameters

<ParamField query="programId" param-type="Long" required="true">
  Unique identifier of the loyalty program. To retrieve the `programId`, use the [Get Loyalty Programs](https://docs.capillarytech.com/reference/get-loyalty-programs) API.
</ParamField>

<ParamField query="promotionId" param-type="Long" required="true">
  Unique identifier of the loyalty promotion. To retrieve the `promotionId`, use the [Get Details of all Loyalty Promotions](https://docs.capillarytech.com/reference/get-loyalty-promotion-all) API.
</ParamField>

<ParamField query="activityId" param-type="String">
  When provided, scopes the returned `incentives` and points to those associated with the specified activity. When omitted, all benefits across all activities are returned.
</ParamField>
...
<CodeGroup tabs="Customer with benefits,No benefits found">
...
<ParamField body="action" param-type="String" enum="REWARD,COUPONS,BADGES,ENROL,OPTIN,UPGRADE_TIER">
  Type of incentive action. Case-sensitive.
</ParamField>
...
<ParamField body="pointsCategory" param-type="String" enum="REGULAR_POINTS,BONUS_POINTS">
  Category of the points earned.
</ParamField>
...
<Expandable title="alternateCurrencies[]">
