...
> ## [Documentation Index](https://capilalry-demo.documentationai.com/docs/event-schema-loyalty-and-cart-promotions\#documentation-index)
>
...
## [Loyalty Promotions and Cart Promotions](https://capilalry-demo.documentationai.com/docs/event-schema-loyalty-and-cart-promotions\#loyalty-promotions-and-cart-promotions)

## [Loyalty Promotions](https://capilalry-demo.documentationai.com/docs/event-schema-loyalty-and-cart-promotions\#loyalty-promotions)
...
### [Creating loyalty promotion (promotionCreated)](https://capilalry-demo.documentationai.com/docs/event-schema-loyalty-and-cart-promotions\#creating-loyalty-promotion-promotioncreated)
...
Webhook payload-For Transaction Eventswith custom fieldsFor Generic Events(event name and id would be of generic event)For Target completed eventthere will be xtra field named linkedTargetGroupVsTargetRuleIdMapNon webhook payload
...
### [Updating a loyalty promotion (promotionUpdated)](https://capilalry-demo.documentationai.com/docs/event-schema-loyalty-and-cart-promotions\#updating-a-loyalty-promotion-promotionupdated)
...
### [Issuing a loyalty promotion (promotionIssued)](https://capilalry-demo.documentationai.com/docs/event-schema-loyalty-and-cart-promotions\#issuing-a-loyalty-promotion-promotionissued)
...
### [Earned loyalty promotion (promotionEarned)](https://capilalry-demo.documentationai.com/docs/event-schema-loyalty-and-cart-promotions\#earned-loyalty-promotion-promotionearned)
...
### [Revoke issued loyalty promotion (revokeIssuedPromotion)](https://capilalry-demo.documentationai.com/docs/event-schema-loyalty-and-cart-promotions\#revoke-issued-loyalty-promotion-revokeissuedpromotion)
...
### [Revoke earned loyalty promotion (revokeEarnedPromotion)](https://capilalry-demo.documentationai.com/docs/event-schema-loyalty-and-cart-promotions\#revoke-earned-loyalty-promotion-revokeearnedpromotion)
...
## [Cart Promotions](https://capilalry-demo.documentationai.com/docs/event-schema-loyalty-and-cart-promotions\#cart-promotions)
...
### [Cart Promotion Issued Event (cartPromotionIssued)](https://capilalry-demo.documentationai.com/docs/event-schema-loyalty-and-cart-promotions\#cart-promotion-issued-event-cartpromotionissued)
...
### [Cart Promotion Redeemed Event (cartPromotionRedeemed)](https://capilalry-demo.documentationai.com/docs/event-schema-loyalty-and-cart-promotions\#cart-promotion-redeemed-event-cartpromotionredeemed)
...
### [Cart Promotion Revoked Event (cartPromotionRevoked)](https://capilalry-demo.documentationai.com/docs/event-schema-loyalty-and-cart-promotions\#cart-promotion-revoked-event-cartpromotionrevoked)
...
### [Cart Promotion Earned Event (cartPromotionEarned)](https://capilalry-demo.documentationai.com/docs/event-schema-loyalty-and-cart-promotions\#cart-promotion-earned-event-cartpromotionearned)
