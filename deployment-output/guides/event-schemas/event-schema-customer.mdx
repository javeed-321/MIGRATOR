...
> ## [Documentation Index](https://capilalry-demo.documentationai.com/docs/event-schema-customer\#documentation-index)
>
...
## [Customer and User Group](https://capilalry-demo.documentationai.com/docs/event-schema-customer\#customer-and-user-group)

## [Customer](https://capilalry-demo.documentationai.com/docs/event-schema-customer\#customer)
...
### [Customer Added Event (customerAdded)](https://capilalry-demo.documentationai.com/docs/event-schema-customer\#customer-added-event-customeradded)
...
### [Customer Updated Event (customerUpdated)](https://capilalry-demo.documentationai.com/docs/event-schema-customer\#customer-updated-event-customerupdated)
...
#### [PII deletion Customer update](https://capilalry-demo.documentationai.com/docs/event-schema-customer\#pii-deletion-customer-update)
...
### [Customer Subscription Event (customerSubscription)](https://capilalry-demo.documentationai.com/docs/event-schema-customer\#customer-subscription-event-customersubscription)
...
## [Group](https://capilalry-demo.documentationai.com/docs/event-schema-customer\#group)
...
### [Group Created Event (groupCreated)](https://capilalry-demo.documentationai.com/docs/event-schema-customer\#group-created-event-groupcreated)
...
### [Group Updated Event (groupUpdated)](https://capilalry-demo.documentationai.com/docs/event-schema-customer\#group-updated-event-groupupdated)
...
### [Group Member Removed Event (groupMemberRemoved)](https://capilalry-demo.documentationai.com/docs/event-schema-customer\#group-member-removed-event-groupmemberremoved)
...
### [Group Member Added Event (groupMemberAdded)](https://capilalry-demo.documentationai.com/docs/event-schema-customer\#group-member-added-event-groupmemberadded)
...
### [Points Contribution to Group Event (pointsContributionToGroup)](https://capilalry-demo.documentationai.com/docs/event-schema-customer\#points-contribution-to-group-event-pointscontributiontogroup)
