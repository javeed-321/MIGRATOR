...
> ## [Documentation Index](https://capilalry-demo.documentationai.com/docs/event-schema-loyalty\#documentation-index)
>
> Fetch the complete documentation index at: [https://docs.capillarytech.com/llms.txt](https://docs.capillarytech.com/llms.txt)
> Use this file to discover all available pages before exploring further.

## [Loyalty](https://capilalry-demo.documentationai.com/docs/event-schema-loyalty\#loyalty)

## [Milestone (Targets) and Streaks](https://capilalry-demo.documentationai.com/docs/event-schema-loyalty\#milestone-targets-and-streaks)

This section contains the schemas of various milestones (also called targets) related event notifications. These will be sent to the respective brand's webhooks which brands can consume and use at their end.

**Supported event notifications are:**

01. Target Achieved Value Updated event
02. Target Value Updated event
03. Target Value Achieved event
04. Target period start
05. Target period end
06. Unified target achieved
07. Unified target un-achieved
08. Target enrollment
09. Streak level achievement
...
### [Target Achieved Value Updated event (targetAchievedValueUpdated)](https://capilalry-demo.documentationai.com/docs/event-schema-loyalty\#target-achieved-value-updated-event-targetachievedvalueupdated)
...
### [Target Value Achieved Event](https://capilalry-demo.documentationai.com/docs/event-schema-loyalty\#target-value-achieved-event)
...
### [Target Period Completed Event](https://capilalry-demo.documentationai.com/docs/event-schema-loyalty\#target-period-completed-event)
...
### [Target Value Update Event](https://capilalry-demo.documentationai.com/docs/event-schema-loyalty\#target-value-update-event)
...
### [Unified Target Achieved Event](https://capilalry-demo.documentationai.com/docs/event-schema-loyalty\#unified-target-achieved-event)
...
### [Unified Target Unachieved Event](https://capilalry-demo.documentationai.com/docs/event-schema-loyalty\#unified-target-unachieved-event)
...
### [Target Customer Enrolment Event (targetCustomerEnrolment)](https://capilalry-demo.documentationai.com/docs/event-schema-loyalty\#target-customer-enrolment-event-targetcustomerenrolment)
...
### [Target Customer Unenrolment Event (targetCustomerUnenrolment)](https://capilalry-demo.documentationai.com/docs/event-schema-loyalty\#target-customer-unenrolment-event-targetcustomerunenrolment)
...
### [Target Period Started Event (targetPeriodStarted)](https://capilalry-demo.documentationai.com/docs/event-schema-loyalty\#target-period-started-event-targetperiodstarted)
...
### [Streak Level Achievement Event (streakLevelAchieved)](https://capilalry-demo.documentationai.com/docs/event-schema-loyalty\#streak-level-achievement-event-streaklevelachieved)
...
### [Streak Level Unachievement Event (streakLevelUnAchieved)](https://capilalry-demo.documentationai.com/docs/event-schema-loyalty\#streak-level-unachievement-event-streaklevelunachieved)
...
### [Streak Enrolment Event (streakCustomerEnrolment)](https://capilalry-demo.documentationai.com/docs/event-schema-loyalty\#streak-enrolment-event-streakcustomerenrolment)
...
### [Streak unenrolment (streakCustomerUnEnrolment)](https://capilalry-demo.documentationai.com/docs/event-schema-loyalty\#streak-unenrolment-streakcustomerunenrolment)
...
### [Streak Start Event (streakStart)](https://capilalry-demo.documentationai.com/docs/event-schema-loyalty\#streak-start-event-streakstart)
...
### [Streak End Event (streakEnd)](https://capilalry-demo.documentationai.com/docs/event-schema-loyalty\#streak-end-event-streakend)
...
### [Event notification for the change in milestone achieved value on return of purchases](https://capilalry-demo.documentationai.com/docs/event-schema-loyalty\#event-notification-for-the-change-in-milestone-achieved-value-on-return-of-purchases)
...
## [Points](https://capilalry-demo.documentationai.com/docs/event-schema-loyalty\#points)
...
### [Points Issued Event (pointsIssued)](https://capilalry-demo.documentationai.com/docs/event-schema-loyalty\#points-issued-event-pointsissued)

Notifies when points are issued to a user.

| Parameter | Description |
| --- | --- |
| `-eventName` | Name of the event, e.g., "pointsIssued". |
| `-eventId` | Unique identifier for the event. |
| `-eventLogId` | Unique ID that is generated when the event is triggered. |
| `-orgId` | Unique identifier for the organisation. |
| `-refId` | This is a combination of org id and loyalty event ID and is used for internal debugging. |
| `-apiRequestId` | Identifier for the API request. |
| `-createdAt` | Timestamp when the event was created. |
| `-data` | Data related to the event. |
| `--customerIdentifiers` | Identifiers related to the customer. |
| `---customerId` | Unique identifier for the customer. |
| `--entityInformation` | Information about the entity involved in the event. |
| `---entityType` | Type of entity, e.g., "USER". |
| `---entityId` | Unique identifier for the entity. |
| `--triggeringActivity` | Details about the activity that triggered the event. Possible values: `NewBill`, `NewBillDVS`, `TransactionAdd`, `CustomerRegistration`, `PointsRedemption`, `VoucherRedemption`, `ReturnBill`, `TrackerConditionSuccess`, `TransactionFinished`, `CustomerUpdate`, `TransactionUpdate`, `SocialConnect`, `CampaignRefereeRedeem`, `CampaignReferral`, `CampaignReferralReferrer`, `IncomingSms`, `ReferralPostProcessing`, `SocialConnectUpdate`, `EmailOpen`, `EmailClick`, `VoucherPreRedemption`, `DelayedAccrual`, `Scan`, `GroupTransactionAdd`, `GroupTransactionUpdate`, `GroupReturnBill`, `GroupMemberJoin`, `GroupMemberLeave`, `GenericEvent`, `SlabUpgrade`, `ManualSlabAdjustment`, `PointsTransfer`, `TargetCompleted`, `PointsRedemptionReversal`, `PartnerProgramLinking`, `PartnerProgramTierUpdate`, `PartnerProgramDeLinking`, `TierReassessment`, `PointsContributionToGroup`, `UserGroup2Create`, `LineItemsPointsPromotionImport`, `CustomerPromotionImport`, `BillPointsPromotionImport`, `AllocateGoodwillPoints`, `ManualPointsAdjustment`, `ManualPointsConversion`, `ReturnTargetCompletedEvent`, `IssuePromotionForEntityEvent`, `EarnPromotionForEntityEvent`, `ConvertPointsToReward`, `BulkAllocatePoints`, `RevokeEarnPromotionEvent`, `RevokeIssuePromotionEvent`, `ManualCurrencyAllocation` |
| `---name` | Name of the triggering activity. |
| `---identifiers` | Identifiers related to the activity. |
| `----key` | Key identifier, e.g., "CustomerId". |
| `----value` | Value of the key identifier. |
| `---enteredBy` | User who entered the activity. |
| `----id` | Unique identifier for the user. |
| `----entityInformation` | Information about the entity involved in the event. |
| `-----entityType` | Type of entity, e.g., "USER". |
| `-----entityId` | Unique identifier for the entity. |
| `---additionalAttributes` | Additional attributes related to the activity. |
| `--loyaltyProgramDetails` | Details about the loyalty program. |
| `---id` | Unique identifier for the user. |
| `---tiers` | List of program tiers. |
| `----tierNumber` | Tier number, e.g., 1. |
| `----tierName` | Tier name, e.g., "Silver". |
| `--loyaltyProgramId` | Unique identifier for the loyalty program. |
| `--programCurrentPoints` | Current points in the loyalty program. |
| `--programLifetimePoints` | Lifetime points in the loyalty program. |
| `--totalPointsIssued` | Total points issued in the event. |
| `--regularPointsIssued` | Regular points issued in the event. |
| `--regularPointsBreakup` | Breakdown of regular points issued. |
| ---expiryAt | Expiry date of the points. This field will be replaced by expiryAtInMillis |
| ---expiryAtInMillis | Expiry date in the Unix epoch timestamp. |
| `--promotionalPointsIssued` | Promotional points issued in the event. |
| ---promotionPointsExpiryDate | Promotional points expry date. This field will be replaced by promotionPointsExpiryDateInMillis. |
| ---promotionPointsExpiryDateInMillis | Promotional points expry date in the Unix epoch timestamp. |
| `--promisedPointsIssued` | Promised points issued in the event. |
| ---promisedPointsConversionDate | Promoised points conversion date. This field will be replaced by promisedPointsConversionDateInMillis. |
| ---promisedPointsConversionDateInMillis | Promised points conversion date in the Unix epoch timestamp. |
| `--loyaltyEventId` | Identifier for the loyalty event. |
...
via transactionNon webhook payloadGood will points
...
### [Points Redeemed Event (pointsRedeemed)](https://capilalry-demo.documentationai.com/docs/event-schema-loyalty\#points-redeemed-event-pointsredeemed)
...
| \-\-\-\- entityType | String | Type of the entity (e.g., "USER", USERGROUP2). |
| \-\-\-\- entityId | Integer | Unique identifier for the entity. |
...
Webhook payloadPoints unlock APIDelayed accrual jobVia Transaction Add
...
### [Points Expired Event (pointsExpired)](https://capilalry-demo.documentationai.com/docs/event-schema-loyalty\#points-expired-event-pointsexpired)
...
| apiRequestId | String | Unique identifier for the API request. |
| eventSearchKey | String | The primary identifier used to search or filter the event. Supported fields: `customerIdentifiers.customerId` – Capillary's internal unique customer ID `customerIdentifiers.firstName` – First name of the customer `customerIdentifiers.lastName` – Last name of the customer `customerIdentifiers.instore.mobile` – Mobile number of the customer `customerIdentifiers.instore.email` – Email address of the customer `customerIdentifiers.instore.externalId` – External system identifier for the customer `customerIdentifiers.instore.cardnumber` – Loyalty card number of the customer `customerIdentifiers.instore.cardexternalid` – External identifier for the customer's loyalty card `customerIdentifiers.ecommerce.accounts[].identifiers` – Identifiers from linked e-commerce platform accounts `customerIdentifiers.facebook.accounts[].identifiers` – Identifiers from linked Facebook accounts `customerIdentifiers.wechat.accounts[].identifiers` – Identifiers from linked WeChat accounts `customerIdentifiers.web_engage.accounts[].identifiers` – Identifiers from linked WebEngage accounts `customerIdentifiers.line.accounts[].identifiers` – Identifiers from linked LINE accounts `customerIdentifiers.martjack.accounts[].identifiers` – Identifiers from linked Martjack accounts |
...
| \-\- loyaltyProgramDetails | Object | Contains details about the loyalty program. |
| \-\-\- id | Integer | Unique identifier for the loyalty program. |
| \-\-\- name | String | Name of the loyalty program (e.g., "DocDemoDefaultProgram"). |
| \-\-\- isDefault | Boolean | Indicates if the program is the default program. |
| \-\-\- pointsToCurrencyRatio | Float | Points-to-currency conversion ratio. |
| \-\-\- tiers | Array of Objects | List of tiers in the loyalty program. |
...
### [Points Expired Reminder Event (pointsExpiryReminder)](https://capilalry-demo.documentationai.com/docs/event-schema-loyalty\#points-expired-reminder-event-pointsexpiryreminder)
...
### [Points Transferred Initiated Event (pointsTransferredInitiated)](https://capilalry-demo.documentationai.com/docs/event-schema-loyalty\#points-transferred-initiated-event-pointstransferredinitiated)
...
### [Points Transferred Received (pointsTransferredReceived)](https://capilalry-demo.documentationai.com/docs/event-schema-loyalty\#points-transferred-received-pointstransferredreceived)
...
### [Redeemed Points Reversed Event (redeemedPointsReversed)](https://capilalry-demo.documentationai.com/docs/event-schema-loyalty\#redeemed-points-reversed-event-redeemedpointsreversed)
...
### [Updated Single Points Expiry (singlePointsExpiryUpdated)](https://capilalry-demo.documentationai.com/docs/event-schema-loyalty\#updated-single-points-expiry-singlepointsexpiryupdated)
...
### [Issued Points Reversed Event (issuedPointsReversed)](https://capilalry-demo.documentationai.com/docs/event-schema-loyalty\#issued-points-reversed-event-issuedpointsreversed)
...
### [Manual Points Adjustment Event (manualPointsAdjustment)](https://capilalry-demo.documentationai.com/docs/event-schema-loyalty\#manual-points-adjustment-event-manualpointsadjustment)

Notifies whenever points are adjusted/deducted manually.

Non webhook payloadVia thrift (API-Immediate)via Points Expiry Batch (Scheduled job)
...
### [Promised/External Points Conversion Event](https://capilalry-demo.documentationai.com/docs/event-schema-loyalty\#promisedexternal-points-conversion-event)
...
## [Alternate currencies](https://capilalry-demo.documentationai.com/docs/event-schema-loyalty\#alternate-currencies)
...
### [Alternate currencies issued (alternateCurrenciesIssued)](https://capilalry-demo.documentationai.com/docs/event-schema-loyalty\#alternate-currencies-issued-alternatecurrenciesissued)
...
### [Issued Alternate Currency Reversed (issuedAlternateCurrenciesReversed)](https://capilalry-demo.documentationai.com/docs/event-schema-loyalty\#issued-alternate-currency-reversed-issuedalternatecurrenciesreversed)
...
### [Promised Alternate Currencies Issued Event (promisedToCurrentAlternateCurrencyConversion)](https://capilalry-demo.documentationai.com/docs/event-schema-loyalty\#promised-alternate-currencies-issued-event-promisedtocurrentalternatecurrencyconversion)
...
## [Loyalty customer](https://capilalry-demo.documentationai.com/docs/event-schema-loyalty\#loyalty-customer)

### [Loyalty Customer Merge Event (loyaltyCustomerMerge)](https://capilalry-demo.documentationai.com/docs/event-schema-loyalty\#loyalty-customer-merge-event-loyaltycustomermerge)
