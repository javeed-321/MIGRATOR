...
> ## [Documentation Index](https://capilalry-demo.documentationai.com/docs/event-schema-incentives\#documentation-index)
>
...
## [Incentives](https://capilalry-demo.documentationai.com/docs/event-schema-incentives\#incentives)

## [Rewards](https://capilalry-demo.documentationai.com/docs/event-schema-incentives\#rewards)
...
### [Reward Created Event (rewardCreated)](https://capilalry-demo.documentationai.com/docs/event-schema-incentives\#reward-created-event-rewardcreated)
...
### [Reward Issued Event (rewardIssued)](https://capilalry-demo.documentationai.com/docs/event-schema-incentives\#reward-issued-event-rewardissued)
...
### [Reward Updated Event (rewardUpdated)](https://capilalry-demo.documentationai.com/docs/event-schema-incentives\#reward-updated-event-rewardupdated)
...
### [Issue Reward Failure Event (issueRewardFailure)](https://capilalry-demo.documentationai.com/docs/event-schema-incentives\#issue-reward-failure-event-issuerewardfailure)
...
### [Reward Expiry Reminder (rewardExpiryReminder)](https://capilalry-demo.documentationai.com/docs/event-schema-incentives\#reward-expiry-reminder-rewardexpiryreminder)
...
### [Update Reward Transaction (updateRewardTransaction)](https://capilalry-demo.documentationai.com/docs/event-schema-incentives\#update-reward-transaction-updaterewardtransaction)
...
## [Coupons](https://capilalry-demo.documentationai.com/docs/event-schema-incentives\#coupons)
...
### [Coupon Issue Event (CouponIssue)](https://capilalry-demo.documentationai.com/docs/event-schema-incentives\#coupon-issue-event-couponissue)
...
### [Coupon Redeem Event (CouponRedeem)](https://capilalry-demo.documentationai.com/docs/event-schema-incentives\#coupon-redeem-event-couponredeem)
...
### [Issue Bulk Coupon with Count (CouponIssue)](https://capilalry-demo.documentationai.com/docs/event-schema-incentives\#issue-bulk-coupon-with-count-couponissue)
...
## [Badges](https://capilalry-demo.documentationai.com/docs/event-schema-incentives\#badges)
...
### [Event notifications on earning a badge (badgeEarned)](https://capilalry-demo.documentationai.com/docs/event-schema-incentives\#event-notifications-on-earning-a-badge-badgeearned)
