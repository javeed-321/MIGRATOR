...
| **ENABLE\_GROUP\_PROGRAMS\_REDEMPTION** | Allows points redemption at the group level. Requires setting `group_redemption` to true and ensuring the loyalty workflow rule `currentEvent.isGroupProgramRedemption` is set to true. | Raise a ticket to the sustenance team. Changes may take up to 24 hours to reflect. [More info](https://docs.capillarytech.com/docs/create-a-multi-loyalty-program#faqs). |
| **ENABLE\_FLEET\_LOYALTY**              | Enables fleet loyalty features, such as point expiration and management for fleet or group users.                                                                                       | Raise a JIRA ticket to the sustenance team. [More info](https://docs.capillarytech.com/docs/group-loyalty#expire-points-for-group--fleet-users).                         |
      ...
      "post": {
        ...
        "x-readme": {
          "code-samples": [
            {
              "language": "curl",
              "code": "{curl --location 'https://eu.api.capillarytech.com/v2/points/userGroup2/isTransferrable' \\\n--header 'X-CAP-API-OAUTH-TOKEN*: eyJraWQiOiJrMSIsImFsZyI6IlJTMjU2In0..U8q0j6Ros4pR3es7jJ3n6JLCuki_C-Z2HXo0-YAGHFYHRluJPNdOMsqggHSF2g7ps1P1tQS1hn26GGOzYM66LmQmIxlVrqUrmy1i1gdOxF7tEYs0Y3ngTiubg-kYYiA5mfLS0XqyMloucmIyACixecRBaJMOlUoKJEOTHIfyq5JGtOSfwKHCqDuDHcEgiLOun0FvdXz44ofbcjeWNntq1z25Ac4gXA-5eACE89H5l_kQmv-UrZMZrnL7kXAyCnJ4Dz5RRf4X_tIeHsyFDutQiOqW3iUowpksVruYxuWXlUQCMb9P1MLgMEa9-m_eYd8ZZA9_haREVMbeRQB0RTsAEg' \\\n--header 'X-CAP-API-ATTRIBUTION-ENTITY-TYPE: INSTORE' \\\n--header 'X-CAP-API-ATTRIBUTION-ENTITY-CODE;' \\\n--header 'Content-Type: application/json' \\\n--header 'Authorization: Basic c2FudC5wXzEyMzmVhMGFhYWI1ZThmODg5ZTAzNGE2NjA5NTIwM2FlNw==' \\\n--header 'Cookie: _cfuvid=LvoffYWnKNroiGI4mcPHub.st6yK1dPDHOW3wI1lEls-1751478744816-0.0.1.1-604800000' \\\n--data '{\n    \"pointsTobeTransferred\": 1,\n     \"notes\": \"note1234\",\n    \"programId\": 973,\n    \"transferredBy\": {\n        \"identifierType\": \"id\",\n        \"identifierValue\": \"565345942\",\n        \"source\": \"INSTORE\",\n        \"accountId\": \"textgrp22\"\n    },\n    \"toEntity\": {\n       \"type\": \"USERGROUP2\",\n        \"identifierType\": \"id\",\n       \"identifierValue\": \"3847940\", \n        \"accountId\": 657659,\n        \"source\": \"INSTORE\"\n    },\n    \"fromEntity\": {\n        \"type\": \"CUSTOMER\",\n        \"identifierType\": \"id\",\n        \"identifierValue\": \"565345942\"\n    }\n}'",
