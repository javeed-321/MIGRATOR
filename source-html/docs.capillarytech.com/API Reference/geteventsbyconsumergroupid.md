...
<Table align={[null,null,"left",null]}>
  <thead>
    <tr>
      <th>
        Field
  ...
  <tbody>
    ...
    <tr>
      ...
      <td>
        Filter by delivery status. **Supported values:** ``IN_PROGRESS`
                                        `SUCCESS`, `PARTIAL_SUCCESS`, and `FAIL`.
      </td>
    </tr>
