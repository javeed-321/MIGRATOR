...
**Note:** All line item monetary fields (amount, rate, value, discount) in the request are rounded down to the number of decimal places specified by the AMOUNT\_ROUNDING\_OFF\_TO\_DECIMAL\_PLACES configuration.
...
**Note:** All monetary fields (amount, rate, value, discount) in the response are rounded down to the number of decimal places specified by the AMOUNT\_ROUNDING\_OFF\_TO\_DECIMAL\_PLACES configuration.
