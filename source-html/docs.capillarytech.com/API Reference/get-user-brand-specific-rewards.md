...
| .success                      | Boolean          | Indicates if the request was successful. Possible values: `true`, `false`.                                             |
...
| .id                           | Integer          | Specifies the unique identifier for the reward.                                                                        |
| .name                         | String           | Defines the name of the reward.                                                                                        |
| .description                  | String           | Provides a description of the reward.                                                                                  |
...
| .termAndConditionsId          | Object           | Defines the ID of the terms and conditions.                                                                            |
| .termAndConditionsUrl         | Object           | Specifies the URL for terms and conditions.                                                                            |
| .status                       | String           | Indicates the current status of the reward.                                                                            |
...
| .startTime                    | String           | Indicates the start time of the reward.                                                                                |
| .startDateTime                | String           | Indicates the start date and time of the reward.                                                                       |
| .endTime                      | String           | Indicates the end time of the reward.                                                                                  |
| .endDateTime                  | String           | Indicates the end date and time of the reward in ISO 8601 format.                                                      |
...
| .categoryList                 | Array of Objects | Specifies a list of categories associated with the reward.                                                             |
| ..id                          | Integer          | Specifies the unique identifier for the category.                                                                      |
| ..name                        | String           | Defines the name of the category.                                                                                      |
| ..enabled                     | Boolean          | Indicates if the category is enabled. Possible values: `true`, `false`.                                                |
| ..createdOn                   | Object           | Specifies the timestamp of creation.                                                                                   |
| ..lastUpdatedOn               | Object           | Specifies the timestamp of last update.                                                                                |
| ..createdBy                   | Object           | Specifies the ID of the user who created the category.                                                                 |
| ..lastUpdatedBy               | Object           | Specifies the ID of the user who last updated the category.                                                            |
| ..createdOnDateTime           | Object           | Indicates the creation date and time.                                                                                  |
| ..lastUpdatedOnDateTime       | Object           | Indicates the last updated date and time.                                                                              |
| .customFields                 | Object           | Defines a map of custom key-value pairs for the reward. The keys are dynamic strings, and the values are also strings. |
| .redemptionType               | String           | Specifies the redemption type.                                                                                         |
| .vendorId                     | Object           | Defines the vendor ID.                                                                                                 |
| .richContentRO                | Object           | Indicates the rich content information associated with the reward.                                                     |
| ...content                    | String           | Defines the content of the rich text.                                                                                  |
| ...isEnabled                  | Boolean          | Indicates if the rich content is enabled. Possible values: `true`.                                                     |
| .loyaltyProgramCriteria       | Array of Objects | Defines a list of supplementary criteria for the reward, specifically related to loyalty programs.                     |
| ..loyaltyProgramId            | Long             | Specifies the ID of the loyalty program.                                                                               |
| ..tierIds                     | Array of Strings | Defines a list of tier IDs associated with the loyalty program.                                                        |
| ..partnerProgramIds           | Array of Strings | Defines a list of partner program IDs associated with the loyalty program.                                             |
| .rewardRestrictions           | Object           | Contains various restrictions for the reward.                                                                          |
| ..isValid                     | Boolean          | Indicates if the reward restrictions are valid. Possible values: `true` , `false`                                      |
| .groups                       | Array of Objects | Defines a list of groups associated with the reward.                                                                   |
| ..groupName                   | String           | Specifies the name of the group.                                                                                       |
| ..groupRank                   | Integer          | Defines the rank of the group.                                                                                         |
| .rewardRank                   | Object           | Defines the rank of the reward.                                                                                        |
| .images                       | Object           | Specifies images associated with the reward.                                                                           |
| .videos                       | Object           | Specifies videos associated with the reward.                                                                           |
| .orgLevelRestrictions         | Object           | Defines organization-level restrictions for the reward.                                                                |
| ..isValid                     | Boolean          | Indicates if the organization-level restrictions are valid. Possible values: `true`, `false`                           |
| ..customerRedemptionTypeLevel | Array of Objects | Specifies a list of customer redemption type level restrictions.                                                       |
| ...rewardConstraintId         | Integer          | Specifies the unique identifier for the reward constraint.                                                             |
| ...orgId                      | Integer          | Specifies the organization ID.                                                                                         |
| ...kpi                        | String           | Defines the Key Performance Indicator for the constraint.                                                              |
| ...constraintLevel            | String           | Defines the level at which the constraint is applied.                                                                  |
| ...frequencyType              | String           | Specifies the frequency type of the constraint.                                                                        |
| ...constraintLimitValue       | Integer          | Defines the limit value for the constraint.                                                                            |
| ...isActive                   | Boolean          | Indicates if the constraint is active.                                                                                 |
| ...intervalValue              | Integer          | Specifies the interval value for the constraint.                                                                       |
| ...isValid                    | Boolean          | Indicates if the constraint is valid.                                                                                  |
| ...consumed                   | Integer          | Specifies the unit of reward consumed.                                                                                 |
| ...createdOn                  | Object           | Indicates the system generated date and time when the constraint was created.                                          |
| ...lastUpdatedOn              | Object           | Indicates the system generated date and time the constraint was last updated.                                          |
| ...createdBy                  | Object           | Specifies the system generated ID of the user who created the constraint.                                              |
| ...lastUpdatedBy              | Object           | Specifies the system generated ID of the user who last updated the constraint.                                         |
| ...createdOnDateTime          | Object           | Indicates the creation date and time.                                                                                  |
| ...lastUpdatedOnDateTime      | Object           | Indicates the last updated date and time.                                                                              |
| ...redemptionType             | String           | Specifies the redemption type associated with the constraint.                                                          |
...
```json
{
  ...
  "paths": {
    "/api_gateway/rewards/core/v1/user/reward/{reward Id}/brand/{brand name}?userId={id}": {
      "get": {
        "summary": "Get available reward details for user by id",
        "description": "",
                          ...
                          "properties": {
                            ...
                            "Testing-richtestcontent": {
                              ...
                              "properties": {
                                "content": {
                                  "type": "string",
                                  "example": "hello this is rich content test"
                                },
                                "isEnabled": {
                                  "type": "boolean",
                                  "example": true,
        ...
        "x-readme": {
          "code-samples": [
            {
              "language": "curl",
              "code": "curl --location 'https://eu.api.capillarytech.com/api_gateway/rewards/core/v1/user/reward/355104/brand/DOCDEMO?userId=565039504' \\\n--header 'Authorization: Basic Z2VvcmdlLmpvaG5zb246OTg4OTU2NWI4ODVhMmY4ZWE1MTk1MjA2NWEwYTEzNzg=' \\\n--header 'Cookie: _cfuvid=5A9H65nLTjshWYFwlD4Eez8KP6Aqj84z4mKabXwAVuo-1732602816001-0.0.1.1-604800000; _cfuvid=MglQfT4Gdb3DhzjEkJBQ_6vSB3xcEJLuBpENxVTO3GQ-1745904637618-0.0.1.1-604800000'"
            }
          ],
          "samples-languages": [
            "curl"
