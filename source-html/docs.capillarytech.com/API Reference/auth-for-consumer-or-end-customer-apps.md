...
For more information about customer-facing app authentication, see [Authentication configurations](https://docs.capillarytech.com/v1.0/reference/authentication-configurations).
