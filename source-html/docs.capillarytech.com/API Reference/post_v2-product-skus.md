...
| `ouCode`          | string | Optional    | Specifies the concept code of the organisation unit. This is applicable only if OU support for product inventory is enabled. For more information, see <Anchor label="OU support for product inventory" target="_blank" href="https://docs.capillarytech.com/docs/inventory-profiles?isFramePreview=true#configuring-organisation-unit-ou-support-for-product-entities">OU support for product inventory</Anchor>. |
