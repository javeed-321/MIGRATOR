...
This API generates card numbers in bulk for a specific card series. Generated cards have a status NOT\_ISSUED, and you can assign or issue them to customers later.
