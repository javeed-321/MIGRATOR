...
For more information and other optional configurations, refer to [External ID configuration](https://docs.capillarytech.com/docs/customer_entity#external-id-configuration).
