...
* For group redemptions, the transacting customer (`{id}`) must be an active member of a UserGroup2 group with the `allow_points_redemption` permission. Use the [Update permissions API](https://docs.capillarytech.com/reference/update-user-group-permission) to grant this permission.
