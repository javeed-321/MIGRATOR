...
<Table align={["left","left","left"]}>
  ...
  <tbody>
    ...
    <tr>
      ...
      <td>
        Identifier for the organization issuing the badge.
      </td>
    </tr>
    ...
    <tr>
      ...
      <td>
        Description of what the badge represents or how it can be earned.
      </td>
    </tr>
    ...
    <tr>
      ...
      <td>
        Timestamp indicating when the badge becomes available.
      </td>
    </tr>
    ...
    <tr>
      ...
      <td>
        Timestamp indicating when the badge becomes available, in ISO 8601 format, returned in the server time zone.     

        EU server example 2026-03-31T18:30:00Z → 31 March 2026, 18:30:00 (UTC)   

        India server example 2026-03-31T23:59:59+05:30 → 31 March 2026, 23:59:59 (IST)    
    ...
    <tr>
      ...
      <td>
        Timestamp indicating when the badge offer expires.
      </td>
    </tr>
    ...
    <tr>
      ...
      <td>
        Timestamp indicating when the badge offer expires, in ISO 8601 format, returned in the server time zone.  

        EU server example 2026-05-29T18:29:59Z → 29 May 2026, 18:29:59 (UTC).    

        India server example 2026-05-29T23:59:59+05:30 → 29 May 2026, 23:59:59 (IST)    
    ...
    <tr>
      ...
      <td>
        Name associated with the badge image.
      </td>
    </tr>
    ...
    <tr>
      ...
      <td>
        Handle for the file service managing the badge images.
      </td>
    </tr>
    ...
    <tr>
      ...
      <td>
        URL where the badge image is stored.
      </td>
    </tr>
    ...
    <tr>
      ...
      <td>
        Type of earning associated with the badge (e.g., 'ISSUE_EARN').
      </td>
    </tr>
    ...
    <tr>
      ...
      <td>
        Constraints specific to customers for earning the badge.
      </td>
    </tr>
    ...
    <tr>
      ...
      <td>
        Badge constraints associated with the badge.
      </td>
    </tr>
    ...
    <tr>
      ...
      <td>
        Number of times the badge has been earned, if applicable.
      </td>
    </tr>
    ...
    <tr>
      ...
      <td>
        Indicates whether the badge meta is currently active or not.
      </td>
    </tr>
    ...
    <tr>
      ...
      <td>
        A list of custom fields associated with the badge.
      </td>
    </tr>
    ...
    <tr>
      ...
      <td>
        Specifies the ownership rule for the module.
      </td>
    </tr>
    ...
    <tr>
      ...
      <td>
        Specifies the owner by whom the badge has been claimed.
      </td>
    </tr>
    ...
    <tr>
      ...
      <td>
        Date and time when the triggering event occurred, initiating the badge earning, in ISO 8601 format, returned in the server time zone.  

        EU server example 2026-01-27T06:24:15Z → 27 January 2026, 06:24:15 (UTC)  

        India server example 2026-01-27T11:54:15+05:30 → 27 January 2026, 11:54:15 (IST)  
    ...
    <tr>
      ...
      <td>
        Date and time when the badge was awarded to the customer, in ISO 8601 format, returned in the server time zone.
