...
<Table align={["left","left","left"]}>
  ...
  <tbody>
    ...
    <tr>
      ...
      <td>
        Defines detailed condition rules based on the <Anchor label="tender" target="_blank" href="https://docs.capillarytech.com/reference/create-cart-promotion-api#when-the-promotions-action-type-is-tender">tender</Anchor> payment type.
      </td>
    </tr>
    ...
    <tr>
      ...
      <td>
        Defines the key metric used for the restriction.
      </td>
    </tr>
    ...
    <tr>
      ...
      <td>
        Defines the maximum allowed value for the restriction.
      </td>
    </tr>
    ...
    <tr>
      ...
      <td>
        Defines the type of limit window applied to the restriction.
      </td>
    </tr>
    ...
    <tr>
      ...
      <td>
        Defines the cycle configuration for the restriction when `windowType` is `FIXED`.
      </td>
    </tr>
    ...
    <tr>
      ...
      <td>
        Defines the type of fixed cycle.
      </td>
    </tr>
    ...
    <tr>
      ...
      <td>
        Defines the start day of the weekly cycle when `cycleType` is `WEEK`.
      </td>
    </tr>
    ...
    <tr>
      ...
      <td>
        Defines the number of days per cycle when `cycleType` is `N_DAY`.
      </td>
    </tr>
