...
```json
{
  ...
  "paths": {
    "/api_gateway/v1/badges/customer/earnBulk": {
      "post": {
        "summary": "Issue badge to multiple customers",
        "description": "",
              ...
              "application/json": {
                ...
                "schema": {
                  "oneOf": [
                      ...
                      "properties": {
                        "data": {
                          ...
                          "properties": {
                            "badgeMetaId": {
                              "type": "string",
                              "example": "653de334b3cda7078c7c68eb"
                            },
                            "triggeredBy": {
                              "type": "object",
                              "properties": {
                            ...
                            "issuedBadges": {
                              ...
                              "items": {
                                ...
                                "properties": {
                                  ...
                                  "issuedId": {
                                    "type": "string",
                                    "example": "661681a535bc684e9e72553a"
                                  },
                                  "error": {}
                                }
                              }
                    ...
                    {
                      "title": "Failure: Badge Overlapping",
                      "type": "object",
                      "properties": {
                        "data": {
                          "type": "object",
                          "properties": {
                            "badgeMetaId": {
                              "type": "string",
                              "example": "66f3be92a8647e03dc526a5f"
                            },
                            "triggeredBy": {
                              "type": "object",
                              "properties": {
                            ...
                            "issuedBadges": {
                              ...
                              "items": {
                                ...
                                "properties": {
                                  ...
                                  "issuedId": {
                                    "type": "string",
                                    "example": "66f3bf91c7bf1e4d65e126b1"
                                  },
                                  "error": {
                                    "type": "object",
                                    "properties": {
                                      ...
                                      "message": {
                                        "type": "string",
                                        "example": "An active issue for the badge already exists."
                                      },
                                      "reference": {}
                                    }
                                  },
          ...
          "409": {
            ...
            "content": {
              "application/json": {
                "examples": {
                  "Result": {
                    "value": "{\n    \"data\": null,\n    \"errors\": [\n        {\n            \"code\": 810,\n            \"message\": \"BadgeMeta needs to be claimed first\",\n            \"reference\": null\n        }\n    ],\n    \"warnings\": null\n}"
                  }
                },
                "schema": {
                  "type": "object",
                    ...
                    "errors": {
                      ...
                      "items": {
                        ...
                        "properties": {
                          ...
                          "message": {
                            "type": "string",
                            "example": "BadgeMeta needs to be claimed first"
                          },
                          "reference": {}
                        }
                      }
            ...
            "application/json": {
              "schema": {
                ...
                "properties": {
                  "badgeMetaId": {
                    "type": "string",
                    "description": "Unique identifier (\"id\") generated during the creation of the badge."
                  },
                  "customerId": {
                    "type": "number",
                  ...
                  "requestId": {
                    "type": "string",
                    "description": "Enter a unique identifier to identify the request."
                  },
                  "earnEventDate": {
                    "type": "string",
                    "format": "date",
                    "description": "Defines the date on which the customer performed the activity. This date can be set up to 24 hours in the future from the current time, which allows badges to be earned based on when the customer's action occurred, not just when the system processes it.\n* The earn event date has to be between the badge start date and end date if it is a direct earn type of badge.\n* The earn event date has to be set between the badge issual start date and end date if it is an issue & earn type of badge.\n* You can enter a past date to issue a badge against an older transaction.\n* This field will be deprecated in the future and is being replaced by earnEventDateISO."
                  },
                  "earnEventDateISO": {
                    "type": "string",
                  ...
                  "triggeredBy": {
                    "type": "object",
                    "description": "The object containing information about what triggered the action.",
                    "required": [
                      "ownerType",
                      "referenceId"
                    ],
                    "properties": {
                      "ownerType": {
                        ...
                        "description": "The module for which the badge is being issued. Supported values: Loyalty, Loyalty_Promotion, Referral_Campaigns, Journeys, Audience_Campaigns, Rewards_Catalog, Goodwill_Module, Milestones, Historical_Import"
                      },
                      "referenceId": {
                        "type": "string",
                        "description": "Enter a unique identifier to identify the owner (ownerType). The referenceId passed here should be the same as the referenceId in the claim badge API."
                      }
                    }
                  },
                  "issueEventDate": {
                    "type": "string",
                    "description": "Specifies when the badge issuance event happened, in ISO 8601 format, including the region offset. (Optional: defaults to current time). For example, the badge issuance event happened at 14:30:45 on December 16, 2025, in India. Format for the request parameter: 2025-12-16T14:30:45+05:30. Note: The response time zone always matches the server time zone, regardless of the time zone offset in the request."
                  }
                }
              },
              "examples": {
        ...
        "x-readme": {
          "code-samples": [
            {
              "code": "curl --location 'https://eu.api.capillarytech.com/api_gateway/v1/badges/customer/earnBulk' \\\n--header 'Accept: application/json' \\\n--header 'Content-Type: application/json' \\\n--header 'accept: application/json' \\\n--header 'Authorization: Basic bWFkaHVI3MjU2YQ==' \\\n--header 'Cookie: _cfuvid=3_WeBHaCOoCMTu1WOqEmbpgNdxbEJfshHYOAHt8Pluk-1769690097065-0.0.1.1-604800000' \\\n--data '{\n    \"badgeMetaId\": \"68d66ab3480b423e5c6857f4\",\n    \"customerIds\": [\n        87654,74672,27864\n    ],\n    \"requestId\": \"3785468349\",\n    \"issueEventDate\": \"2025-10-29T21:51:00.192Z\",\n    \"triggeredBy\": {\n        \"ownerType\": \"Loyalty\",\n        \"referenceId\": \"823626\"\n    }\n}'",
              "language": "shell",
              "name": "Sample request"
            }
          ],
