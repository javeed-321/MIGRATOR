...
This API allows you to enable the language metadata for rewards for your organization.
...
```json
{
  ...
  "info": {
    "title": "Sample API",
    "version": "1.0.0",
    "description": "API specification generated from cURL for PUT /api_gateway/rewards/core/v1/metadata/language/12/status/enable"
  },
  "servers": [
    {
      "url": "https://{host}"
  ...
  "paths": {
    "/api_gateway/rewards/core/v1/metadata/language/{languagecode}/status/enable": {
      "put": {
        "summary": "Operation for PUT /api_gateway/rewards/core/v1/metadata/language/12/status/enable",
        "description": "Endpoint for PUT /api_gateway/rewards/core/v1/metadata/language/12/status/enable",
