...
```json
{
  ...
  "info": {
    ...
    "description": "API to fetch customer tracker details.",
    "version": "1.0.0"
  },
  "servers": [
    {
  ...
  "paths": {
    "/v2/customers/{customerId}/trackers": {
      "get": {
        "summary": "Get Customer Tracker Details",
        "description": "Fetches tracker details for a specific customer.",
        "security": [
          {
            "BasicAuth": []
          }
        ...
        "responses": {
          "200": {
            "description": "Tracker details retrieved successfully.",
            "content": {
              "application/json": {
                "schema": {
                  "type": "object",
