...
<Table align={["left","left","left","left"]}>
  ...
  <tbody>
    <tr>
      ...
      <td>
        Defines the unique identifier for the attribute. Maximum 30 characters are supported. Codes are validated case-insensitively. For example, "ATTRIBUTE1" and "attribute1" are treated as duplicates.  The same code can exist for different organizational units (ouCode).
      </td>
    </tr>
    ...
    <tr>
      ...
      <td>
        Specifies an ID of an existing attribute value to be set as the default.
      </td>
    </tr>
    ...
    <tr>
      ...
      <td>
        Creates an attribute value with this code and sets it as the default value in a single API call. Maximum 30 characters. If the value exceeds this limit, the attribute is created but the default value is not set, and warning code 10252 is returned.
      </td>
    </tr>
  </tbody>
</Table>
