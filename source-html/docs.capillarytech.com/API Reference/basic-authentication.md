...
This page provides you wit information on how to authenticate the APIs using basic authentication.
...
<Image align="center" className="border" border={true} src="https://files.readme.io/edb2a2f-image.png" />
