...
Returns reminders of all tasks.
  ...
  "paths": {
    "/task/reminder": {
      "get": {
        ...
        "description": "Returns reminders of all tasks.",
        ...
        "x-readme": {
          "code-samples": [
            {
              "language": "curl",
              "code": "https://eu.api.capillarytech.com/v1.1/task/reminder?format=xml&only_for_stores=true",
