...
Use this API to retrieve **product attribute values** configured for your organisation. Attribute values represent the **allowed options** for a product attribute, such as *Cotton* and *Polyester* for a *Material* attribute, or *Red* and *Blue* for a *Colour* attribute.

* Fetch attribute values in bulk across the organisation.
* Retrieve values for specific attributes using **attribute codes**.
* Search attribute values by code using the first few words of the code.
* Include **default (possible) values** for an attribute when retrieving a single attribute.
* Paginate through large sets of attribute values.
* Filter attribute values by organisation unit (OU) when OU support is enabled.
* Control the fetch scope using `ALL`, `ORG`, or `SCOPE`.

The response includes attribute metadata, associated value definitions, attribution details, and pagination information.
...
<Table align={["left","left","left","left"]}>
  ...
  <tbody>
    <tr>
      ...
      <td>
        Searches product attributes by their code. This returns product attributes whose names start with the specified query string. • If provided with entityCodes or entityIds, a warning is returned and the other filters are ignored. • Case-insensitive; supports UTF-8 characters. • Maximum 30 characters.
      </td>
    </tr>
    ...
    <tr>
      ...
      <td>
        A single or comma-separated list of product attributes `code. Use the code parameter from the response of the [Add Product attribute API](https://docs.capillarytech.com/reference/add_product_attributes_v2).Used when `q` parameter is not provided.
    ...
    <tr>
      ...
      <td>
        A single or comma-separated list of product attribute `id`. Use the value of the `id` parameter from the response of the [Add Product attribute API](https://docs.capillarytech.com/reference/add_product_attributes_v2).Example: 1999, 2000
    ...
    <tr>
      ...
      <td>
        Includes the default values for the attribute in the response. Only works when retrieving a single product attribute using `entityCodes` or `entityIds`. If multiple are passed, the API applies it to the first one and issues a warning. Default: false
      </td>
    </tr>
    ...
    <tr>
      ...
      <td>
        Maximum number of attributes to include when includeValues=true.  
        Default: 10.
    ...
    <tr>
      ...
      <td>
        Number of default attribute values to skip when includeValues=true. Default: 0.
      </td>
    </tr>
    ...
    <tr>
      ...
      <td>
        Maximum number of product attributes to retrieve.
    ...
    <tr>
      ...
      <td>
        Number of product attributes to skip from the beginning of the result set. Use for pagination.
      </td>
    </tr>
    ...
    <tr>
      ...
      <td>
        Field to sort by. Supported values: `id`, code. Default: `id`.
      </td>
    </tr>
    ...
    <tr>
      ...
      <td>
        Organization unit code. Use to filter product attributes by organizational unit when OU support is enabled.
      </td>
    </tr>
    ...
    <tr>
      ...
      <td>
        Scope of product attributes to fetch. Supported Values: ALL (master org and OU), ORG (master org only), SCOPE (OU only).
      </td>
    </tr>
  </tbody>
</Table>
...
```json
{
  "openapi": "3.0.0",
  "info": {
    "title": "Get Product Attribute Values",
    "version": "1.0.0"
  },
  "servers": [
    {
  ...
  "paths": {
    "/v2/product/attributes/{attributeId}/values": {
      "get": {
