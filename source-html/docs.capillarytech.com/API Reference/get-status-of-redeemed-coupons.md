...
```json
{
  ...
  "paths": {
    "/upload/getUploadRedeemedCouponStatus/{couponSeriesId}": {
      "get": {
        "summary": "Get Status of Redeemed Coupons",
        "description": "Retrieves the status of the uploaded coupon redeem job a coupon series.",
        "operationId": "get-status-of-redeemed-coupons",
        "parameters": [
          {
            "name": "couponSeriesId",
            "in": "query",
            "description": "The ID of coupon series for which the user wants to know the redeem status.",
            "required": true,
            "schema": {
              "type": "integer",
              "format": "int64"
        ...
        "responses": {
                        ...
                        "redeemUploadJobStatuses": {
                          ...
                          "items": {
                            ...
                            "properties": {
                              ...
                              "errorFileUrl": {
                                "type": "string",
                                "example": "error_redemption_upload_1619_2532342020_10_20_14_17_00"
                              },
                              "successFileUrl": {},
                              "uploadedFileUrl": {
                                "type": "string",
                                "example": "couponCode_1603183613031_253234.csv"
                              },
                              "totalUploadedCount": {
                                "type": "integer",
                                "example": 1,
                              ...
                              "uploadTableName": {
                                "type": "string",
                                "example": "temp_redemption_upload_1619_20201020_141700172"
                              },
                              "uploadedFileName": {
                                "type": "string",
                                "example": "couponCode_1603183613081_259234.csv"
                              }
                            }
                          }
                        }
          ...
          "500": {
            ...
            "content": {
              "text/plain": {
                "examples": {
                  "Unable to post or retrieve details": {
                    "value": ""
                  }
                }
              }
        ...
        "x-readme": {
          "code-samples": [
            {
              "language": "shell",
              "code": "curl --location 'https://eu.api.capillarytech.com/coupon/api/v1/upload/getUploadRedeemedCouponStatus/760779' \\\n--header 'Content-Type: application/json' \\\n--header 'X-CAP-API-OAUTH-TOKEN: eyJraWQiOiJrMSIsImFsZyI6IlJTMjU2In0..C0TAQcsFoNYBJoDCL01C0-XUFStZDZr5yz8Shdyk7rcl5u8FdzQy1mNBm2cdfV5rl-2MSSO0iFvdxa5aSI2sk8yfGZWV8qAAmO7r8j6L9yE9pO5Srnvminn22FiWvvOPq9_edpTF4M2cGaLQjAuPNuLoLJkDd48EhEhFnm5SKwR2ep7hiYvx148uETGS6MhpF0m-5PmgIVjwo4eVxMocz7pKyUpdFFJ83-j6BY6Zf9Jx7gg_JuIkc7S0cTFNGjtQkZuy7iVPvEi91YP3fTtoeaAljcLoFRBxs1h4P2CAFOkW_CxuOi-_Z2mqPBXZpEl1pq82kWtA6Pr3G519oWLpew' \\\n--header 'Authorization: Basic bWFkaHVfcMjU2YQ==' \\\n--header 'Cookie: _cfuvid=VRspa.rJGymgxf5EqRzslLCpNcfrx2TzDI_DJwB3nco-1762837407045-0.0.1.1-604800000'",
              "name": "Sample Request"
            }
          ],
          "samples-languages": [
