...
Contact Capillary Support to enable `CONF_ALLOW_CAMPAIGN_AND_VICTIM_USER_IDENTIFIER_REUSE` for your organisation. </Callout>
...
The identifier you want to add must be unique across the source (for single-account sources) or unique across the account (for multi-account sources). </Callout>
