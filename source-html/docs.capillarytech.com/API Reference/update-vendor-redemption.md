...
|                        |                                                                                    |
| :--------------------- | :--------------------------------------------------------------------------------- |
| URI                    | /api\_gateway/rewards/core/v1/vendor/redemption/`{redemptionId}`/brand/`{brandId}` |
| HTTP Method            | PUT                                                                                |
| Pagination             | No                                                                                 |
| Batch support          | No                                                                                 |
    ...
    <tr>
      ...
      <td>
        ...
        **VENDOR_ONLY_REWARD**`: These are either points or coupons created at the vendor end.  
                                                                `**VENDOR_INTOUCH_REWARD**`: These are vendor rewards created at the Capillary end. It's not recommended to use `VENDOR_INTOUCH_REWARD`instead, use `VENDOR_ONLY_REWARD` to issue coupons directly through the vendor API.
      </td>
    </tr>
