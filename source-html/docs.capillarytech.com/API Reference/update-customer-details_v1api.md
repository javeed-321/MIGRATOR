...
You can define certain attributes in the API header section and define the <Anchor label="user context details" target="_blank" href="https://docs.capillarytech.com/reference/add-customer#/adding-user-context-details">user context details</Anchor>.
