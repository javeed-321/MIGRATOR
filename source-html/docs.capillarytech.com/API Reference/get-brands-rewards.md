...
```json
{
  ...
  "paths": {
    "/api_gateway/rewards/core/v1/reward/brand/{brand Id}": {
      "get": {
        "summary": "Get brand rewards",
        "description": "",
        ...
        "x-readme": {
          "code-samples": [
            {
              "language": "curl",
              "code": "https://eucrm.cc.capillarytech.com/api_gateway/rewards/core/v1/reward/brand/1"
            }
          ],
          "samples-languages": [
            "curl"
