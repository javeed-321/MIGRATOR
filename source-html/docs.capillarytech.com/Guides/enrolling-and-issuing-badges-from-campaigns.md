...
<Image align="center" className="border" border={true} src="https://files.readme.io/0cc73a5-Screenshot_2024-04-22_at_5.22.03_PM.png" />

2. Navigate to the **Creatives+Incentives** section and click on **Add Incentives > Enrol Badge**.

<Image align="center" className="border" border={true} src="https://files.readme.io/8f5ef76-Screenshot_2024-04-22_at_5.22.56_PM.png" />
...
<Image align="center" className="border" border={true} src="https://files.readme.io/b9da429-Screenshot_2024-04-22_at_5.27.21_PM.png" />
...
<Image align="center" className="border" width="60% " border={true} src="https://files.readme.io/18988fa-Screenshot_2024-04-22_at_5.31.28_PM.png" />

**Note:** Adding an expiry label is not required for badges that do not have an expiry.

<Image align="center" className="border" width="60% " border={true} src="https://files.readme.io/cc4516c-Never_Expiry_badges_in_campaign.gif" />
...
<Image align="center" className="border" border={true} src="https://files.readme.io/c236fb1-Screenshot_2024-04-23_at_2.17.29_PM.png" />

2. Navigate to the **Creatives+Incentives** section and click on **Add Incentives > Issue Badge**.

<Image align="center" className="border" border={true} src="https://files.readme.io/526866b-Screenshot_2024-04-23_at_2.17.43_PM.png" />
...
<Image align="center" className="border" border={true} src="https://files.readme.io/4613992-Screenshot_2024-04-23_at_2.18.09_PM.png" />
...
<Image align="center" className="border" border={true} src="https://files.readme.io/ffffc39-Screenshot_2024-04-23_at_2.18.43_PM.png" />