...
This page provides you with information on analysing the performance of the dataflow created.
...
<Image align="center" className="border" border={true} src="https://files.readme.io/3bc6a18-Analyse_error.png" />
...
<Image align="center" className="border" border={true} src="https://files.readme.io/8e4ed6f-Overall_performance.png" />
...
<Image align="center" className="border" border={true} src="https://files.readme.io/c85f412-Blockwise_summary.png" />
...
<Image align="center" className="border" border={true} src="https://files.readme.io/e1a8da3-Error_summary.png" />
...
<Image align="center" className="border" width="55% " border={true} src="https://files.readme.io/f2df261-Error_tab.png" />
...
<Image align="center" className="border" width="45% " border={true} src="https://files.readme.io/a0d3896-Report.png" />
