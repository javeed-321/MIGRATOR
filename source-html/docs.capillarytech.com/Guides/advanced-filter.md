...
2. Click **Advanced Filter**.
   ...
   <Image align="center" className="border" width="100% " border={true} src="https://files.readme.io/5b9def1-Advanced_filter_Button.png" />
...
<Image align="center" className="border" width="25% " border={true} src="https://files.readme.io/95c60ec-KPI_Dropdown.png" />
...
<Image align="center" className="border" width="25% " border={true} src="https://files.readme.io/0ab9909-Dimensions_Dropdown.png" />

5. Click **Apply**.

<Image align="center" className="border" width="75% " border={true} src="https://files.readme.io/1c661ae-Total_Screen.png" />
