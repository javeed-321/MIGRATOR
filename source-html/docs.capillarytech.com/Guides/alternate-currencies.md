...
<Image align="center" className="border" border={true} width="80% " src="https://files.readme.io/d7eeb8b-Screenshot_2024-02-28_at_3.45.26_PM.png" />
...
<Image align="center" className="border" border={true} width="60% " src="https://files.readme.io/29c8219-Desktop_-_493.jpg" />

<Image align="center" className="border" border={true} width="60% " src="https://files.readme.io/f4dc0f7-Frame_717605.jpg" />
...
6. Enter the required details needed to create the currency:
   ...
   6. Redeemability of Alternate Currency: Alternate currencies can only be earned. Redeeming alternate currencies is not supported.
   ...
   8. Reward currency conversion: Similar to the feature in points, each Alternate Currency can also be assigned a conversion value.
7. Click **Done**.

<Image align="center" className="border" border={true} width="60% " src="https://files.readme.io/fdbe716-Screenshot_2024-08-07_at_12.41.46_PM.png" />
...
<Image align="center" className="border" border={true} src="https://files.readme.io/db33b61-Desktop_-_409.jpg" />
...
2. Alternate currencies can be issued for customer activities such as AddTransaction, Milestone/Streak is updated (also called as Target period elapsed), and Generic events.
   1. The conditions (Earn, Expiry, Return) configured for points can also be applied to the distribution of Alternate Currencies.
      ...
      2. All proration types supported for points, including **Proportional to Value** with **Line Item Quantity** as the base value (prorate on quantity), are also available for alternate currencies.
...
<Image align="center" className="border" border={true} width="60% " src="https://files.readme.io/ac710fd-24471_frame.jpg" />

<Image align="center" className="border" border={true} width="60% " src="https://files.readme.io/bea8fcc-25127_frame.jpg" />
...
<Image align="center" className="border" border={true} width="60% " src="https://files.readme.io/611b4f9-25791_frame.jpg" />
...
8. Click on "Save" to create the tracker
   ...
   <Image align="center" className="border" border={true} width="80% " src="https://files.readme.io/60a5a80-Milestone_-_Option-2_1.jpg" />
...
<Image align="center" className="border" border={true} src="https://files.readme.io/5ae5ded-Screenshot_2024-04-19_at_3.52.49_PM.png" />
...
<Image align="center" className="border" border={true} width="95% " src="https://files.readme.io/5b2dd76-Screenshot_2024-04-19_at_2.02.19_PM.png" />

**Preview of using the above tracker for renewal check:**

<Image align="center" className="border" border={true} width="95% " src="https://files.readme.io/0410ae7-Screenshot_2024-04-19_at_2.03.12_PM.png" />
