...
**Q19: Why do shortened links in my messages sometimes appear broken?**

A: This can happen when the destination URL contains parentheses ( ). Links with parentheses may not shorten or track correctly, causing recipients to see a broken link. To prevent this, remove or replace any parentheses in your URL before adding it to your message.
