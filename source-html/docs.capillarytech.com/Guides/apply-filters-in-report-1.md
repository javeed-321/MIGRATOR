...
<Image className="border" width="smart" border={true} src="https://files.readme.io/ec375b0-as.jpg" />
...
<Image className="border" width="smart" border={true} src="https://files.readme.io/fb3fb3f-kKV6Dzsv4wI_K0Tr6m-0U4_v6vr3vg1tMg.jpg" />

3. Click on the desired attribute. You will see the values of that attribute as shown below.

<Image className="border" width="smart" border={true} src="https://files.readme.io/f9ca500-2lXSh-Mcdr4MoJ30s1Pe_pufcQznD31cMA.jpg" />
...
<Image className="border" width="smart" border={true} src="https://files.readme.io/5492deb-DBhJbg41ocVh_O9ju1c09Ry1UpMc6T-ahQ.jpg" />
