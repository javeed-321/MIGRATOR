...
<Image className="border" width="smart" border={true} src="https://files.readme.io/584cc5f-K3eBK5DjzlUHbK7AKrIXZ6CcfXvcp8h9NA.png" />
...
<Image className="border" width="smart" border={true} src="https://files.readme.io/9aedea2-chLgAlpamFjo0daFoFUyY7tWSEBVehRzMA.png" />

5. The message status will be changed based on the message delivery schedule.

<Image className="border" width="smart" border={true} src="https://files.readme.io/f4d60d3-5OCtsrapO3W--bg7qVu2DxrWFsn7BTFoaA.png" />