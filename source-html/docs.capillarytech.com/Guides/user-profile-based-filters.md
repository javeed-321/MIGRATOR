...
<Image align="center" border={true} width="smart" src="https://files.readme.io/90ab173-HXLB6hNS5rzjWhVI9OABTMtEhWfG2Q4Zjw.png" className="border" />
...
<Image align="center" border={true} width="smart" src="https://files.readme.io/23df1c7-JpT1S66CXBNrQBIAKR7LwWiVZW_GFtLK4A.png" className="border" />
...
<Image align="center" border={true} width="smart" src="https://files.readme.io/26552ab-MyZD_Ops_kEmt-3JHn1Wd9jCDw26D7BnjQ.png" className="border" />
...
<Image align="center" border={true} width="smart" src="https://files.readme.io/3248c94-mpcdzRe4q7oSrdqETad2G54uFRn4He_32Q.png" className="border" />
...
<Image align="center" border={true} width="smart" src="https://files.readme.io/f194dc0-C6hV1-FyUwr6mHejfpiIz_x0BACzpbjvNg.png" className="border" />
...
> **Important**
>
> Only user (user\_cf) and invoice (inv\_cf) custom fields are supported for filtering during audience creation. Store (store\_cf) custom fields may appear in the filter list but are not supported. If you select a store\_cf field, it is not applied to the audience group.

<Image align="center" border={true} src="https://files.readme.io/6740a56-dV00fFAWrCHw-mnQ9zcXLs5CkyCFs_IfyA.png" className="border" />
...
<Table align={["left","left"]}>
  ...
  <tbody>
    <tr>
      ...
      <td>
        You can retrieve an audience list based on their custom field values. Only user (user_cf) and invoice (inv_cf) custom fields are supported for filtering. Store (store_cf) custom fields are visible but cannot be used to filter your audience.
...
<Image align="center" border={true} width="smart" src="https://files.readme.io/988c4e9-u2gLUWzdmt46WcF3J__ONwCoyh5vne8q8A.png" className="border" />
...
<Image align="center" border={true} width="smart" src="https://files.readme.io/54506c6-9g5JNQsteogZGEdUgxX2vquJdhg8JIafMg.png" className="border" />
...
<Image align="center" border={true} width="smart" src="https://files.readme.io/4a62e2f-NyPvUG0wU0N_uvCmuK91jXrjG6Pvz347ow.png" className="border" />
