...
In this section, you will find details on how to enable and integrate Single Sign-On (SSO).
...
> 👍 Get in touch with   <access@capillarytech.com> for enabling and integrating SSO.
...
<Image align="center" className="border" width="50% " border={true} src="https://files.readme.io/5b6f1ed-Enable_SSO.png" />
...
<Image align="center" className="border" width="50% " border={true} src="https://files.readme.io/4d5eb2d-SAML.png" />
...
<Image align="center" className="border" border={true} src="https://files.readme.io/a4dc3c1-Attributes.gif" />
...
<Image align="center" className="border" border={true} src="https://files.readme.io/1d7a707-Profile_Attributes.gif" />
...
<Image align="center" className="border" border={true} src="https://files.readme.io/2c79f0e-Mapping.gif" />
...
<Image align="center" className="border" border={true} src="https://files.readme.io/15f2f6a-Routing_rules.gif" />
...
<Image align="center" className="border" width="30% " border={true} src="https://files.readme.io/a5697f3-SSO_login.png" />

# Disabling SSO

To disable SSO,  navigate to  **Organisation settings > Authentication configurations** and clear the **Enable Single Sign On (SSO)** check box. If you do not have access to organisation settings, send an e-mail to \`<access@capillarytech.com>.
