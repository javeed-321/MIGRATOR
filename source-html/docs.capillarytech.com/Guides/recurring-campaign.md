...
<Image align="center" border={true} width="65% " src="https://files.readme.io/e59a4539f849f48341482b375ecd2f093c8f92e321c904a7c0e22db6d4a33824-image.png" className="border" />
...
* Ensure that the uploaded audience file includes the <Anchor label="custom tags" target="_blank" href="https://docs.capillarytech.com/docs/custom-tags#/">custom tags</Anchor> for each user. If the custom tags are missing, the campaign message will be skipped for those users.
...
<Image align="center" border={true} width="65% " src="https://files.readme.io/0af9d0044bce7fe63ac441e845331eec4dc72be7d577764fae0cbc0ac1ef3366-Screenshot_2025-08-06_at_12.21.40_PM.png" className="border" />

2. On the Messages listing page, select the campaign recurring message you want to edit.

<Image align="center" border={true} width="65% " src="https://files.readme.io/838e3c73679ea5eec9a140993ca32a3f9a810d7f92389f14b92adf7f571478b4-Screenshot_2025-08-06_at_12.23.05_PM.png" className="border" />
...
<Image align="center" border={true} width="65% " src="https://files.readme.io/10926895cd04113e7caf271557f2d8e5511dea1e3143b3cc4e37986c51a70b11-Connected_Orgs_4.gif" className="border" />
...
<Image align="center" border={true} width="65% " src="https://files.readme.io/fdfff3b9ab7aa960942863210031d1d03a12a1862fb62cf081d45885251de5d8-Connected_Orgs_5.gif" className="border" />
...
<Image align="center" border={true} width="65% " src="https://files.readme.io/bcf6047bd1c626560eb1d8559dc57d9c840b7de32bb3d6fde5fa09d822805ad5-Connected_Orgs_6.gif" className="border" />