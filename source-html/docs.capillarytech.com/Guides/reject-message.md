...
<Image className="border" width="smart" border={true} src="https://files.readme.io/312c719-s5pQWw7RNmQJxLoxYwfAn7eWa5rmLhn2Rg.png" />
...
<Image className="border" width="smart" border={true} src="https://files.readme.io/a18da6b-19GC5pywDvy3F6EzvFihtgrWMYleed6XZA.png" />

5. The message status will be changed based on the message delivery schedule.

<Image className="border" width="smart" border={true} src="https://files.readme.io/0915c63-5QcavmMbpd2FiQsjG7Df2xOQY-jG-Di6gA.png" />