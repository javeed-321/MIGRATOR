...
<Image align="center" className="border" border={true} src="https://files.readme.io/ed6d8d3-Search_customer.gif" />

By default, if enabled, when you open Member Care, the application opens the new Member Care UI.

<Image align="center" className="border" width="smart" border={true} src="https://files.readme.io/dfe3269-1.gif" />
...
<Image align="center" className="border" border={true} src="https://files.readme.io/e4c005a-Switch_to_new_UI.png" />

Also, from the old UI, if you click **Customer Search** the customer search opens in the new UI.

<Image align="center" className="border" border={true} src="https://files.readme.io/7bf007a-3.gif" />
...
<Image align="center" className="border" border={true} src="https://files.readme.io/6c42392-Switch_to_Old_member_care.gif" />
