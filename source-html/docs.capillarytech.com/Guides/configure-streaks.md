...
<Image align="center" className="border" width="90% " border={true} src="https://files.readme.io/344bbbd-Screenshot_2024-08-05_at_6.24.15_PM.png" />
...
1. Activate/Deactivate: A streak can be activated/deactivated depending on the use case by clicking on the 3-dot symbol at the end of each row.
   1. <Image align="center" className="border" width="70% " border={true} src="https://files.readme.io/885ff53-Screenshot_2024-08-05_at_6.24.34_PM.png" />
...
<Image align="center" className="border" border={true} src="https://files.readme.io/e484b7d-Bandges_-_Listing_page_and_its_interaction_310.jpg" />
...
<Image align="center" className="border" border={true} src="https://files.readme.io/3f92a4b-Bandges_-_Listing_page_and_its_interaction_311.jpg" />
...
<Image align="center" className="border" border={true} src="https://files.readme.io/9c057ad-Streaks_creation_flow19.jpg" />
...
<Image align="center" className="border" width="70% " border={true} src="https://files.readme.io/4520336-Screenshot_2024-04-09_at_4.45.01_PM.png" />
...
<Image align="center" className="border" width="70% " border={true} src="https://files.readme.io/cf3cde6-Screenshot_2024-04-09_at_4.44.30_PM.png" />
...
1. **All other customer level activities:** Helps in tracking how many times the various customer level activities/events (aka different customer level events present in the workflow in the loyalty) are triggered for a user in the defined period as per the configuration. The following are the supported customer activities:
   ...
   1. 1. Points redemptions
      ...
      10. Milestones achieved: This type of tracking is available only during the creation of a fixed-calendar window (aka where a specific start date is selected) type of milestones and helps in tracking how many times a user has achieved a specific target group.
          ...
          2. <Image align="center" className="border" width="60% " border={true} src="https://files.readme.io/b3c0858-Screenshot_2024-08-05_at_3.23.30_PM.png" />
...
<Image align="center" className="border" width="70% " border={true} src="https://files.readme.io/00fd85e-Screenshot_2024-04-09_at_4.44.38_PM.png" />

**An eagle-eye view of the above looks like this:**

<Image align="center" width="80% " src="https://files.readme.io/442813e-Screenshot_2024-04-18_at_11.55.39_AM.png" />
...
<Image align="center" className="border" width="100% " border={true} src="https://files.readme.io/5d64aa9-Streaks_creation_flow19_5.jpg" />

<Image align="center" className="border" width="100% " border={true} src="https://files.readme.io/a54950c-Streaks_creation_flow19.png" />

<br />

<Image align="center" className="border" width="100% " border={true} src="https://files.readme.io/bb5d8f4-Streaks_creation_flow19_1.png" />

**Upload duration**

You can click **Upload duration** and add the duration details in the sample template format provided.

<Image align="center" className="border" width="60% " border={true} src="https://files.readme.io/2553759-Upload_duration.png" />
...
<Image align="center" className="border" border={true} src="https://files.readme.io/61b0db7-Screenshot_2024-04-09_at_8.27.52_PM.png" />
...
<Image align="center" className="border" width="100% " border={true} src="https://files.readme.io/c8f6ccf-Screenshot_2024-04-09_at_8.28.11_PM.png" />
...
<Image align="center" className="border" width="80% " border={true} src="https://files.readme.io/1c0a772-Screenshot_2024-04-09_at_8.28.23_PM.png" />
...
<Image align="center" className="border" width="60% " border={true} src="https://files.readme.io/6577cd6-Continous_streaks.jpeg" />
...
<Image align="center" className="border" width="55% " border={true} src="https://files.readme.io/47638e5-Non_cont_streak.jpeg" />
...
<Image align="center" className="border" width="90% " border={true} src="https://files.readme.io/6d2ef25-Screenshot_2024-08-05_at_6.25.44_PM.png" />
