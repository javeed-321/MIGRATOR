...
<Image align="center" className="border" border={true} src="https://files.readme.io/4ec70a6-ZFmbTFxjASFoxKVsk_j4lMxJBPRi3VOQrQ.png" />
...
<Image align="center" className="border" border={true} src="https://files.readme.io/5ebf2d4-sBgxkEgmLOkpPr44vrXfL6rch3ztVqHm6Q.png" />
...
> 📘 Note:
>
> If your organization has enabled the new timezone display setting, expiry dates are shown in your local timezone. If your local timezone is behind your organization's timezone, the expiry date may appear as the previous day. The system still stores the correct end-of-day expiry, but the display may differ due to timezone conversion.
...
<Image align="center" className="border" border={true} src="https://files.readme.io/3a69ea8-64a6mDRBo03_QUNoiqzgAb34j_ftSdFn-w.png" />
...
<Image align="center" className="border" border={true} src="https://files.readme.io/9578670-T9_e0DFg77McJ74xwkn-lir3u_ehtiFvfg.png" />
...
<Image align="center" className="border" border={true} src="https://files.readme.io/bc14012--M6f2OihuU8O7ZyfZ7myDLDKU1F0qi7Ciw.png" />
...
<Image align="center" className="border" border={true} src="https://files.readme.io/84e6692-eYHCAQm2KkGGYZhSNiWTyhQWExP298pgcA.png" />

<Image align="center" className="border" border={true} src="https://files.readme.io/5c9c287--pkBXE3SDvCRzVPntivf5C8NVQz5FetnRA.png" />
...
> 📘 Note:
>
> If your organization has enabled the new timezone display setting, coupon expiry dates are shown in your local timezone. If your local timezone is behind your organization's timezone, the expiry date may appear as the previous day. The system still stores the correct end-of-day expiry, but the display may differ due to timezone conversion.
...
<Image align="center" className="border" width="smart" border={true} src="https://files.readme.io/f530e6f-h1C14R2_7syecrBdGTC2m0jAAbAaoChBbA.png" />
...
<Image align="center" className="border" width="smart" border={true} src="https://files.readme.io/1b7eb8d--p_eWyzOdVjZsS5DhPHwpEFg0ioukvJTeA.png" />