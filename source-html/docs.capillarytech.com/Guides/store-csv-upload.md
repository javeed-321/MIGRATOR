...
# Upload Store Data in User Event
...
<Image align="center" border={true} src="https://files.readme.io/65c6856-small-9.png" className="border" />
...
<Image align="center" alt="Note: You can either select the stores from the drop-down or upload with the help of csv. Both cannot be done simultaneously." border={true} caption="Note: You can either select the stores from the drop-down or upload with the help of csv. Both cannot be done simultaneously." src="https://files.readme.io/b144b83-small-11.png" />
