...
<Image align="center" className="border" border={true} src="https://files.readme.io/7ddfec5-Add_Audience_group.png" />

3. In the **Audience Group** list, search and select the audience group by name.

<Image align="center" className="border" border={true} src="https://files.readme.io/6453ba4-Select_Audience_Group.png" />
...
<Image align="center" className="border" border={true} src="https://files.readme.io/ef2d1a6-Audience_Group_Info.png" />

5. Click **Done** to apply changes. The applied audience groups are displayed at the top of the report.

<Image align="center" className="border" border={true} src="https://files.readme.io/ea32756-Applied_Audiences.png" />
...
<Image align="center" className="border" border={true} src="https://files.readme.io/25f7be0-Product_Type.png" />
