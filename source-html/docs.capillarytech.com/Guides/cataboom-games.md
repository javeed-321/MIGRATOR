...
<Image align="center" className="border" width="45% " border={true} src="https://files.readme.io/308d1b2-Screenshot_2023-08-14_at_4.35.06_PM.png" />
...
<Image align="center" className="border" width="65% " border={true} src="https://files.readme.io/0534335-image5.png" />
...
<Image align="center" className="border" width="50% " border={true} src="https://files.readme.io/afa1c38-image14.png" />
...
<Image align="center" className="border" border={true} src="https://files.readme.io/5963d8c-image8.png" />

4. Click **Campaigns** to create new games.  You can also search for existing games.

<Image align="center" className="border" width="75% " border={true} src="https://files.readme.io/5b049e2-image1.png" />
...
<Image align="center" className="border" width="75% " border={true} src="https://files.readme.io/18c6ef9-image6.png" />

7. Click **Create**.\
   The campaign is created.
8. Configure the game as required.

<Image align="center" className="border" width="60% " border={true} src="https://files.readme.io/1771f22-image9.png" />

<Image align="center" className="border" width="65% " border={true} src="https://files.readme.io/bbad9db-image13.png" />

<Image align="center" className="border" width="65% " border={true} src="https://files.readme.io/c4f0551-image11.png" />

<Image align="center" className="border" width="65% " border={true} src="https://files.readme.io/b6109cc-image10.png" />

<Image align="center" className="border" width="65% " border={true} src="https://files.readme.io/7b5c9db-image12.png" />

Once you click on the game URL, the following screens will appear based on the configuration:\*\*

Optional screen:

<Image align="center" className="border" width="300px" border={true} src="https://files.readme.io/d5d0855-image2.png" />

Game screens

<Image align="center" className="border" width="300px" border={true} src="https://files.readme.io/7e83b10-image15.png" />

<Image align="center" className="border" width="300px" border={true} src="https://files.readme.io/9e34b6f-image4.png" />

Fulfillment form to share the rewards

<Image align="center" className="border" width="300px" border={true} src="https://files.readme.io/26ea31a-image7.png" />

<Image align="center" className="border" width="60% " border={true} src="https://files.readme.io/2ba12a9-image16.png" />
...
* These will be raised directly to <support@cataboom.com>
