...
<Image align="center" className="border" border={true} src="https://files.readme.io/c0a90cc-Tier_edit.png" />

4. Select **edit** icon.
5. In **Edit tier**, enable **Validity**.

<Image align="center" className="border" border={true} src="https://files.readme.io/fcf9110-Validity.png" />
...
<Image align="center" className="border" border={true} src="https://files.readme.io/3a5ce61-Tier_downgrade_Image_1.png" />
...
<Image align="center" className="border" border={true} src="https://files.readme.io/f444684-Extend_available_points_to_next_cycle.png" />