...
<Image align="center" alt=" " border={true} width="75% " src="https://files.readme.io/60b4a3de118488ccf31fc8f81dd0d691b934e829929b835a784ac5a5c8c97a5c-FLOWCHART_7.png" className="border" />
...
## Step 1: Configure referral code
...
<Image align="center" border={true} src="https://files.readme.io/262457b-Screenshot_2024-06-18_113333.png" className="border" />
...
<Image align="center" border={true} src="https://files.readme.io/7f41069-Screenshot_2024-06-18_122013.png" className="border" />
...
<Image align="center" border={true} src="https://files.readme.io/1528ff8-custom_string.png" className="border" />
...
<Image align="center" border={true} src="https://files.readme.io/013adf2-Screenshot_2024-06-18_124332.png" className="border" />
...
<Image align="center" border={true} src="https://files.readme.io/ed6b994-Screenshot_2024-06-18_135318.png" className="border" />
...
<Image align="center" border={true} src="https://files.readme.io/31fb8c8-Screenshot_2024-06-24_130325.png" className="border" />
...
## Step 2: Configure referral campaign details
...
<Image align="center" border={true} src="https://files.readme.io/31313fc05c6c0826b9ea98335dbb8c8b278c48425ab21fcb9767ed89fdde26ec-image7.png" className="border" />

3. Select **Open old campaign manager**.

<Image align="center" border={true} src="https://files.readme.io/0186aef6b94081469abfbc530e735357dd41ec546ea8fd19cd37e6f39e63538e-image5.png" className="border" />

4. Select **+New Campaign** from the **Campaigns Home** page.

<Image align="center" border={true} src="https://files.readme.io/f3e1651b98deb5bb1c87e24b3348a0b8e7dff7809b0e5b85e68589dab7162256-image2.png" className="border" />
...
## Step 3: Configure message (post referral)
...
<Image align="center" border={true} src="https://files.readme.io/c9f19451ea1ae13c1d81d3022997851cffb0386d5a257121bc1b92aacdf1243f-image4.png" className="border" />

7. Select **Edit Message**to begin editing the subject and text message.

<Image align="center" border={true} src="https://files.readme.io/22adaee0c593166e30b4649730de195ea9142c4df37a77861d89c4805e713aee-image6.png" className="border" />
...
<Image align="center" border={true} src="https://files.readme.io/de449552b062416c3605598ccd8d18b58710a2950851b7dcf8322dec1736ccb1-image.png" className="border" />
...
| Term                     | Definition                                                                                                                                                                                                                                                                                                                       |
| ------------------------ | -------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------- |
| **Referee Registration** | The action when a new customer (referee) signs up or joins using the referral link or code shared by an existing customer (referrer). You can set a limit on the number of referee registrations eligible for incentives. For example, if the limit is set to 10, incentives are awarded when 10 referees complete registration. |
| **Referee Transaction**  | The qualifying purchase or transaction made by the referee after successful registration through a referral.You can set a limit on the number of referee transactions eligible for incentives. For example, if the limit is set to 10, incentives are awarded when 10 qualifying transactions are completed by referees.         |

<Image align="center" border={true} src="https://files.readme.io/b696f36cf109540a18bc3c92b1e0c371c8a631147143e125867e2248d5a4fbc6-image8.png" className="border" />

3. Enter the number of registrations or transactions required to fulfill the criteria.

<Callout icon="📘" theme="info">
  Note
  For **Incentives to Referrer**, you can add multiple registration and transaction criteria.
  However, for **Incentives to Referee**, multiple registration or transaction criteria cannot be configured.

  <Image align="center" border={true} width="65% " src="https://files.readme.io/27184847df6b941f1d709a4073dfeb969eb8d1cd8f1ee4b29b614843132f9b71-Screenshot_2025-10-07_at_6.22.26_PM.png" className="border" />
</Callout>

3. Select the **Edit**icon to configure the coupon.
4. Select **Create Coupon Series**to [create a new coupon](https://docs.capillarytech.com/docs/create-offer-1#create-offers), or select **Claim Coupon Series**to add an existing coupon, ensuring the coupon code number is greater than 6.
5. Enable **Notify by SMS** or **Notify by Email** under **Notification Settings** to enable sending SMS or Email.

<Image align="center" border={true} src="https://files.readme.io/e8fc2ea431dd7930af073e58c03b189f11e44d0b9499b825fc883f19b241e181-Screenshot_102.png" className="border" />
...
<Image align="center" border={true} src="https://files.readme.io/788d9ff279563dd4fcf6d521e77068d04ee0f2e3ae34e5ec53789b13e6f5d283-Screenshot_102.png" className="border" />

8. Select **Review and Save** to save the changes.

<Image align="center" border={true} src="https://files.readme.io/9f1c2ce7e4db347b146a6757f2c5b068a228402789b485678aa2230f3a55f2b5-Screenshot_103.png" className="border" />

## Step 4: Configure incentive
...
<Image align="center" border={true} src="https://files.readme.io/ba78ed42e4c216e4afcedb86e587bc20e4ab3480ca12b2490494e0b06212003e-image9.png" className="border" />
...
You can configure issuing points for a referral campaign through Loyalty+.
...
<Image align="center" alt="Award Points to Referee" border={true} src="https://files.readme.io/8fe5a44-JgRNTWNS6_kiLOGEFGhMO9hsEKIUBAuIIg.png" className="border" />

<Image align="center" alt="Award Points to Referrer" border={true} src="https://files.readme.io/2a1efce-nrV50--2GIuO3iKJZXu6J30KErJz_q0U8A.png" className="border" />
...
<Image align="center" border={true} width="55% " src="https://files.readme.io/7a4e020901709e328276cf7416a90d54e107b33a9b6df5bf340545f9a2d04523-image.png" className="border" />

<Image align="center" border={true} width="65% " src="https://files.readme.io/9bdc74af56a35aad3469477867bbea2f177c17b5b5e898c28e13625364657a1b-Screenshot_2025-09-02_at_11.09.32_AM.png" className="border" />

3. Select **Save and Continue** to apply the changes.

## Step 5: Create & send referral campaign message
...
<Image align="center" border={true} src="https://files.readme.io/c67991f5da7860fe2030a8a1f85c9f559ccefb539cbb836cd3c6ac9ef8aaac98-Screenshot_59.png" className="border" />

4. Add the **Audience Group** for the campaign.

<Image align="center" border={true} src="https://files.readme.io/c8cf94c68c13bb85d5bc7cea196ac79954c45a8487d72bfbb6d5f901700879cb-Screenshot_61.png" className="border" />
...
<Image align="center" border={true} src="https://files.readme.io/17a7a3aeab08d0fcc1940f98f3ab2bc7e0182ae951bfa0fbbb4cf42d57e00aaf-Screenshot_93.png" className="border" />
...
> ⚠️ **Note**
>
> You must approve campaigns with status Approved at least 2 hours before the scheduled execution time. If you approve a campaign less than 2 hours before its scheduled start, it will not trigger as scheduled. Always plan campaign approvals to meet this timing requirement.

<Image align="center" border={true} src="https://files.readme.io/04ae656736dedc1598dfdce2fd33091b94d944fa0a44330f27f63fefc7a7ac43-Screenshot_63.png" className="border" />

Once approved, the message will be successfully created.

## Step 6: Create broadcast campaign
...
<Image align="center" border={true} src="https://files.readme.io/fa73b13a54a758ceabe8d5d4ffabc1ef4109920db387e8035bfaa2eface78630-Screenshot_54.png" className="border" />
...
<Image align="center" border={true} src="https://files.readme.io/668abe39f9d41eb6f68ccd4b85c9fb5f265dcaab259436ef8bf7a52751e73944-Screenshot_55.png" className="border" />
...
<Image align="center" border={true} src="https://files.readme.io/578c30124c32e5a0f0e8ff99d78098713f28cfc5efe2c95762732d7597b6e601-Screenshot_58.png" className="border" />

> 📘 **Note**
>
> The token is a unique identifier used for the [Refer Customer API.](https://docs.capillarytech.com/reference/refer-customer)

# Activating & deactivating a referral campaign
...
<Image align="center" border={true} src="https://files.readme.io/607c1d66b9656770ba09c88679f580364413edf96a3f860069d56d865950f048-Screenshot_58.png" className="border" />

5. Select **Stop** to deactivate the Campaign.

<Image align="center" border={true} src="https://files.readme.io/aa08ae83d866f271e23434bf1645e4763d7cfe537ab2b9facb484d3e7ae82863-Screenshot_70.png" className="border" />

6. The campaign is successfully de activated.

<Image align="center" border={true} src="https://files.readme.io/aac6ca6d8bb387112083ff47331cac218e74160ea87e735f1cc4633dc4055ae7-Screenshot_71.png" className="border" />
...
<Image align="center" border={true} src="https://files.readme.io/17dc3646248442ed4763a5953447977d2aa064c49aaa3a048b63175ad44476e5-Screenshot_72.png" className="border" />

4. Select **start** to activate the campaign.

<Image align="center" border={true} src="https://files.readme.io/b312bcdbf3fafb57596f89037742ba5b9c7c8354a96e9e6b3e8073b51d3a4ef6-Screenshot_73.png" className="border" />

5. The campaign is successfully activated and can be viewed in the **Old Campaign Manager**.

<Image align="center" border={true} src="https://files.readme.io/3f090420c58f71c9ef7be9407c5ce91d5cb16fcf42f7cc20d4a1cf496300056f-Screenshot_75.png" className="border" />
...
<Image align="center" border={true} src="https://files.readme.io/699d2622054672a5fa47bc584784c1dbbffddd36496ad1ce7944e7d3fafa6b25-Screenshot_96.png" className="border" />

2. [Configure campaign details. ](https://docs.capillarytech.com/docs/referral-campaign#creating-a-referral-campaign)

<Image align="center" border={true} src="https://files.readme.io/6997d664f1f000966a95abd7e05f00aaeb677ed2337a061d492474351753fb83-Screenshot_97.png" className="border" />
...
<Image align="center" border={true} src="https://files.readme.io/4800a2901cb34c241cfac07e352f5c2c68894d63a82344f1867e5970b4e731ba-Screenshot_100.png" className="border" />
...
<Image align="center" border={true} src="https://files.readme.io/7eb3775ce6777702eb250a1f349b753d5f7f27d43b020a2a8c5a68149e65f3bd-image.png" className="border" />
...
<Image align="center" border={true} src="https://files.readme.io/8da00c1a4dd34c63276f06d40ed6f550c83feb9125e07f66644e34f26128d347-Screenshot_98.png" className="border" />
...
<Image align="center" border={true} src="https://files.readme.io/3f9fc1f3447bf342b3eb10d1d1b807b3ad11848df72095979229955664dff8ec-Screenshot_80.png" className="border" />

2. [Configure a confirmation message](https://docs.capillarytech.com/docs/referral-campaign#/configure-message-post-referral) in the old UI to be sent after a successful referral completion.
3. [Configure Incentive.](https://docs.capillarytech.com/docs/referral-campaign#/configure-incentive)

<Image align="center" border={true} src="https://files.readme.io/2e2dad98c1a57790bc145a1ef480fa33b56cf23940f17aedecd1b786f7021740-Screenshot_79.png" className="border" />

<Image align="center" border={true} src="https://files.readme.io/53954bfe0cd108258b9f7d6f5b67d0c970837960490c98d8247a2de657c8c8f4-Screenshot_81.png" className="border" />

3. [Create a broadcast campaign.](https://docs.capillarytech.com/docs/broadcast-campaign#/)

<Image align="center" border={true} src="https://files.readme.io/787770c8184eb97912cf8f3c87df15412a774a2ee15cddeeb5bd84fbcd8f9712-Screenshot_76.png" className="border" />
...
<Image align="center" border={true} src="https://files.readme.io/9db36c3864f3fb612e7ace2e58aae0f5a4847056e82f32d7b654b2b22606dd81-Screenshot_63.png" className="border" />
...
<Image align="center" border={true} src="https://files.readme.io/c0899ef772e397ea3f2bd90bd8133044b4fc75181c7c3279814a10599c4e2725-Screenshot_80.png" className="border" />

2. [Create Coupon Offers.](https://docs.capillarytech.com/docs/offers#create-offer)

<Image align="center" border={true} src="https://files.readme.io/408b8586782c8c95756d6eb4d1f138f3928e9fb67af7b898b7d93de59a5561a9-Screenshot_81.png" className="border" />

3. [Configure Incentive.](https://docs.capillarytech.com/docs/referral-campaign#configuring-incentives)

<Image align="center" border={true} src="https://files.readme.io/5cc75b818c8c0afc0d9399530036e625a9b22d5c006e2839f6159b9d873a6e6b-Screenshot_79.png" className="border" />

4. [Create message template.](https://docs.capillarytech.com/docs/referral-campaign#creating-a-message-template)

<Image align="center" border={true} src="https://files.readme.io/2b90985ef1dbbe5bbf437cb68e4526786513efdd21aa8b51e4f9bdaef3626817-Screenshot_85.png" className="border" />

5. Set up[ referral Code Configuration.](https://docs.capillarytech.com/docs/referral-campaign#/configure-referral-code)

<Image align="center" border={true} src="https://files.readme.io/4f9b2a8dd9360c7b429ee33e1f6e8a666b31dccfa6b2ff42a02a648af75cbb1a-Screenshot_88.png" className="border" />
...
<Image align="center" border={true} src="https://files.readme.io/95c0e176af98ddf942b9f55d16ca86fff04074f7fe259790e1bcd9589c4730e4-Screenshot_80.png" className="border" />

2. [Configure a confirmation message](https://docs.capillarytech.com/docs/referral-campaign#/configure-message-post-referral) in the old UI to be sent after a successful referral completion.
3. [Configure referral code](https://docs.capillarytech.com/docs/referral-campaign#/configure-referral-code)

<Image align="center" border={true} src="https://files.readme.io/2b6decad5ced692c3b3e95b0d520654f03ce546d6e26ec749a9e692ee473a14a-Screenshot_88.png" className="border" />
...
<Image align="center" border={true} src="https://files.readme.io/38f79f0a1ded558c16358a95fb4cfc3eb6bafdbd4621e024635b46ce584432ab-Screenshot_94.png" className="border" />
