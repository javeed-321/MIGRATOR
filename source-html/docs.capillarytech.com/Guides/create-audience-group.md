...
Learn the different ways to create audience groups, including filters, CSV upload, combining existing groups, and FTP import.
...
Only custom fields related to users (user\_cf) and invoices (inv\_cf) are supported for filtering when creating audience groups. Custom fields related to stores (store\_cf) are not supported. Using store\_cf fields does not affect the audience group. </Callout>
...
* Create  audience groups using various predefined filters such as transactions, customer details, demographics, custom field details, and loyalty information. Only users (user\_cf) and invoice (inv\_cf) custom fields are supported for filtering. Store custom fields (store\_cf) are visible in the filter options, but are not supported for filtering. For more information about audience filters, refer to **[About audience group filters](https://docs.capillarytech.com/docs/about-audience-group-filters)** documentation.
...
<Image align="center" border={true} src="https://files.readme.io/2c8899c-r1odQX5RTgq0JLAaxzgzWpuYYmnv0GfUjg.png" className="border" />

2. Click **Add audience group**  > Create **audience group**
3. Specify a name for the filter group.

<Image align="center" border={true} width="80%" src="https://files.readme.io/04ffe27-JDoZtWdE-Gb1577VW0wFcFRcsRy4pPbwcw.png" className="border" />
...
<Image align="center" border={true} src="https://files.readme.io/728b758-PdyJt06PNkKPYB8l8s-R3K5Ny8RkIkPFsg.png" className="border" />
  ...
  <tbody>
    ...
    <tr>
      ...
      <td>
        ...
        For more information, see [Transaction based filters](https://docs.capillarytech.com/docs/transaction-based-filters).
      </td>
    </tr>
    ...
    <tr>
      ...
      <td>
        ...
        For more information, see the [Campaigns & Coupons based filters](https://docs.capillarytech.com/docs/campaigns-coupons-based-filters) documentation.
      </td>
    </tr>
    ...
    <tr>
      ...
      <td>
        ...
        * *For more information, see [User Profile based filters](https://docs.capillarytech.com/docs/user-profile-based-filters)
      </td>
    </tr>
...
> 📘 Notes
>
> * A filtered audience list gets refreshed everyday during EI sync. You can enable **"Execute message only after audience sync completion"** to ensure that the campaign proceeds only after confirming EI sync completion and verifying that the audience is up to date. For more information, refer to the <Anchor label="documentation on the same" target="_blank" href="https://docs.capillarytech.com/docs/schedule-message#scheduling-messages-post-audience-sync-confirmation">documentation on the same</Anchor>.
...
<Image align="center" border={true} width="80%" src="https://files.readme.io/2d5a33c-5dc9a64-N6XnEj-jZ_4YDNYbqiyNsGLm8bOHgKEg3w.png" className="border" />
...
* All the duplicate entries will be merged
  ...
  <Image align="center" border={true} width="80% " src="https://files.readme.io/0bae29684b2da09f2c25e3a0cf21b65135cc09381d4a7ac53e1cb6de7d64e744-image.png" className="border" />

5. Select an appropriate tag for each column, and then click Confirm and Upload.

   <Image align="center" border={true} width="80% " src="https://files.readme.io/79d9ed838ec43d6dba5c69bb1bfa50aad5c4638490038f82d523e46c02aad314-image.png" className="border" />
6. Preview the reachability of the audience in the group, and then click **Done**.

<Image align="center" border={true} width="80%" src="https://files.readme.io/c24b837-9b0036a-TGG3vFPib54EpZ0UC6ofzW2nHSXt6KQ1dw.png" className="border" />
...
<Image align="center" border={true} width="75% " src="https://files.readme.io/5961d03890f03979ade7f551c676edde4a98a907a6064bd609b60b0cd8c848b7-audience-group-google-docs.png" className="border" />

2. Enter the name for the audience group and select **Combine existing groups**.

<Image align="center" border={true} width="75% " src="https://files.readme.io/572d54c51d47944d82778880782069f9313c3a4d12fb181b361276080961cd68-audience-group-google-docs_1.png" className="border" />
...
<Image align="center" border={true} width="75% " src="https://files.readme.io/241b04bfee7d1ff9963e1553565a8b9c8f84e0660fd2834d762ef3fb434a02fb-audience-group-google-docs_2.png" className="border" />
...
<Image align="center" border={true} width="75% " src="https://files.readme.io/d4806ff51e9fd2c51583ba29f236dbf3cd4cbee6db53783ae64fcbe3ad8e3265-audience-group-google-docs_3.png" className="border" />
...
<Image align="center" border={true} width="75% " src="https://files.readme.io/a8a6a6b792ec3d600b9efbc50ea4e774c4c4afcbffb627fdb3bd23e7ceb33b2a-gify_1.gif" className="border" />
...
<Image align="center" border={true} width="75% " src="https://files.readme.io/1979939b14b8e17709fad4e7b090fec902d434d5a53d968369e00d3c7f869a5e-audience-group-google-docs_5.png" className="border" />
...
<Image align="center" border={true} width="80%" src="https://files.readme.io/da1f4b9-3xF3I5ufleAJv4D5QylpP4MHG3CCI_sJkQ.png" className="border" />
...
>
> <Image align="center" border={true} width="70% " src="https://files.readme.io/d132b650a7b2c9c91277a2ac3de08af893ae71351b499f047d1a71356b4c6942-Screenshot_2025-06-24_at_2.16.28_PM.png" className="border" />

3. Select **Import via FTP connector** and click **Next**.

<Image align="center" border={true} src="https://files.readme.io/fb3367b-Select_Import_via_FTP.png" className="border" />
...
4. Click Done.
   ...
   <Image align="center" border={true} src="https://files.readme.io/8a41d6f-Mapping_FTP_file.png" className="border" />
...
<Image align="center" border={true} src="https://files.readme.io/96369e9-Status.png" className="border" />
