...
<Image align="center" className="border" width="80%" border={true} src="https://files.readme.io/4d9798a-ChartsExplore.png" />
...
<Image align="center" className="border" width="30% " border={true} src="https://files.readme.io/bf96e96-Buttons_explore_chart.png" />
...
<Image align="center" className="border" width="smart" border={true} src="https://files.readme.io/c102a4e-Explore1.gif" />
...
<Image align="center" className="border" width="smart" border={true} src="https://files.readme.io/07afa01-Explore2.gif" />
...
<Image align="center" className="border" width="smart" border={true} src="https://files.readme.io/2ce885b-Explore3.gif" />
...
<Image align="center" className="border" width="smart" border={true} src="https://files.readme.io/6efa349-Explore4.gif" />

For a KPI with Display % of total chip applied, an indication appears on the KPI chip as shown below.

<Image align="center" className="border" width="smart" border={true} src="https://files.readme.io/21a5e28-Explore5.png" />
...
<Image align="center" className="border" width="smart" border={true} src="https://files.readme.io/a148352-Explore6.gif" />

Once you apply a filter to a KPI, you can view it on the KPI chip, as demonstrated below.

<Image align="center" className="border" width="smart" border={true} src="https://files.readme.io/0450893-Explore7.png" />
...
<Image align="center" className="border" width="smart" border={true} src="https://files.readme.io/d7b650a-RTP.png" />
...
<Image align="center" className="border" width="smart" border={true} src="https://files.readme.io/da4ad12-Explore9.gif" />
...
<Image align="center" className="border" width="smart" border={true} src="https://files.readme.io/03ed841-LastTimePeriod.png" />
...
<Image align="center" className="border" width="smart" border={true} src="https://files.readme.io/ee1b068-exploreLast.png" />
