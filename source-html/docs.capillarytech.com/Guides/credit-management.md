...
<Image align="center" className="border" border={true} src="https://files.readme.io/daf6711-JQGf_oJevjvxkSp3NGH-_v8s8Lae-I4fkA.png" />

<Image align="center" className="border" border={true} src="https://files.readme.io/6f51539-z1LmKJ3Exkewk4fnQEM10chMTq9N932u2w.png" />

2. In Search brands, search the org for which you want to configure or view credits and select the brand.

<Image align="center" className="border" border={true} src="https://files.readme.io/10b315e-hfcAMv_ygfRShcRLVXwQ9YUykwxg60uzEw.png" />
...
<Image align="center" className="border" border={true} src="https://files.readme.io/6681880-b0PYmQDcqUklkSm_e528e4xHy0Ph2U_MAQ.png" />

4. Click **Edit rate card**.

<Image align="center" className="border" border={true} src="https://files.readme.io/6b50126-RfDXRsiVq5pjiojzk-kwgJ1MP_yEV_UZ_g.png" />
...
<Image align="center" className="border" border={true} src="https://files.readme.io/200d8d5-jkFwNklh0aqFyOKu0VFuWZaEMNeJRrZuww.png" />
...
<Image align="center" className="border" border={true} src="https://files.readme.io/642db6d-Uyvkcj1p9ssy-GnpRGchhf7vuSnlbzdrTA.png" />
...
<Image align="center" className="border" border={true} src="https://files.readme.io/da2bfa7-CWH2yqc5bEM-KQ7hcXlQnBLwVfQe6ryW-g.png" />
...
<Image align="center" className="border" border={true} src="https://files.readme.io/81f2fec-O6lshghnpypYHzEZiqJuhc3CLolkE6tTlA.png" />

2. In **Low credit alert**, set when to receive notification in terms of available credits.

<Image align="center" className="border" border={true} src="https://files.readme.io/7815138-Gh4JEURlPcbdxRvDRCAktj7_TlvkqYDr5w.png" />
