...
You can create rules on the points that are redeemable, non-redeemable, or with the summation of both. </Callout>
...
<Image align="center" border={true} src="https://files.readme.io/f388f89b7316ceb2cf4ecfeb4522da587a939c6d465310834495757f57b34d71-Screenshot_2025-10-08_at_11.59.35_AM.png" className="border" />

6. In **Name**, enter the condition name.

<Image align="center" border={true} width="smart" src="https://files.readme.io/a5fee99-Gnv9ybXcStwsta30UrKK0c4O7rXxO7LGqw.png" className="border" />

7. In **Description**, describe the condition.

<Image align="center" border={true} width="smart" src="https://files.readme.io/9170a21-3vNYVE0m2oIvkDqghDAFBcYqxcZxLGIbsA.png" className="border" />

8. In **Module Using this Condition**, select the module **Loyalty** or **Engage** where you want to use this condition.

<Image align="center" border={true} width="40% " src="https://files.readme.io/325834f34c5857017f5dc6d892873f2d8a6391c7d97cff9265bf7bbb78b50c21-Screenshot_2025-08-28_at_9.32.48_PM.png" className="border" />

<Callout icon="📘" theme="info">
  Note

* If you select Engage+, three options are available: **Fixed**, **Round Up**, and **Prorate**.
* Selecting Engage+ allows you to define the earn conditions when issuing points for campaigns and journeys.
  </Callout>
...
<Image align="center" border={false} width="smart" src="https://files.readme.io/039be42-dymtQnUNnm_CG4qK_1hg6TLrUNBIF4SvYA.png" />
...
<Image align="center" border={false} width="0% " src="https://files.readme.io/987a25c-Screenshot_2023-01-20_at_5.54.49_PM.png" />

<Image align="center" border={false} width="300px" src="https://files.readme.io/4115c68-Screenshot_2023-01-20_at_5.54.49_PM.png" />
...
<Image align="center" border={false} width="smart" src="https://files.readme.io/2219fa1-qvGeRxzNTs3eu8v1xMCya8ywIrITjaGjGw.png" />
...
<Image align="center" border={false} width="smart" src="https://files.readme.io/0160873-k5HNUdtuWRQ0hRnh9vV7laHwLsxbJags6A.png" />

13. Click **Done**.

### Allocate points on custom field values

You can also reward points to your customers based on the custom field values that are submitted on the customer registration and profile update screens of InStore. This works only for custom fields with integer values (for example: 20) and not for string values (for example: John).

> Note:
> When you set **Allocate Based On** to a custom field (such as a field collected during registration or transaction), you can only award points as a percentage of the transaction value. Conditions where points awarded equals the custom field value is not supported. For example, award 100 points when the custom field value is 100.

To configure rewarding points based on custom fields, follow these steps:
...
<Image align="center" border={false} width="smart" src="https://files.readme.io/9f6af84-gd4fw3XCRdVhclmvq0M9lCePsMCa22ynBQ.png" />

<Image align="center" border={false} width="smart" src="https://files.readme.io/e4dc534-DeeSN4YFEPvkUCtlWJfdcvi73GKAGDk7XQ.png" />

3. In the **Allocation type**, choose **Prorated** to allocate points as a percentage of the transaction amount. Fixed allocation is not supported when allocating based on a custom field value.
4. Click **Done**.
...
<Image align="center" border={false} width="smart" src="https://files.readme.io/e9a8da2-0RKh0249iMG-Idb__vriWauYmDb_D_Qz0Q.png" />
...
<Image align="center" border={false} width="smart" src="https://files.readme.io/3c29dfa-uqcxDO042WQiQpo3cKhSoL0cvzvHEi1evg.png" />

<Image align="center" border={false} width="smart" src="https://files.readme.io/52d0927-bx1GHBH3UB5WH0msmH_GKgXNNyrNqSQWXg.png" />
...
<Image align="center" border={false} width="smart" src="https://files.readme.io/2f19af0-XOJo2uw4fcNtRSN2962lwyd_bv_CY-v_JQ.png" />

<Image align="center" border={false} width="smart" src="https://files.readme.io/ebcfbfc-XSHjiilBH2p_k8KtFFlAC7Wim2_72ihO3w.png" />
...
**Note:**
When a transaction-level points cap (for example, 500 points) is reached, the system continues to calculate the source values for all tenders and line items in the transaction. However, for any entries that exceed the cap, the points awarded are set to zero. These zero-point entries are filtered out from reports and the user interface. As a result, the Earn Eligible Amount shown in reports or UI may differ from the total tender value, because only entries with non-zero points are displayed.
...
<Image border={false} src="https://files.readme.io/d9ac5e4-earn1.png" title="earn1.png" />

* In Add capping page, click Total points.

<Image border={false} src="https://files.readme.io/ee592fc-earn2.png" title="earn2.png" />

* In Total points, set the limit per customer.

<Image border={false} src="https://files.readme.io/07282ab-earn3.png" title="earn3.png" />
...
<Image border={false} src="https://files.readme.io/e32668c-earn4.png" title="earn4.png" />

* In Add capping page, click Source value.

<Image border={false} src="https://files.readme.io/c0dc7c8-earn5.png" title="earn5.png" />

* In Source value, set the limit per customer.

<Image border={false} src="https://files.readme.io/2d4f92a-earn6.png" title="earn6.png" />
...
<Image border={false} src="https://files.readme.io/67cd033-earn7.png" title="earn7.png" />

<Image border={false} src="https://files.readme.io/68888bf-earn8.png" title="earn8.png" />

<Image border={false} src="https://files.readme.io/1755562-earn9.png" title="earn9.png" />
...
<Image border={false} src="https://files.readme.io/29d0b0d-earnq1.png" title="earnq1.png" />

<Image border={false} src="https://files.readme.io/a0b0f34-earnq2.png" title="earnq2.png" />

<Image border={false} src="https://files.readme.io/91e63ed-earnq3.png" title="earnq3.png" />

<Image border={false} src="https://files.readme.io/2363f87-earnq4.png" title="earnq4.png" />
...
<Table align={["left","left"]}>
  ...
  <tbody>
    ...
    <tr>
      ...
      <td>
        Points expire after the configured number of months. Points expire at the end of the last day of the calculated month, at 23:59:59 in the org's configured timezone — not on the exact same date the specified number of months later.

        For example, if a customer makes a transaction on July 10, 2021, and Months for expiry is set as 1, points expire on August 31, 2021 at 23:59:59 — not August 10, 2021.
      </td>
    </tr>
...
> 📘 **Note:**
>
> The points expiry job is a scheduled bulk process that runs in the early hours after the expiry date. As a result, the event timestamp visible in activity logs may show a time such as 04:51 rather than 23:59:59. This does not mean the points expired late — the system records the expiry date as the configured end-of-month date at 23:59:59.
...
### Points consumption order

When a customer redeems points, Capillary uses an **Expiry-First Out (EFO)** strategy — points closest to their expiry date are consumed first. This protects customers from losing points to expiry unnecessarily.

For points sharing the same expiry date, the system falls back to **FIFO (First In, First Out)** — the oldest earned points are consumed first.
...
<Image align="center" border={true} width="smart" src="https://files.readme.io/33e39f9-_O4sh8fO2eX8qOK2GfZrzoW2-4G6J1UzbQ.png" className="border" />

6. Click **Add Redeem Conditions**.

<Image align="center" border={true} width="smart" src="https://files.readme.io/c46e534-65gZ1oAz8Du4YSlzZMyY9HFeFO1QoANO_w.png" className="border" />
...
<Image align="center" border={false} width="smart" src="https://files.readme.io/036826f-xga8kvVfC9z_iXzpPii_Yco_JWT7MSViIg.png" />
...
<Image align="center" border={true} width="smart" src="https://files.readme.io/5cd250c-i6VDm8pzPk9oCZIWyN2krd6IIK__xjXGfA.png" className="border" />
...
<Image align="center" border={true} width="smart" src="https://files.readme.io/c227b01-dYfm6nxht0tXHvbmZB1Z8i7YCAX7XvjUtA.png" className="border" />

12. In the **Points balance required**, enter the minimum current points that a customer should have to allow redemption.

<Image align="center" border={true} width="smart" src="https://files.readme.io/79416a5-4pX0P5p3irU-uHqGx09r8uTccNrTXPOG8A.png" className="border" />
...
<Image align="center" border={true} width="smart" src="https://files.readme.io/fd3c082-ZaKCVnPqbeA-JZcdIXQwOUzLdQHqR7ouGA.png" className="border" />

14. In **Lifetime points required**, enter the total points that customers should earn to allow redemption.

<Image align="center" border={true} width="smart" src="https://files.readme.io/896adea-pPFc68AWwo6CMRD2zZnZfnBcnAGtoiLFiQ.png" className="border" />

15. In **Lifetime purchases required**, enter the total purchases that customers should make to allow redemption.

<Image align="center" border={true} width="smart" src="https://files.readme.io/5c969b6-kU_T9-3AScAMkU8yKU6hDshoFESavfUvww.png" className="border" />
...
<Image align="center" border={true} width="smart" src="https://files.readme.io/fc61c60-qDi4fLoHji1dvZVmiS8fWC_ogIHJAXObYQ.png" className="border" />
...
Enable Allow\_points\_redemption\_reversal config on EMF settings. Only the back-end team has access to this page. Please raise a ticket if you want this to enable.
...
Return re-evaluation ensures that when a customer returns items, the points adjustment reflects the actual earn rules rather than a simple proportional deduction. This matters for loyalty programs that have [earning limits](https://docs.capillarytech.com/docs/advanced-capping). A pro-rata deduction would give the wrong result in these cases. For example, if a customer earns 500 bonus points for crossing a ₹5,000 spend threshold and returns an item that drops their total below ₹5,000, re-evaluation removes all 500 points — not just a fraction of them. This is default behaviour and no additional configuration or flag is required. Once you configure return conditions for your program steps above, return re-evaluation applies automatically to all return transactions.

When a return is processed, calculations are made on how many points the customer would have earned had they only purchased the remaining items. This uses the original purchase date, not the return date for the time reference. The difference between what was originally awarded and this recalculated amount is what gets deducted as part of the return.

<img width="1408" height="768" alt="Gemini_Generated_Image_urdb70urdb70urdb" src="https://github.com/user-attachments/assets/a3f0c94b-e4cc-49ed-b0e6-d76330691210" />
...
3. Hover over the condition name to view the condition code. To copy a code to the clipboard, select the copy icon. These condition codes are used in the [Issue reward currency API](https://docs.capillarytech.com/reference/issue-reward-currency#/)
   ...
   <Image align="center" border={false} width="80% " src="https://files.readme.io/561df902566774aff876296333b6872af07c1de849a1dc40d20e951bf7ebcc92-image.png" />
...
<Image align="center" border={true} width="80% " src="https://files.readme.io/9886a3318c6fc80d69b6b9335bd1ce6a47163c0083fa5537a28a61ebecef8281-image.png" className="border" />
...
4. Choose the decimal places using the drop-down list under **Round off decimal earnings by**. By default, the system stores the values up to 3 decimal places.
   ...
   <Image align="center" border={true} width="80% " src="https://files.readme.io/46398dee4da6f09fbfef8a4bee1742e8ce682a2c1b911c30e8fc16cceacbcce1-image.png" className="border" />
...
4. Choose the points rounding strategy using the drop-down list under **Currency rounding strategy for decimal conversion**. that appears on the earn conditions. By default, the system rounds half up.
   ...
   <Image align="center" border={true} width="80% " src="https://files.readme.io/6501119d8ad32615850f2aa754b00713dac45d2d77ed28d549ca9c4abd9a8544-image.png" className="border" />
...
* The **expiry date of the 100 points is extended to December 2025**.
  ...
  <Image align="center" border={true} width="80% " src="https://files.readme.io/933e82390fa30548c1f461c3d4fd2f4a75bbd5c9e4cd86c637519a00332c9712-Pts_rolling-2.png" className="border" />
...
2. Select your program, then choose **Edit Program** > **Advanced settings**.
   ...
   <Image align="center" border={true} width="80% " src="https://files.readme.io/2e21759e54e3de837f8cca43cfbca752010514ef6f690c0403bbeeebf4978065-image.png" className="border" />
3. Navigate to the **Points** page.
4. Turn on the **Roll expiry even when 0 points are given** toggle.

   <Image align="center" border={true} width="80% " src="https://files.readme.io/dcd384c7d22ebc0a4d19b29b2283a8a669bd9825411133ef216da5690c63a1d5-image.png" className="border" />
5. Select **Done** to save the changes.
...
<details>
  <summary>Why does the Earn Eligible Amount sometimes not match the total tender value in reports or the UI?</summary>
  When a transaction-level points cap is reached, the system continues to calculate source values for all tenders and line items. However, any entries that exceed the cap are assigned zero points. These zero-point entries are filtered out from reports and the user interface. As a result, the Earn Eligible Amount shown may be less than the total tender value, because only entries with non-zero points are displayed.
</details>
