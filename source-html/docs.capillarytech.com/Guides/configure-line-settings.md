...
* [ ] **[Create a LINE account](#creating-a-line-account):** A LINE account is the primary account used to login to the LINE Developer Platform.
* [ ] **[Create a LINE Developer Platform Account](#creating-a-line-developer-platform-account):** The LINE Developer Platform is the portal to connect and utilize the LINE API.
* [ ] **[Create a Provider](#creating-a-provider):** A provider is an individual developer or organization that provides services and acquires user information on the LINE Developers platform.
* [ ] **[Create a Channel](#creating-a-channel):** A channel is a communication path for providers to use the LINE platform's features.
* [ ] **[Create a Bot](#creating-a-bot):** A bot allows you to send messages to users and leverage features such as rich menus and quick replies.
* [ ] **[Create a Webhook](#creating-a-webhook):** A webhook allows you to receive real time information from LINE.
* [ ] **[Configure the LINE Message API](#configuring-the-line-message-api):** The Messaging API lets you develop two-way communication between your service and LINE users.
* [ ] **[Channel ID and Secret Keys](#channel-id-and-channel-secret-keys):** The Channel ID and Secret Keys are identifiers used when integrating your LINE account with Capillary.
...
<Image align="center" className="border" border={true} src="https://files.readme.io/1e5e42320fb42c17de2a555ce01c6620bd2c5a92603c203896f81c00243fd17f-image.png" />
...
* [ ] [Setting up LINE Source Account on InTouch](#setting-up-a-line-source-account-on-intouch)
* [ ] [Registering a LINE User on InTouch](#registering-a-line-user-on-intouch)
* [ ] [Creating a LINE Gateway](#creating-a-line-gateway)
* [ ] [Setting Up a Webhook in the LINE Developer Account](#setting-up-a-webhook-on-the-line-developer-platform)
...
<Image align="center" className="border" border={true} width="70% " src="https://files.readme.io/2d1ba3e1edd7db2c3ea009ffa792cea9d2eccca6182196fe896270ca3bf48f4a-image.png" />
...
<Image align="center" className="border" border={true} src="https://files.readme.io/def87dbda1eb63d3a332c2665db1651c24a0ccdc4b7e505b908be23d7c90c719-image.png" />
...
<Image align="center" className="border" border={true} src="https://files.readme.io/0ec10de5dc9b3f613961d7a7d1a9dda1f76cc92da0e06e508595c216f1fcde4a-image.png" />
...
<Image align="center" className="border" border={true} src="https://files.readme.io/5cab36bb6575e65d1691519222dbe48f2d774eddf65a33b4a18f87c8df53812c-image.png" />
...
<Image align="center" className="border" border={true} src="https://files.readme.io/8fd7e294112d1a1cf0b16a820a8f190c0059860ad6ce24769780e1792eab9ae3-image.png" />
...
<Image align="center" className="border" border={true} src="https://files.readme.io/8ab336652c792a37253f3fc9e1aed2eba9b803802a14381dc05bfb0d3aca6d56-image.png" />