...
<Image align="center" border={true} width="223px" src="https://files.readme.io/b640f425082fbd90fcb5240e5cfeb1c0b4ca4d446e18c9fc5591dd109714cdc4-image.png" className="border" />
...
<Image align="center" border={true} width="70% " src="https://files.readme.io/0e4a467db8a2c5d78f62cf76fcc012526fb74b90b6816b99298a71fe23ed2c5e-image.png" className="border" />
...
<Image align="center" border={true} src="https://files.readme.io/74043bba655f76dc9c424f3d3c13e9598b93eea827bac0d67f0f122d34cddf2c-image.png" className="border" />
...
6. [Configure email](https://docs.capillarytech.com/docs/configure-email).

<Image align="center" border={true} src="https://files.readme.io/f73204518f33510b1f0da41eb8e15932a278621348c7762691cbacc39c11a2b3-image.png" className="border" />

7. (Optional) Select Preview and test to see how the template will appear on different devices, and send a test message to ensure everything looks correct before sending it to your audience.

## Reward Redemption Notification Email

<Image align="center" border={true} width="50% " src="https://files.readme.io/625b639ba512df301453242a9706f219bf36516258481cc4e1b9c92180007aa8-image.png" className="border" />
...
<Image align="center" border={true} width="70% " src="https://files.readme.io/c3f6bbf44cb09662439932ab94743826d838924e985bad81f11e45fe14d8e63a-image.png" className="border" />
...
<Image align="center" border={true} src="https://files.readme.io/df89fe9d3ebf06444ed67142eb3683e0742be5da17ab5f9751794c6e44b1ce37-image.png" className="border" />

4. Add the audience by [creating an audience group](https://docs.capillarytech.com/docs/create-audience-group).
5. In the Content section, click **Add Creative** and select **Email** as the channel.
6. [Configure Email](https://docs.capillarytech.com/docs/configure-email).

<Image align="center" border={true} width="70% " src="https://files.readme.io/9ba25b0d92eae668f8a584583c14c4063ccac9e7afc32ffffb83eef30141b4fd-image.png" className="border" />
