...
<Image align="center" className="border" border={true} src="https://files.readme.io/ae8d5f1-image.png" />

2. On the Settings page, select **Target** and click **Create target template**.

<Image align="center" className="border" border={true} src="https://files.readme.io/b80047c-image.png" />

3. In the **Template name** field, enter a name for the target template.

<Image align="center" className="border" width="50% " border={true} src="https://files.readme.io/eea2e95-image.png" />
...
<Image align="center" className="border" width="70% " border={true} src="https://files.readme.io/d3fcefb-Target_list_page.png" />
...
<Image align="center" className="border" width="70% " border={true} src="https://files.readme.io/50f1b92-Target_List.png" />

<Image align="center" className="border" width="25% " border={true} src="https://files.readme.io/b0f6997-Advanced_filter_for_Target_Template.png" />

7. Click on the target template to open it.

<Image align="center" className="border" width="70% " border={true} src="https://files.readme.io/071d886-Test_Target.png" />

<Image align="center" className="border" width="70% " border={true} src="https://files.readme.io/18eece5-Test_Target1.png" />

8. Click **Download target template**. This template is used for adding the target values.

<Image align="center" className="border" width="70% " border={true} src="https://files.readme.io/2f78548-Downlod_target_template.png" />

<Image align="center" className="border" width="70% " border={true} src="https://files.readme.io/0a0c0bb-image.png" />

9. Choose the date range for which you want to set the target.

<Image align="center" className="border" width="70% " border={true} src="https://files.readme.io/1f6ef8a-Target_dates.png" />

10. Expand the time range divider by clicking the drop-down box and selecting from Day, Week, Month and Year.

<Image align="center" className="border" width="70% " border={true} src="https://files.readme.io/01639be-Target_date_divider.png" />
...
<Image align="center" className="border" width="40% " border={true} src="https://files.readme.io/58acda7-CSV_zeros.png" />

13. In the sheet, enter the target values in the column with zeros.

<Image align="center" className="border" width="40% " border={true} src="https://files.readme.io/dfae362-CSV_values.png" />
...
<Image align="center" className="border" width="70% " border={true} src="https://files.readme.io/7175022-Upload_target.png" />

The target upload gets validated.

<Image align="center" className="border" width="-1px" border={true} src="https://files.readme.io/adc8a34-Validating_the_target.png" />

Once the upload and validation is completed, the target for the selected KPI and dimension is set and ready to track.

<Image align="center" className="border" border={true} src="https://files.readme.io/88a2d0e-Target_Upload_Successful.png" />
...
<Image align="center" className="border" width="70% " border={true} src="https://files.readme.io/f3313b5-Navigate_to_Target.png" />
...
<Image align="center" className="border" width="65% " border={true} src="https://files.readme.io/94128b4-image.png" />
...
<Image align="center" className="border" border={true} src="https://files.readme.io/5c1307c-Create_Target.gif" />
...
<Image align="center" className="border" border={true} src="https://files.readme.io/28d1451-Part_2_template.gif" />
...
<Image align="center" className="border" border={true} src="https://files.readme.io/8f9b613-excel.gif" />
...
<Image align="center" className="border" border={true} src="https://files.readme.io/af8a2a0-Final_upload.gif" />