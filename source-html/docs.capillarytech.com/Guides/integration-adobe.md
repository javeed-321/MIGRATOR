...
# Integration Set-up (Capillary to Adobe)
...
| **Configuration Setup**            | JSON payload samples from Capillary (Profiles and Events)  <br /> - Adobe schemas: one for Profiles (with IdentityMap) and one for Events (XDM-compliant)  <br />  Datasets mapped to each schema in AEP  <br />  Field mapping reference (see <Anchor label="sample mappings" target="_blank" href="https://github.com/Capillary/-CapDocFiles-/tree/main/AdobeCap">sample mappings</Anchor>) |
