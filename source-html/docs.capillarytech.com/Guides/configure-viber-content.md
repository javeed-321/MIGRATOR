...
<Image align="center" border={true} src="https://files.readme.io/3183e4acd98a870677adcce204f476388dfd0e52c3ef240ea99f67be04971bdc-image.png" className="border" />

3. Create a new Viber message or select from the existing template(creatives).
4. Click **Create new**.

<Image align="center" border={true} src="https://files.readme.io/a864d41ff500e81ad20f2de20d97febe11b8b74835e86b0d6fc66d37dc9ba090-image.png" className="border" />
...
9. (Optional) Select **<Anchor label="Preview and Test" target="_blank" href="https://docs.capillarytech.com/docs/test-and-preview-across-engagement-channels">Preview and Test</Anchor>** to preview the message content and test it with a set of <Anchor label="test customers" target="_blank" href="https://docs.capillarytech.com/docs/configure-campaign-level-settings#test-customers">test customers</Anchor> before sending it.

<Image align="center" border={true} width="550px" src="https://files.readme.io/e46a2da00b8dc1b9c8e9949438d14c65cd6d53d8958d6b4d504809d4a716b2a0-image.png" className="border" />

10. Click **Done**.

<Image align="center" border={true} width="70% " src="https://files.readme.io/52d2b01ca39f68c8ddf43701962067cd74254400d86e336ee0a3bf64700bb908-image.png" className="border" />

<Callout icon="📘" theme="info">
  **Note**

When adding video content to a Viber message, ensure that the video thumbnail is visible in the preview before saving the template. If the thumbnail does not appear, the message may fail during delivery. </Callout>
