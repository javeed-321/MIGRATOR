...
| createdAt    | Integer  | The system timestamp for when the event is received in milliseconds since the Unix epoch 1970-01-01T00:00:00Z, UTC. This value is always set to the current time when the event arrives.                                                       |
