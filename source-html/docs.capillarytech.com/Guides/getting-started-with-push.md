...
> 📘 Note
>
> Using outdated SDK versions may impact push notification delivery and delivery receipt (DLR) accuracy.
> To ensure reliable delivery and reporting, upgrade to the latest SDK version. It is recommended to always use the most recent SDK version for optimal campaign performance.
...
<Image align="left" border={true} width="250px" src="https://files.readme.io/292ec07-image3.png" className="border" />

<Image align="center" border={true} width="250px" src="https://files.readme.io/6f1288d-image10.png" className="border" />

<br />

# Configuring Push Notification

<Image align="center" border={true} width="70% " src="https://files.readme.io/1570404932583a53984a2d968404c87e6b6e6896e1295ab224ab3bcc552977fb-FLOWCHART_3.png" className="border" />
