...
<Image align="center" className="border" border={true} src="https://files.readme.io/305c1c9-Screenshot_2024-05-24_114056.png" />

2. In **Programs**, select the program for which you want to view the tier configuration.

<Image align="center" className="border" border={true} src="https://files.readme.io/04b371c-Screenshot_2024-05-24_114305.png" />

3. Under **Tiers** section, you can see the configuration of the tier program.

<Image align="center" className="border" border={true} src="https://files.readme.io/3867587-Screenshot_2024-05-24_114406.png" />
