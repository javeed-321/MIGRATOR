...
<Image align="center" className="border" border={true} src="https://files.readme.io/d12982c-image.png" />
...
<Image align="center" className="border" border={true} src="https://files.readme.io/176cd68f5531c0f29286369a26478c7c5197040dbbe9bfd16b766923625a5422-Screenshot_2025-05-23_at_1.41.42_PM.png" />
...
| Valid between                                                                                                                                                | The date range when the campaign is active. Only transactions that occur within this period are eligible for coupon issuance. Transactions before the activation time are not eligible, even if the offer is activated later. |
...
<Image align="center" className="border" border={true} src="https://files.readme.io/3915f1b-image.png" />
...
<Image align="center" className="border" border={true} src="https://files.readme.io/0ec6cac-image.png" />
...
<Image align="center" className="border" border={true} src="https://files.readme.io/a5216a3-image.png" />
...
<Image align="center" className="border" border={true} src="https://files.readme.io/c4223da88f1abc417148c6947dd1e195124284cdec347f06211e0f039151fd69-image_1.png" />

## Creating sms templates for bounceback campaign

Click Add against SMS. The SMS screen setting screen appears:

<Image align="center" className="border" border={true} src="https://files.readme.io/7df4f1e-image.png" />
...
<Image align="center" className="border" border={true} src="https://files.readme.io/40da26f-image.png" />
