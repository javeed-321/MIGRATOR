...
Capillary delivers event notifications in near real time. 95% of events are published for delivery within about 2 to 3 minutes of being generated, at a sustained load of up to 50,000 requests per minute (RPM).

After Capillary publishes an event, the total delivery time to the downstream application depends on how quickly your webhook accepts and responds to the request.

> **Note:** This delivery time covers Capillary's processing only. End-to-end delivery time also depends on your webhook's responsiveness.
