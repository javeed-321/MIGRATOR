...
<Image align="center" className="border" border={true} src="https://files.readme.io/395bb5af6530719d8ed6f866f647eb054db692eff75450c2877948b99be58884-Segmentation_file_upload_flowchart.drawio_1.png" />
...
<Image align="center" className="border" width="smart" border={true} src="https://files.readme.io/170bff3-iAOxImIbcJCxdR19mFnrv1DAXGIPol0dJA.png" />

2. Click **Create Segment**.

<Image align="center" className="border" width="smart" border={true} src="https://files.readme.io/13aacdb-H6GXkzJgSXYXcL6l8OX5i9R9Ahr-KjPOcQ.png" />
...
<Image align="center" className="border" width="smart" border={true} src="https://files.readme.io/2e523ac-mzKe0PB182l8A0aWn_uxHuglZ-dGdr3sEQ.png" />
...
<Image align="center" className="border" width="smart" border={true} src="https://files.readme.io/1169896-0Q6zvkGQanticR3gM_EQM3JcsOSUGo44Vg.png" />

9. Once the processing is completed, review the details and click **Create**

<Image align="center" className="border" width="smart" border={true} src="https://files.readme.io/c598a33-BddAi_6RbjcbweODdxEQhmCE-utHlUvO0g.jpg" />
...
<Image align="center" className="border" width="smart" border={true} src="https://files.readme.io/f89bc7f-9X2i2p7N5DztcxW2Zg216Zyp_s-UKVO_Ng.png" />
