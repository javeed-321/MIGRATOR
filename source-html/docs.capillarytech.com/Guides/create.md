...
<Image align="center" className="border" width="25% " border={true} src="https://files.readme.io/05b0192-Create_Reports.png" />

2. Click **Create Report**.

<Image align="center" className="border" border={true} src="https://files.readme.io/7c963ac-Create_report_Page.png" />
...
<Image align="center" className="border" border={true} src="https://files.readme.io/ef13f5a-Create_report.png" />

8. Click **+ Add/Remove Charts**. You will be directed to the add/remove charts interface.

<Image align="center" className="border" width="25% " border={true} src="https://files.readme.io/e5abdf2-Add_Chart.png" />
...
<Image align="center" className="border" border={true} src="https://files.readme.io/e582dc1-Select_Normal_Chart.png" />
...
<Image align="center" className="border" border={true} src="https://files.readme.io/f12c16b-Advanced_Filters.png" />
...
<Image align="center" className="border" border={true} src="https://files.readme.io/c594ca7-Add_or_Remove_Chart.png" />
...
<Image align="center" className="border" border={true} src="https://files.readme.io/4f0deac-Report_Date.png" />
...
<Image align="center" className="border" width="50% " border={true} src="https://files.readme.io/62977ab-External_report.png" />

4. From the **Type**, select **External**.
5. In the **Report URL**, enter the Databricks notebook path.

<Image align="center" className="border" width="50% " border={true} src="https://files.readme.io/919c288-External_report_url.png" />
...
<Image align="center" className="border" width="50% " border={true} src="https://files.readme.io/5359559-Add_query.png" />
...
<Image align="center" className="border" border={true} src="https://files.readme.io/1a9092e-Publish_Report.png" />
...
<Image align="center" className="border" border={true} src="https://files.readme.io/971ffd1-Publish_from_home_page.png" />

A success message is displayed when the report is published.

<Image align="center" className="border" border={true} src="https://files.readme.io/8276c31-2X3tHxYytXzLF8U6lt9UTZjMGgKt958rTg.png" />
...
<Image align="center" className="border" border={true} src="https://files.readme.io/014440e2a95ab1d602a3d71810c2aefca83239b2d95d6725cd07b622bdc0ce78-Create_Report_Badges_GIF.gif" />
