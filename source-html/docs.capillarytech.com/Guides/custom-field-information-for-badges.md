...
<Image align="center" className="border" border={true} src="https://files.readme.io/6a22100-image1.png" />

# Creating Custom Fields from Badges UI

1. Start by navigating to the badges UI and go to **Settings**.

<Image align="center" className="border" border={true} src="https://files.readme.io/4a9ee9d5fda635e785e91967fd51ddd4a633a4e4b804025a6046c99e758423b8-image.png" />

2. Select the option to **Create Custom field**.

<Image align="center" className="border" border={true} src="https://files.readme.io/ae823c828d3a86dbb89fe3107511b31921fa8343415deff5f02d2aaeb6db2ec2-image.png" />
...
<Image align="center" className="border" border={true} src="https://files.readme.io/6858b307265708c1c3dc4123f411039601c4750f04cfed6add3db4d7b6e79dcf-image.png" />

<Image align="center" className="border" border={true} src="https://files.readme.io/855e547eaa7d50e6ab8897b6fdb93699fcee0498b5c88f7bf5f3022bc8c79a65-image.png" />

<Image align="center" className="border" border={true} src="https://files.readme.io/0337520031a72751cb8efe8c904efcc680a642d076bb477f88f896ac8a9d5271-image.png" />

<Image align="center" className="border" border={true} src="https://files.readme.io/64484dc0b3487868fec801f89813687aadb1a819c4e3566b01fde73aabdc6c8c-image.png" />
...
<Image align="center" className="border" border={true} src="https://files.readme.io/58a25a3bd53eeb70d9faef84bb5e86e301f93dcdab6a620e14977a7dab16625b-image.png" />
...
<Image align="center" className="border" border={true} src="https://files.readme.io/b41280609f2769f91192369a8052cfe206d0e046975ad4a00b88c8a104421639-image.png" />

2. Make the required changes.

   <Image align="center" className="border" border={true} src="https://files.readme.io/8b6c56f059432106e1f6f599159418758509318e1e6c74c76cb9880e2dbb8994-image.png" />
...
<Image align="center" className="border" border={true} src="https://files.readme.io/86468bb2b3a513363e5a535680e0cfab1903b1435f8d364c5e2404e529b93b98-image.png" />
...
<Image align="center" className="border" border={true} src="https://files.readme.io/d39abf09ef08f2c4e05762d3f8cb5b245a75aa746054382949388c7f86490965-Step-by-Step_Instructions.gif" />
