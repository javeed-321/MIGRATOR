...
<Image align="center" className="border" border={true} src="https://files.readme.io/92e75e8-Customer_Data_Transactional_Data_2.gif" />
...
When an org is deactivated, all dataflows associated with that org are disabled and cannot be restored, even if the org is later reactivated. If you reactivate an org, Connect+ creates a new workspace for the org. You must recreate any required dataflows in the new workspace. Dataflows from the previous workspace are not available due to data model constraints.

To select your workspace, click the dropdown next to Connect+, and select your org from the list.

<Image align="center" className="border" border={true} width="50% " src="https://files.readme.io/808c27b-Workspace.png" />
