...
```json Webhook payload-For Transaction Events, with custom fields
{
...
```
```Text For Generic Events, (event name and id would be of generic event)
{
...
```
```Text For Target completed event, there will be xtra field named linkedTargetGroupVsTargetRuleIdMap
{
