...
<Image align="center" className="border" border={true} src="https://files.readme.io/31313fc05c6c0826b9ea98335dbb8c8b278c48425ab21fcb9767ed89fdde26ec-image7.png" />

3. Select **Open old campaign manager**.

<Image align="center" className="border" border={true} src="https://files.readme.io/0186aef6b94081469abfbc530e735357dd41ec546ea8fd19cd37e6f39e63538e-image5.png" />

4. Select **+New Campaign** from the **Campaigns Home** page.

<Image align="center" className="border" border={true} src="https://files.readme.io/f3e1651b98deb5bb1c87e24b3348a0b8e7dff7809b0e5b85e68589dab7162256-image2.png" />

5. Choose the campaign type from the dropdown menu. Choose Survey campaign.

<Image align="center" className="border" border={true} src="https://files.readme.io/67e75500e427586eb1e67949273242c598930764efa191c1428d09450443bb62-Screenshot_2025-05-23_at_5.42.13_PM.png" />

6. Enter the required details for the selected campaign and select appropriate configuration settings.

<Image align="center" className="border" border={true} src="https://files.readme.io/dc49bd4f91e14a1c6a496917e759f6bc171081a994cdb25518cd027718f93f68-Screenshot_2025-05-23_at_5.41.40_PM.png" />
...
## Viewing and editing a survey campaign
...
<Image align="center" className="border" border={true} src="https://files.readme.io/53582f560e2f964903fe94653c3d0b725930cb72b9720907e4b901aac135c4f2-Screenshot_2025-05-27_at_12.14.43_PM.png" />

5. Select **Stop** to deactivate the Campaign.

<Image align="center" className="border" border={true} src="https://files.readme.io/7e1a1216c1a259a536a92d9484001931ffa9d058e8818a6d7afe15d64d6505ee-Screenshot_2025-05-27_at_12.20.01_PM.png" />

6. The campaign is successfully de activated.

<Image align="center" className="border" border={true} src="https://files.readme.io/aac6ca6d8bb387112083ff47331cac218e74160ea87e735f1cc4633dc4055ae7-Screenshot_71.png" />
...
<Image align="center" className="border" border={true} src="https://files.readme.io/df2ddd152ab817832d3ec3a5d9906ba680f1389d10bc984c89a90813e5ce571f-Screenshot_2025-05-27_at_12.38.12_PM.png" />

4. Select **start** to activate the campaign.

<Image align="center" className="border" border={true} src="https://files.readme.io/8ff9224c80260c836861036e0fcc9c97be127336c2f98e0e357185d30e0cbbe9-Screenshot_2025-05-27_at_2.15.28_PM.png" />

5. The campaign is successfully activated and can be viewed in the Old Campaign Manager.

<Image align="center" className="border" border={true} src="https://files.readme.io/b7a4c2fa0fdfb6f7dc9b054e4803da414c8a8f45322e99a261778e0d480f92d8-Screenshot_2025-05-27_at_2.17.08_PM.png" />