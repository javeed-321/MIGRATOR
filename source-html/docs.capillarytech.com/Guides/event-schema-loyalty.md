...
```json Webhook payload
{
  "event": {
    "body": {
      "apiRequestId": "206f03b3832d0dd4b08b4a3016bea940",
      "createdAt": 1715922814916,
      "data": {
        "customerIdentifiers": {
          "customerId": 386959468,
          "instore": {
            "mobile": "918999777180"
          },
          "loyaltyType": "loyalty"
        ...
        "targetData": [
          {
            ...
            "definedTargetValue": "2500.000",
            "targetId": 53023,
            "targetName": "unified case any_d804ba76-dca8-4f9d-aaa1-012dc3fdae4d",
            "targetPeriodId": 35627,
          ...
          },
          {
            ...
            "targetId": 53024,
            "targetName": "unified case any_144894ab-2774-4df5-85a7-b2598542dddd",
            "targetPeriodId": 35627,
            "targetPeriodName": "Cycle_1"
          }
        ],
        "transactionId": 2151615115,
        "triggeringActivity": {
          "additionalAttributes": [],
          "enteredBy": {
            "id": 50670145,
        ...
        "unifiedTargetGroupDetails": {
          "targetGroupId": 28035,
          "targetGroupName": "unified case any",
          "unifiedTargetsAchievementCondition": {
            "aggregation": "COUNT",
            "combinationType": "ANY",
            "ruleExpression": "(53023 | 53024 | 53025)",
            "thresholdValue": 2
          }
        }
      },
      "eventId": "2bf9ab46-d86b-4a0d-a2b2-51e03cd4f335",
      "eventName": "unifiedTargetsAchieved",
      "loyaltyEventId": "27156179",
      "orgId": 51174,
      "refId": "51174_206f03b3832d0dd4b08b4a3016bea940"
    },
    "method": "POST",
    "path": "/",
    "query": {},
...
```json Webhook payload
{
  "event": {
    "body": {
      "apiRequestId": "382e08d160a867a09bcc195d2322bc46",
      "createdAt": 1714043035302,
      "data": {
        "customerIdentifiers": {
          "customerId": 383453457,
          "instore": {
            "mobile": "916661610045"
          },
          "loyaltyType": "loyalty"
      ...
      "eventId": "bef75633-2991-47d3-93ee-c4d6032ef1d5",
      "eventName": "unifiedTargetsUnAchieved",
      "loyaltyEventId": "",
      "orgId": 51174,
      "refId": "51174_382e08d160a867a09bcc195d2322bc46"
    }
  }
}
```
...
```json Fixed window
{
    ...
    "data":
    {
        "customerIdentifiers":
        {
            "customerId": 438576826
        },
        "defaultTargetValue": "1.000",
        "targetId": 5869,
        "targetName": "T&C test milestone sep15",
        "targetGroupId": 8161,
        "targetGroupName": "T&C test milestone sep15",
        "source": "API",
        "targetPeriodId": 46753,
        "targetPeriodName": "Cycle_1",
        "targetPeriodStartDate": "2025-09-15 00:00:00.0",
        "targetPeriodStartDateInMillis": 1757874600000, ////Post timezone standardization
        "description": "test milestone sep15",
        "milestoneDetails":
        []
    },
    "orgId": 50583,
    "refId": "50583_6e51ec9831524c5069fa2ea4ca47ece1",
    "apiRequestId": "6e51ec9831524c5069fa2ea4ca47ece1",
    "createdAt": 1760509316373,
    "loyaltyEventId": ""
}
```
```Text Cyclic Window
{
    ...
    "data":
    {
        ...
        "defaultTargetValue": "1000.000",
        "targetId": 4638,
        "targetName": "test cyclic 2",
        "targetGroupId": 4772,
        "targetGroupName": "test cyclic 2",
        "source": "API",
        "targetPeriodId": 14406,
        "targetPeriodName": "PERIOD_G_4772_1",
        "targetCycleStartDate": "2025-02-19 06:00:00.0",
        "targetCycleStartDateInMillis": 1739925000000, //Post timezone standardization
        "description": "",
        "milestoneDetails":
        []
    },
    "orgId": 50583,
    "refId": "50583_4faa2686f1b7d32c5c76d525e6ebbb38",
    "apiRequestId": "4faa2686f1b7d32c5c76d525e6ebbb38",
    "createdAt": 1760509550744,
    "loyaltyEventId": ""
}
```

## Target Customer Unenrolment Event (targetCustomerUnenrolment)

Notifies when a user is unenrolled from a target. You can send multiple event notifications to customers who are unenrolled from a particular target.

```json Fixed window
{
    "eventName": "targetCustomerUnenrolment",
    "eventSearchKey": "data.customerIdentifiers.customerId",
    "data":
    {
        "customerIdentifiers":
        ...
        "targetPeriodId": 46753,
        "targetPeriodName": "Cycle_1",
        "targetPeriodStartDate": "2025-09-15 00:00:00.0", //Being replaced by targetPeriodStartDateInMillis
        "targetPeriodStartDateInMillis": 1757874600000, //Post timezone standardization
        "description": "test milestone sep15",
        "milestoneDetails":
        []
    ...
    "orgId": 50583,
    "refId": "50583_e6970395e2fbf04e5428f7b3a40237ee",
    "apiRequestId": "e6970395e2fbf04e5428f7b3a40237ee",
    "createdAt": 1760509183998,
    "loyaltyEventId": ""
}
```
```Text Cyclic window
{
    ...
    "orgId": 50583,
    "refId": "50583_6f3fc0eb51badd903d86983fa30eaa98",
    "apiRequestId": "6f3fc0eb51badd903d86983fa30eaa98",
    "createdAt": 1760509509366,
    "loyaltyEventId": ""
}
```
...
```json Webhook payload
{
        ...
        [
            {
                ...
                "streakLevelName": "1 and 2 transaction streak_1",
                "streakName": "1 and 2 transaction streak",
                "streakId": "4568",
                "userStreakId": "4",
                "streakLevelAchievedDate": "2025-10-15T12:03:11.252+0530", //Being replaced by streakLevelAchievedDateInMillis
                "streakLevelAchievedDateInMillis": 1760509991252 //Post Timezone standardisation
            }
        ],
        "targetData":
        [
            {
                "id": 5907,
                "name": "1 and 2 transaction streak",
                "targetGroupId": 8444,
                "targetGroupName": "1 and 2 transaction streak",
                "targetPeriodId": 51230,
                "targetPeriodName": "Cycle_15",
                "description": ""
            }
        ],
        "triggeringActivity":
    ...
    "orgId": 50583,
    "refId": "50583_beaec2879f11bbab3cef2135d119f5ce",
    "apiRequestId": "beaec2879f11bbab3cef2135d119f5ce",
    "createdAt": 1760509991268,
    "loyaltyEventId": "23857639"
}
```
```json Non webhook payload
{
    ...
    "streakData": [
      {
        ...
        "streakLevelAchievedDateInMillis": 1761629791527
      }
    ],
    "targetData": [
      {
...
```json Webhook payload
{
    ...
    "data":
    {
        ...
        [
            {
                "streakName": "1 and 2 transaction streak_2",
                "numberOfLevel": 2,
                "levelValues":
                [
                    "1",
                ...
                "userStreakId": "2",
                "startDate": "2025-10-07 00:00:00", //Being replaced by startDateInMillis
                "startDateInMillis": 1759775400000,//Post Timezone standardisation
                "endDate": "2025-10-07 23:59:59", //Being replaced by endDateInMillis
                "endDateInMillis": 1759861799000,//Post Timezone standardisation
                "streakValueWhenEnrolled": "2",
                "enrolledDate": "2025-10-05 13:03:07", //Being replaced by enrolledDateInMillis
                "enrolledDateInMillis": 1759649587000 //Post Timezone standardisation
            },
            {
                "streakName": "1 and 2 transaction streak_1",
                "numberOfLevel": 1,
                "levelValues":
                [
                    "1",
                ...
                "endDateInMillis": 1759861799000,//Post Timezone standardisation
                "streakValueWhenEnrolled": "1",
                "enrolledDate": "2025-10-04 20:24:24",
                "enrolledDateInMillis": 1759589664000 //Post Timezone standardisation
            }
        ],
        "targetData":
        [
            {
                ...
                "targetGroupId": 8444,
                "targetGroupName": "1 and 2 transaction streak",
                "targetPeriodId": 51222,
                "targetPeriodName": "Cycle_7",
                "description": ""
            }
        ],
        "triggeringActivity":
        {
            ...
            [
                {
                    "key": "ENROL_VIA_API",
                    "value": "03517a5fe2304238cceadfdb121bced0"
                }
            ],
            "additionalAttributes":
            []
    ...
    "orgId": 50583,
    "refId": "50583_03517a5fe2304238cceadfdb121bced0",
    "apiRequestId": "03517a5fe2304238cceadfdb121bced0",
    "createdAt": 1760508832446
}
```
```json Non webhook payload
{
    ...
    "streakEnrolmentData": [
      {
        ...
        "endDate": "UZO",
        "endDateInMillis": 1761609599000,
        "streakName": "KLOSEESYFN",
        "startDate": "COLWASFN",
        "startDateInMillis": 1761523200000,
        "streakValueWhenEnrolled": "DDYE",
        "enrolledDate": "2025-10-05 13:03:07",
        "enrolledDateInMillis": 1759649587000
,
...
```json Webhook payload
{
    ...
    "data":
    {
        ...
        [
            {
                ...
                "userStreakId": "2",
                "startDate": "2025-10-04 00:00:00", //Being replaced by startDateInMillis
                "startDateInMillis": 1759516200000, //Post Timezone standardisation
                "endDate": "2025-10-04 23:59:59", //Being replaced by endDateInMillis
                "endDateInMillis": 1759602599000,//Post Timezone standardisation
                "streakValueWhenUnEnrolled": "2",
                "unEnrolledDate": "2025-10-15 11:41:29", //Being replaced by unEnrolledDateInMillis
                "unEnrolledDateInMillis": 1760508689861 //Post Timezone standardisation
            },
            {
                "streakName": "1 and 2 transaction streak_1",
                "numberOfLevel": 1,
                ...
                "endDate": "2025-10-04 23:59:59", //Being replaced by endDateInMillis
                "endDateInMillis": 1759602599000, //Post Timezone standardisation
                "streakValueWhenUnEnrolled": "1",
                "unEnrolledDate": "2025-10-15 11:41:29", //Being replaced by unEnrolledDateInMillis
                "unEnrolledDateInMillis": 1760508689870 //Post Timezone standardisation
            }
        ],
        "targetData":
        [
        ...
        "triggeringActivity":
        {
            ...
            [
                {
                    "key": "UNENROL_VIA_APIq",
                    "value": "f9786a3846c135eaf2b330e585aa5ef0"
                }
            ],
            "additionalAttributes":
            []
    ...
    "orgId": 50583,
    "refId": "50583_f9786a3846c135eaf2b330e585aa5ef0",
    "apiRequestId": "f9786a3846c135eaf2b330e585aa5ef0",
    "createdAt": 1760508689878
}
```
```json Non webhook payload
{
    ...
    "streakUnEnrolmentData": [
      {
        ...
        "unEnrolledDate": "2025-10-15 11:41:29",
        "unEnrolledDateInMillis": 1760508689861,
        "startDate": "GIIJT",
        "startDateInMillis": 1761523200000,
...
```json Webhook payload
{
    ...
    "data":
    {
        ...
        "targetDetails":
        {
            ...
            "targetGroupId": 110834,
            "targetGroupName": "daily transaction",
            "targetPeriodId": 218894,
            "targetPeriodName": "Cycle_1",
            "description": ""
        },
        "streakStartData":
        [
            {
                "streakName": "daily transaction",
                "descriptionOfTheStreak": "",
                "numberOfLevel": 2,
                "levelValues":
                [
                    "1",
                ...
                "userStreakValueAtTheStart": "1",
                "startDate": "2025-10-01 05:30:00",//Being replaced by startDateInMillis
                "startDateInMillis": 1759276800000 //Post Timezone standardisation
            }
        ],
        "triggeringActivity":
        {
...
```json Webhook payload
{
    ...
    "data":
    {
        ...
        "targetDetails":
        {
            ...
            "targetGroupId": 110834,
            "targetGroupName": "daily transaction",
            "targetPeriodId": 218984,
            "targetPeriodName": "Cycle_91",
            "description": ""
        },
        "streakEndData":
        [
            {
                ...
                "numberOfLevelsAchievedByTheUser": "1",
                "levelsAchievedByTheUser":
                [
                    "1"
                ],
                "userStreakValueByTheEnd": "1",
                "endDate": "2025-12-31 05:29:59", //Being replaced by endDateInMillis
                "endDateInMillis": 1767139199000 //Post Timezone standardisation
            }
        ],
        "triggeringActivity":
        {
...
<Table>
  ...
  <tbody>
    ...
    <tr>
      ...
      <td>
        Breakdown of regular points issued.
      </td>
    </tr>
    ...
    <tr>
      ...
      <td>
        Expiry date of the points. This field will be replaced by expiryAtInMillis
      </td>
    </tr>
    ...
    <tr>
      ...
      <td>
        Expiry date in the Unix epoch timestamp.
      </td>
    </tr>
    ...
    <tr>
      <td>
        ---promotionPointsExpiryDate
      </td>

      <td>
        Promotional points expry date. This field will be replaced by promotionPointsExpiryDateInMillis.
      </td>
    </tr>

    <tr>
      <td>
        ---promotionPointsExpiryDateInMillis
      </td>

      <td>
        Promotional points expry date in the Unix epoch timestamp.
      </td>
    </tr>
    ...
    <tr>
      ...
      <td>
        Promised points issued in the event.
      </td>
    </tr>

    <tr>
      <td>
        ---promisedPointsConversionDate
      </td>

      <td>
        Promoised points conversion date. This field will be replaced by promisedPointsConversionDateInMillis.
      </td>
    </tr>

    <tr>
      <td>
        ---promisedPointsConversionDateInMillis
      </td>

      <td>
        Promised points conversion date in the Unix epoch timestamp.
      </td>
    </tr>
...
```json via transaction
{
    ...
    "data":
    {
        ...
        {
            "id": 1377,
            "name": "Krishna's MallDefaultProgram",
            "isDefault": true,
        ...
        "programCurrentPoints": 45.0,
        "programLifetimePoints": 45.0,
        "totalPointsIssued": 8.0,
        "regularPointsIssued": 3.0,
        "regularPointsBreakup":
        [
            {
                "points": 1.0,
                "expiryAt": "2025-10-28",
                "expiryAtInMillis": 1761676199999
            },
            {
                "points": 2.0,
                "expiryAt": "2026-01-31",
                "expiryAtInMillis": 1769884199999
            }
        ],
        "promotionalPointsIssued":
        [
            {
                "promotionIdentifier": "098190b8-3277-4f7d-aa0b-eb1475f7110d",
                "promotionType": "BILL_PROMOTION",
                "promotionPoints": 2.0,
                "promotionPointsExpiryDate": "2025-10-28",
                "promotionPointsExpiryDateInMillis": 1761676199999
            },
            {
                "promotionIdentifier": "37f3d975-3bd1-4052-bb2a-d5b3227e54dd",
                "promotionType": "BILL_PROMOTION",
                "promotionPoints": 3.0,
                "promotionPointsExpiryDate": "2026-01-31",
                "promotionPointsExpiryDateInMillis": 1769884199999
            }
        ],
        "promisedPointsIssued":
        [
            {
                ...
                "promisedPointsConversionDate": "2025-11-07",
                "promisedPointsConversionDateInMillis": 1762453800000
            },
            {
                "promisedPoints": 3.0,
                "isExternalTriggerBased": false,
                "promisedPointsConversionDate": "2025-10-30",
                "promisedPointsConversionDateInMillis": 1761762600000,
                "promotionIdentifier": "37f3d975-3bd1-4052-bb2a-d5b3227e54dd"
            }
        ]
    },
    "eventLogId": 23939437,
    "orgId": 50583,
    "refId": "50583_wIybJMkaCq",
    "apiRequestId": "6950f9b11855c30751ef284e15d4a373",
    "createdAt": 1761624502438,
    "loyaltyEventId": "wIybJMkaCq"
}
```
```json Non webhook payload
{
    ...
    "promisedPointsIssued": [
      {
        ...
        "promisedPointsConversionDateInMillis": 1762214400000,
    ...
    "regularPointsBreakup": [
      {
        ...
        "expiryAt": "QHBZZWGAW",
        "expiryAtInMillis": 1796083199999
      }
    ],
    "promotionalPointsIssued": [
      {
        ...
        "promotionPointsExpiryDateInMillis": 1762559999999
      }
    ]
  },
  "refId": "SYTIRZNM",
  ...
  "createdAt": 9764,
  "traceAttributes": {
    "x-cap-lineage-id": "88b3bcd7-545b-4ac0-9ad2-e33195f37f4b",
    "x-cap-lineage-start": "1762178039768"
  },
  "orgId": 5795
}
```
```Text Good will points
{
    "eventName": "pointsIssued",
    "eventSearchKey": "data.customerIdentifiers.customerId",
    "data":
    {
        ...
        "loyaltyProgramId": 1377,
        "programCurrentPoints": 224.0,
        "programLifetimePoints": 18003.016,
        "totalPointsIssued": 10.0,
        ...
        [
            {
                "promotionIdentifier": "",
                "promotionType": "Goodwill Promotion",
                "promotionPoints": 10.0,
                "promotionPointsExpiryDate": "2025-10-28",
                "promotionPointsExpiryDateInMillis": 1761676199999
            }
        ],
    ...
    "eventLogId": 23940767,
    "orgId": 50583,
    "refId": "50583_e4f1ff35b889215a8ffd7df08c2b2c84",
    "apiRequestId": "e4f1ff35b889215a8ffd7df08c2b2c84",
    "createdAt": 1761653811849,
    "loyaltyEventId": "e4f1ff35b889215a8ffd7df08c2b2c84"
}
```
...
<Table align={["left","left","left"]}>
  ...
  <tbody>
    ...
    <tr>
      ...
      <td>
        Type of the entity (e.g., "USER", USERGROUP2).
      </td>
    </tr>
...
```json Webhook payload
{
  ...
  "data": {
    ...
    "loyaltyProgramId": 973,
    "totalPointsRedeemed": 10,
    "redemptionSummaryId": 28070048,
    "redeemedPointsCurrencyValue": 10,
    "redemptionNotes": "",
    "redemptionBillNumber": "txn-251",
    "isGroupRedemption": false,
    "redemptionFromEarningPrograms": [
      {
        "programId": 973,
        "pointsRedeemed": 10,
        "programCurrentPoints": 1990
      }
    ]
  },
  "loyaltyEventId": "fif7qJh6gz",
  "eventName": "pointsRedeemed",
  "eventSearchKey": "data.customerIdentifiers.customerId",
  "eventLogId": 664420009,
  "refId": "100737_fif7qJh6gz",
  "apiRequestId": "36a27fa97b9066f45af4827dbddd4926",
  "orgId": 100737,
  "eventId": "77c311c7-c210-4fe2-845e-73ff507330f2"
}
```
```json Non webhook payload
{
...
<Table align={["left","left","left"]}>
  ...
  <tbody>
    ...
    <tr>
      ...
      <td>
        The exact moment the activity occurred. This field is being replaced by eventDateTimeInMillis.
      </td>
    </tr>

    <tr>
      <td>
        eventDateTimeInMillis
      </td>
      ...
      <td>
        The exact moment the activity occurred in the Unix epoch timestamp.
      </td>
    </tr>
    ...
    <tr>
      ...
      <td>
        Promotion start date. This field is being replaced by promotionStartDateInMillis.
      </td>
    </tr>

    <tr>
      <td>
        promotionStartDateInMillis
      </td>
      ...
      <td>
        Promotion start date in in the Unix epoch timestamp.
      </td>
    </tr>
    ...
    <tr>
      ...
      <td>
        Promotion end date. This field is being replaced by promotionEndDateInMillis.
      </td>
    </tr>

    <tr>
      <td>
        promotionEndDateInMillis
      </td>
      ...
      <td>
        Promotion end date in the Unix epoch timestamp.
      </td>
    </tr>
...
```json Points unlock API
{
    ...
    "data":
    {
        ...
        [],
        "pointsConverted": 5.0,
        "eventDateTime": "2025-10-28 17:36:11",
        "eventDateTimeInMillis": 1761653171260,
                ...
                [
                    {
                        ...
                        "programId": 1377,
                        "promotionId": 231444,
                        "promotionName": "extra promised points promotion",
                        "promotionDetails":
                        [
                            {
                                "programId": 1377,
                                ...
                                "promotionStartDate": "2025-10-01 00:00:00.0",
                                "promotionStartDateInMillis": 1759257000000,
                                "promotionEndDate": "2027-04-01 23:59:59.0",
                                "promotionEndDateInMillis": 1806604199000,
    ...
    "orgId": 50583,
    "refId": "",
    "apiRequestId": "abd572f0c25309ef436333a29be7a2d4",
    "createdAt": 1761653171258,
    "loyaltyEventId": ""
}
```
```Text Delayed accrual job
{
...
<Table align={["left","left","left"]}>
  ...
  <tbody>
    <tr>
      ...
      <td>
        Name of the event (e.g., "pointsExpired").
      </td>
    </tr>
    ...
    <tr>
      ...
      <td>
        This is used for internal debugging purposes.
      </td>
    </tr>
    ...
    <tr>
      ...
      <td>
        The primary identifier used to search or filter the event.  
        Supported fields:

        `customerIdentifiers.customerId` – Capillary's internal unique customer ID
        `customerIdentifiers.firstName` – First name of the customer
        `customerIdentifiers.lastName` – Last name of the customer
        `customerIdentifiers.instore.mobile` – Mobile number of the customer
        `customerIdentifiers.instore.email` – Email address of the customer
        `customerIdentifiers.instore.externalId` – External system identifier for the customer
        `customerIdentifiers.instore.cardnumber` – Loyalty card number of the customer
        `customerIdentifiers.instore.cardexternalid` – External identifier for the customer's loyalty card
        `customerIdentifiers.ecommerce.accounts[].identifiers` – Identifiers from linked e-commerce platform accounts
        `customerIdentifiers.facebook.accounts[].identifiers` – Identifiers from linked Facebook accounts
        `customerIdentifiers.wechat.accounts[].identifiers` – Identifiers from linked WeChat accounts
        `customerIdentifiers.web_engage.accounts[].identifiers` – Identifiers from linked WebEngage accounts
        `customerIdentifiers.line.accounts[].identifiers` – Identifiers from linked LINE accounts
        `customerIdentifiers.martjack.accounts[].identifiers` – Identifiers from linked Martjack accounts
      </td>
    </tr>
    ...
    <tr>
      ...
      <td>
        Name of the loyalty program (e.g., "DocDemoDefaultProgram").
      </td>
    </tr>
    ...
    <tr>
      ...
      <td>
        Number of the tier (e.g., 1 for Bronze).
      </td>
    </tr>
    ...
    <tr>
      ...
      <td>
        Contains information about the activity that triggered the event (empty in this case).
      </td>
    </tr>
...
```json Webhook payload
{
  ...
  "eventSearchKey": "data.customerIdentifiers.customerId",
  "eventLogId": 662389307,
  "refId": "100737_STRINGstring",
  "apiRequestId": "STRINGstring-o100737-p973-pc2143-b1",
  "orgId": 100737,
  "eventId": "8bcc7b68-f7b7-4826-8438-df24055a2c1e"
}
```
```json Non webhook payload
{
...
| scheduledExpiryDate         | String           | Date when the points are scheduled to expire (formatted as YYYY-MM-DD). This parameter is being replaced by scheduledExpiryDateInMillis. |
| scheduledExpiryDateInMillis | String           | Date when the points are scheduled to expire in the Unix epoch timestamp.                                                                |
...
```json Webhook payload
{
    ...
    "data":
    {
        ...
        "loyaltyProgramId": 1377,
        "pointsScheduledForExpiry": 7.0,
        "scheduledExpiryDate": "2025-11-05",
        "scheduledExpiryDateInMillis": 1762367399000
    },
    "orgId": 50583,
    "refId": "50583_abcd",
    "apiRequestId": "a150",
    "createdAt": 1762335776925
}
```
```json Non webhook payload
{
  ...
  "data": {
    ...
    "scheduledExpiryDateInMillis": 1762991999000
  },
  "refId": "URA",
...
| --- loyaltyProgramDetails                | Object           | Contains details about the loyalty program.                                                       |
| ---- id                                  | Integer          | Unique identifier for the loyalty program.                                                        |
| ---- name                                | String           | Name of the loyalty program (e.g., "newshard\_orgDefaultProgram").                                |
| ---- isDefault                           | Boolean          | Indicates if the program is the default program.                                                  |
| ---- pointsToCurrencyRatio               | Float            | Points-to-currency conversion ratio.                                                              |
| ---- tiers                               | Array of Objects | List of tiers in the loyalty program.                                                             |
...
| --- loyaltyProgramDetails               | Object           | Contains details about the loyalty program.                                                     |
| ---- id                                 | Integer          | Unique identifier for the loyalty program.                                                      |
| ---- name                               | String           | Name of the loyalty program (e.g., "Abbott ID\_ProdDefaultProgram").                            |
| ---- isDefault                          | Boolean          | Indicates if the program is the default program.                                                |
| ---- pointsToCurrencyRatio              | Float            | Points-to-currency conversion ratio.                                                            |
| ---- tiers                              | Array of Objects | List of tiers in the loyalty program.                                                           |
...
| ---- oldExpiryDate        | String           | The previous expiry date of the points (in YYYY-MM-DD format). This parameter is being replaced by oldExpiryDateInMillis. |
| ----oldExpiryDateInMillis | String           | The previous expiry date of the points in the Unix epoch timestamp.                                                       |
| ---- newExpiryDate        | String           | The new expiry date of the points (in YYYY-MM-DD format). This parameter is being replaced by newExpiryDateInMillis.      |
| ----newExpiryDateInMillis | String           | The new expiry date of the points in the Unix epoch timestamp.                                                            |
...
```json Webhook payload
{
        ...
        [
            {
                ...
                "oldExpiryDate": "2025-11-05",
                "oldExpiryDateInMillis": 1762367399000,
                "newExpiryDate": "2026-02-28",
                "newExpiryDateInMillis": 1772303399000
            },
            {
                "programId": 1377,
                "points": 1.0,
                "pointsType": "billRegular",
                "oldExpiryDate": "2025-11-10",
                "oldExpiryDateInMillis": 1762799399000,
                "newExpiryDate": "2026-02-28",
                "newExpiryDateInMillis": 1772303399000
            }
        ]
    ...
    "orgId": 50583,
    "refId": "50583_0c5bfe5611c02dfc216ee5da9b72c331",
    "apiRequestId": "0c5bfe5611c02dfc216ee5da9b72c331",
    "createdAt": 1762336182549
}
```
```json Non webhook payload
{
    ...
    "updatedPointsExpiry": [
      {
        ...
        "oldExpiryDateInMillis": 1767225599000,
        "newExpiryDate": "VQXMR",
        "newExpiryDateInMillis": 1796083199000
      }
    ]
  },
  "refId": "FBFJERJVV",
...
| --- id                                        | Integer          | Unique identifier for the loyalty program.                                                        |
| --- name                                      | String           | Name of the loyalty program (e.g., "Shell Indonesia\_ProdDefaultProgram").                        |
...
```json Via thrift (API-Immediate)
{
    ...
    "data":
    {
        ...
        [
            {
                "pointAwardedRefID": 719915883,
                "pointsAwardedRefType": "POINT_AWARDED",
                "pointsPreviousExpiryDate": "2025-10-28 23:59:59",
                "pointsPreviousExpiryDateInMillis": 1761676199000, //Post timezone standardization
                "expiryUpdateReasonType": "EXTEND_EXPIRY",
                "expiryUpdateReasonNote": "extend expiry yo",
                "newExpiryDate": "2025-10-30 23:59:59",
                "newExpiryDateInMillis": 1761848999719
            }
        ]
    },
    "orgId": 50583,
    "refId": "50583_defg",
    "apiRequestId": "defg",
    "createdAt": 1761654912859,
    "loyaltyEventId": "defg"
}
```
```Text via Points Expiry Batch (Scheduled job)
{
    "eventName": "pointsExpiryChange",
    "eventSearchKey": "data.customerIdentifiers.customerId",
    "data":
    {
        ...
        [
            {
                "pointAwardedRefID": 719922673,
                "pointsAwardedRefType": "POINT_AWARDED",
                "points": 1.0,
                "pointsPreviousExpiryDate": "2026-02-28",
                "pointsPreviousExpiryDateInMillis": 1772303399000, //Post timezone standardization
                "expiryUpdateReasonType": "EARLY_EXPIRY",
                "expiryUpdateReasonNote": "change in terms",
                "newExpiryDate": "2025-11-05",
                "newExpiryDateInMillis": 1762367399000 //Post timezone standardization
            },
            {
                "pointAwardedRefID": 719925027,
                "pointsAwardedRefType": "POINT_AWARDED",
                "points": 1.0,
                "pointsPreviousExpiryDate": "2026-02-28",
                "pointsPreviousExpiryDateInMillis": 1772303399000, //Post timezone standardization
                ...
                "expiryUpdateReasonNote": "change in terms",
                "newExpiryDate": "2025-11-05",
                "newExpiryDateInMillis": 1762367399000
            },
            {
                "pointAwardedRefID": 719925051,
                "pointsAwardedRefType": "POINT_AWARDED",
                "points": 1.0,
                "pointsPreviousExpiryDate": "2026-02-28",
                "pointsPreviousExpiryDateInMillis": 1772303399000, //Post timezone standardization
            ...
            {
                "pointAwardedRefID": 18679106,
                "pointsAwardedRefType": "POINT_AWARDED_BILL_PROMOTION",
                "promotionID": 231422,
                "points": 2.0,
                "pointsPreviousExpiryDate": "2025-11-05",
                "pointsPreviousExpiryDateInMillis": 1762367399000, //Post timezone standardization
                "expiryUpdateReasonType": "EARLY_EXPIRY",
                "expiryUpdateReasonNote": "change in terms",
                "newExpiryDate": "2025-11-05",
                "newExpiryDateInMillis": 1762367399000
            ...
            {
                "pointAwardedRefID": 18679108,
                "pointsAwardedRefType": "POINT_AWARDED_BILL_PROMOTION",
                "promotionID": 231422,
                "points": 2.0,
                "pointsPreviousExpiryDate": "2025-11-06",
                "pointsPreviousExpiryDateInMillis": 1762453799000, //Post timezone standardization
                "expiryUpdateReasonType": "EARLY_EXPIRY",
                "expiryUpdateReasonNote": "change in terms",
                "newExpiryDate": "2025-11-05",
                "newExpiryDateInMillis": 1762367399000
    ...
    "orgId": 50583,
    "refId": "50583_aQsV2Ar6QZcAACc2S4EAAAAJ",
    "apiRequestId": "aQsV2Ar6QZcAACc2S4EAAAAJ",
    "createdAt": 1762334169639
}
```
...
```json Webhook payload
{
    ...
    "data": {
        ...
        "eventDateTimeInMillis": 1739860477000, // 
        "earningActivityReference": [
            {
                "name": "TransactionAdd",
                "enteredAt": 1739857830000, // Fixed scientific notation (1.73985783E12)
...
An alternate currency is a type of reward currency, similar to points, that brands can create and use within their loyalty programs to incentivise customer behavior.
        ...
        [
            {
                ...
                "alternateCurrencyIdentifier": "e8XLBB",
                "programCurrentAlternateCurrencies": 56.0,
                "programLifetimeAlternateCurrencies": 56.0,
                "totalAlternateCurrenciesIssued": 7.0,
                "regularAlternateCurrenciesIssued": 1.0,
                "regularAlternateCurrenciesBreakup":
                [
                    {
                        "alternateCurrencies": 1.0,
                        "expiryAt": "2025-10-28",
                        "expiryAtInMillis": 1761676199999
                    }
                ],
                ...
                [
                    {
                        "promotionIdentifier": "4673470b-6ef7-4c50-90d3-57b2e1feea45",
                        "promotionType": "BILL_PROMOTION",
                        "promotionAlternateCurrencies": 3.0,
                        "promotionAlternateCurrenciesExpiryDate": "2025-10-28",
                        "promotionAlternateCurrenciesExpiryDateInMillis": 1761676199999 //Post Timezone standardisation
                    },
                    {
                        "promotionIdentifier": "4673470b-6ef7-4c50-90d3-57b2e1feea45",
                        "promotionType": "BILL_PROMOTION",
                        "promotionAlternateCurrencies": 3.0,
                        "promotionAlternateCurrenciesExpiryDate": "2026-01-31",
                        "promotionAlternateCurrenciesExpiryDateInMillis": 1769884199999 //Post Timezone standardisation
                    }
                ],
            ...
            {
                "alternateCurrencyName": "boosts",
                "alternateCurrencyIdentifier": "X354ry",
                "programCurrentAlternateCurrencies": 6.0,
                "programLifetimeAlternateCurrencies": 6.0,
                "totalAlternateCurrenciesIssued": 2.0,
                "regularAlternateCurrenciesIssued": 2.0,
                "regularAlternateCurrenciesBreakup":
                [
                    {
                        "alternateCurrencies": 2.0,
                        "expiryAt": "2026-01-31",
                        "expiryAtInMillis": 1769884199999 //Post Timezone standardisation
                    }
                ],
                "promotionalAlternateCurrenciesIssued":
                [],
        ...
        "promotionalAlternateCurrenciesIssued": [
          {
            ...
            "promotionAlternateCurrenciesExpiryDateInMillis": 1762559999999
          }
        ],
        "promisedAlternateCurrenciesIssued": [
          {
        ...
        "regularAlternateCurrenciesBreakup": [
          {
            ...
            "expiryAt": "MLHUAULU",
            "expiryAtInMillis": 1762559999999
          }
        ],
        ...
        [
            {
                "alternateCurrencyIdentifier": "e8XLBB",
                "alternateCurrencyName": "stars",
                "alternateCurrencyValue": "3.000"
            },
            {
                "alternateCurrencyIdentifier": "X354ry",
                "alternateCurrencyName": "boosts",
                "alternateCurrencyValue": "2.000"
            }
        ],
                        ...
                        [
                            {
                                ...
                                "promotionStartDate": "2025-10-01 00:00:00.0",
                                "promotionStartDateInMillis": 1759257000000,
                                "promotionEndDate": "2027-05-01 23:59:59.0",
                                "promotionEndDateInMillis": 1809196199000,
                                "pointsOfferType": "GENERIC",
                                "customFields":
                                [],
                                "issueRestrictions":
            ...
            "promotionDetails": [
              {
                ...
                "promotionEndDateInMillis": 1798847999000,
                "customFields": [],
