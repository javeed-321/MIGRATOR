...
It is strongly recommended to enable both **Merge Based on Common Name** and **Alphabetical Sort** when using the Join Data block, as these settings ensure files are matched and sequenced correctly. </Callout>