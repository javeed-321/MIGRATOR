...
> 📘 **Note**
>
> To modify details of a loyalty program, select **Edit program**.
>
> * The following details of the loyaly program can be edited:
>   * Name:
>   * Description
>   * Contibutors
...
8. In the listing page, hover over a loyalty program name to view its program identifier.
   ...
   <Image align="center" border={true} width="80% " src="https://files.readme.io/e07ed3774f17989f508a5c1487588e06e5be2ff2a4668cf5da49207747c1fcd6-image.png" className="border" />
...
Step 5: In the API for redemption use the parameter "group\_redemption": true  and for transfer use "groupProgramTransfer": true  in the request body
...
Transactions and other events posted via APIs are always evaluated by the default program and resolved & evaluated by any 1 other non-default program based on the till\_id or store code associated with the authorisation used - this is in case of zone or concept based MLP
...
Most APIs will also commonly support program\_id as a query parameter to pass the program ID and get the specific details for that particular program
...
What should I do when I get an error *group redemption action executed for non group redemption payload*?
