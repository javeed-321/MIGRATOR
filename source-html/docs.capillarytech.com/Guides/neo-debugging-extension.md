...
The Neo Debugging Extension is a browser extension designed to help you with the debugging process for Neo dataflow executions within Capillary. It offers multiple monitoring tools for Neo dataflow's.
...
1. For Chrome users:
   ...
   * Confirm the installation when prompted.
   ...
   <Image align="center" className="border" border={true} width="80% " src="https://files.readme.io/e6e0f8404f75bf599627f289aa475071849d50db2089b358aa697cfc878020b6-image4.gif" />
...
3. Install from Dev Console:
   ...
   * Navigate to **Dev Console > Neo Debugger** (from the left navigation pane).
   ...
   <Image align="center" className="border" border={true} width="80% " src="https://files.readme.io/a7b8f53b7d089d3867c84284961a3d57ae49bbd6ed335595fd3454d58a47a2bf-image12.png" />
   ...
   * Click the **Install Neo Debugger Extension** icon.
   ...
   <Image align="center" className="border" border={true} width="80% " src="https://files.readme.io/d2fcbc6e7b7e2057b906159b5bddac0df04204518c1554c313f8ed990c60d258-image9.png" />
   ...
   * Click **Add extension**.
   ...
   <Image align="center" className="border" border={true} width="80% " src="https://files.readme.io/c35cdeaa12f42e921270fc2ac482db04955c2fc5039e62e39eed0c8205a62563-image4.gif" />
...
<Image align="center" className="border" border={true} width="80% " src="https://files.readme.io/b0bc330bd117866a3e67d7dbaf93a84b62c8d6ceb4238457ae0fafcee8dffa62-image5.png" />
...
<Image align="center" className="border" border={true} width="80% " src="https://files.readme.io/21855678b60c99fa5331bbe4b0c0304a05bc28fb5bb98eb45338dde928de9983-image1.gif" />
...
<Image align="center" className="border" border={true} width="80% " src="https://files.readme.io/db2d5d06efca2b70dd607d74bc74c30c2deb4a23f873db953de727aad97734c1-image7.png" />

### Block I/O Tab

This tab provides detailed information on input and output data for each block in your dataflow execution.

<Image align="center" className="border" border={true} width="60% " src="https://files.readme.io/6f8c8f80168efda7953a6b03cb9b703e8b8a99057fa79b0a8e75f9eb1d767d3f-image8.png" />
...
<Image align="center" className="border" border={true} width="80% " src="https://files.readme.io/232bbc9e2648ea8d82a954d7fc7f1f9fdfdcba00c26be9b124e39bb8a48711f4-image2.gif" />
...
<Image align="center" className="border" border={true} width="50% " src="https://files.readme.io/1c7a3b953f7f6b3d90d04f0ff8cf09470f79078b9fa085ec479511779a130efe-image3.png" />

<br />

* **Search and Highlight**: Enables you to search and highlight specific entries within the logs for quick analysis. For example.

<Image align="center" className="border" border={true} width="60% " src="https://files.readme.io/eb39fb77c1ecf40a5212473470725142ae4cd42c313fc2864de69a8441571d93-image10.png" />
...
<Image align="center" className="border" border={true} width="50% " src="https://files.readme.io/40cd777abb1ffb83d15a7bb6d0e30ddf764313a1208f3ee3fda6df3f96e0a3ea-image11.png" />
...
<Image align="center" className="border" border={true} width="50% " src="https://files.readme.io/8e0708e5817a86126f2ac530c4ab529da3e3854cd67bbfb3b86e95acf282acd3-image6.png" />

<br />

* Paste the cURL command in the input text box.

<Image align="center" className="border" border={true} width="50% " src="https://files.readme.io/4a20e0b519c9abdda5019f12179c05333545e7ff030c1461c09677e54779f68c-image14.png" />
...
<Image align="center" className="border" border={true} width="50% " src="https://files.readme.io/7eb7b7752de8deaf157b33c7413a1e1d4356d0457dfdd90eab42cd10c055a896-image13.png" />
