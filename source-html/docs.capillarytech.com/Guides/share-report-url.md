...
<Image align="center" className="border" border={true} src="https://files.readme.io/8b34b89-Share_URL.png" />

2. Click **Share URL**. An URL of the current report snapshot will be generated for the report.

<Image align="center" className="border" border={true} src="https://files.readme.io/a494280-Share_URL_link.png" />
