...
<Image align="center" border={true} src="https://files.readme.io/7f2ddad-VIew_Subscription.png" className="border" />
...
<Image align="center" border={true} src="https://files.readme.io/aa1247b-Edit_program.png" className="border" />

3. In the **Subscription Program** tab, click **Add subscription program**.

<Image align="center" border={true} src="https://files.readme.io/48b37dc-Add_subscription_program.png" className="border" />
...
6. In the **Duration** field, enter the program's validity in days or months. This is the period during which a customer remains enrolled in a subscription program and can enjoy its benefits. When a customer is linked to a subscription program, the exact day they enroll is treated as a bonus "Day 0." The official count for the configured duration starts at midnight. For example, if you set the duration to **5 Days** and a customer enrolls on **April 1st at 10:00 AM**, the system will add exactly 5 full days to their enrollment date, and the day the customer enrolls is considered as day zero. The subscription will remain active from 10 AM on April 1st and will officially expire on **April 6th at 11:59:59 PM (End of Day)**.
7. Click **Next**.

<Image align="center" border={true} src="https://files.readme.io/1c76f32-New_subscription_program.png" className="border" />

8. From the **Benefit type**  and **Linked promotion** drop-downs, select the benefit type and promotion.
9. Click the tick-mark icon. To add more benefits, click **+Add benefits**.
10. Click **Save**
...
<Image align="center" border={true} src="https://files.readme.io/1925590-Edit_subscription.gif" className="border" />
...
4. Click **Save**.
   ...
   <Image align="center" border={true} src="https://files.readme.io/5e3218f-Add_benefit.gif" className="border" />
...
<Image align="center" border={true} src="https://files.readme.io/e24f385-Configure_subscription_expiry.gif" className="border" />
...
<Image align="center" border={true} src="https://files.readme.io/a0a756d-Set_expiry_date.png" className="border" />
...
<Image align="center" border={true} src="https://files.readme.io/fc477e8-Advanced_Settings.gif" className="border" />
...
* \[View Customer History with Partner/Supplementary Programs]\(<https://docs.capillarytech.com/reference/customeractivityhistories>
