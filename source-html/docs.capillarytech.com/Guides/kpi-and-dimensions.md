...
<Image align="center" className="border" width="600px" border={true} src="https://files.readme.io/7eb4afc-image.png" />

2. From the dropdown, select **KPI**.

<Image align="center" className="border" width="250px" border={true} src="https://files.readme.io/b0429e6-image.png" />
...
<Image align="center" className="border" width="600px" border={true} src="https://files.readme.io/d937ae3-image.png" />
...
<Image align="center" className="border" width="250px" border={true} src="https://files.readme.io/3f7251a-image.png" />

3. You can view the dimensions from the dimensions list.

<Image align="center" className="border" width="600px" border={true} src="https://files.readme.io/5763f9b-image.png" />
...
<Image align="center" className="border" width="600px" border={true} src="https://files.readme.io/23f8b81-image.png" />
...
<Image align="center" className="border" width="600px" border={true} src="https://files.readme.io/1f1bef9-image.png" />

4. Enter the dimension name, description, and details on the basis that the data should be segregated, and click **Next**.

<Image align="center" className="border" width="600px" border={true} src="https://files.readme.io/12802dc-image.png" />

5. Enter the number of bands, and input the band names and the breakpoints.

<Image align="center" className="border" width="600px" border={true} src="https://files.readme.io/d727f59-image.png" />

5. Click **Create**.

You have successfully created a dimension.

<Image align="center" className="border" width="400px" border={true} src="https://files.readme.io/db24b47-image.png" />
...
<Image align="center" className="border" width="600px" border={true} src="https://files.readme.io/f601be1-KPI.png" />