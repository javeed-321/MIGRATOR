...
* **CAP POC:** Ensure a CAP POC is set for the organization. Only users registered in the Capillary organization (org\_id=0) are eligible to be added as Organization Points of Contact (POCs). Users from client-specific organizations will not appear in the POC selection list. To set a POC, navigate to **Organization settings** > **Organization Setup** > **Organization Profile** > **Organization POC**. Setting a POC is required to send an email to set a password for the user.

<Image align="center" border={true} width="85% " src="https://files.readme.io/37f37e6f26b822e2d54fa65480520d2a78e2f50447f51a2924672ea9b0a56464-image.png" className="border" />
...
<Image align="center" border={true} width="70% " src="https://files.readme.io/1068e2a-Roles.png" className="border" />
...
<Image align="center" border={true} width="70% " src="https://usercontent.clueso.io/64d06f10-2e0e-40ec-b636-a868315fe5a6/89ec4425-e73d-4fbf-aec4-fa2ee10793f4/acb0a7f8-ef60-4e6c-9a5b-7bb84b846ea6/images/cfa0fca5-79c5-4dd7-9969-801fce541155.png" className="border" />

2. Select **Add with email addresses** and click **Continue**.

<Image align="center" border={true} width="75% " src="https://usercontent.clueso.io/64d06f10-2e0e-40ec-b636-a868315fe5a6/89ec4425-e73d-4fbf-aec4-fa2ee10793f4/acb0a7f8-ef60-4e6c-9a5b-7bb84b846ea6/images/4b7cdca8-3e58-4d3a-836d-19d1ae4fca8a.png" className="border" />
...
<Image align="center" border={true} width="75% " src="https://usercontent.clueso.io/64d06f10-2e0e-40ec-b636-a868315fe5a6/89ec4425-e73d-4fbf-aec4-fa2ee10793f4/acb0a7f8-ef60-4e6c-9a5b-7bb84b846ea6/images/983b95ee-b18b-49c2-86b5-a10029114709.png" className="border" />

4. Select the User Type and click **Continue**. Please note that it is mandatory to assign a user type to each user.

<Image align="center" border={true} width="75% " src="https://usercontent.clueso.io/64d06f10-2e0e-40ec-b636-a868315fe5a6/89ec4425-e73d-4fbf-aec4-fa2ee10793f4/acb0a7f8-ef60-4e6c-9a5b-7bb84b846ea6/images/c4706865-d9e2-421f-9f8e-8e19f399ef5c.png" className="border" />
...
<Image align="center" border={true} width="75% " src="https://usercontent.clueso.io/64d06f10-2e0e-40ec-b636-a868315fe5a6/89ec4425-e73d-4fbf-aec4-fa2ee10793f4/acb0a7f8-ef60-4e6c-9a5b-7bb84b846ea6/images/e9ded079-16c9-44ec-8cca-2ea884a20c18.png" className="border" />
...
<Image align="center" border={true} width="75% " src="https://usercontent.clueso.io/64d06f10-2e0e-40ec-b636-a868315fe5a6/89ec4425-e73d-4fbf-aec4-fa2ee10793f4/acb0a7f8-ef60-4e6c-9a5b-7bb84b846ea6/images/0c76d029-1667-4ded-b083-869276a8d0f0.png" className="border" />

<Image align="center" border={true} width="75% " src="https://usercontent.clueso.io/64d06f10-2e0e-40ec-b636-a868315fe5a6/89ec4425-e73d-4fbf-aec4-fa2ee10793f4/acb0a7f8-ef60-4e6c-9a5b-7bb84b846ea6/images/683ca5c6-0c07-42d9-972f-cf0c51875e59.png" className="border" />

10. Click **Send invite**.

<Image align="center" border={true} width="75% " src="https://usercontent.clueso.io/64d06f10-2e0e-40ec-b636-a868315fe5a6/89ec4425-e73d-4fbf-aec4-fa2ee10793f4/acb0a7f8-ef60-4e6c-9a5b-7bb84b846ea6/images/b99be709-0cce-46d6-89f8-c968ba9e59b7.png" className="border" />

<Image align="center" border={true} width="75% " src="https://usercontent.clueso.io/64d06f10-2e0e-40ec-b636-a868315fe5a6/89ec4425-e73d-4fbf-aec4-fa2ee10793f4/acb0a7f8-ef60-4e6c-9a5b-7bb84b846ea6/images/2aa39f8a-1ac4-4532-a602-63a640b86f8a.png" className="border" />
...
1. Click **Add new user**.
   ...
   <Image align="center" border={true} src="https://files.readme.io/27997fe9cf30cdb1686f2e40b51f92db1732699666e02a0ff1a615622a5c2579-add_users.png" className="border" />
2. Select the **Bulk upload** option and click **Continue**.

<Image align="center" border={true} src="https://files.readme.io/275a1ba-Bulk_upload_user.png" className="border" />
...
4. Review the validation results and proceed if the CSV contains only valid entries. The system generates an `error.csv` file in the following scenarios:
   ...
   **All invalid entries**
   ...
   <Image align="center" border={true} caption="All invalid entries" src="https://files.readme.io/d979bc899983814984257e33a700baa72f87d17cefd8a8f38318df604c415491-Screenshot_2026-01-27_at_3.42.20_PM.png" />

   **Mix of valid and invalid entries**

   <Image align="center" border={false} caption="Mix of valid and invalid entries" src="https://files.readme.io/659b8171e0442e707483ef2b567e4c7562c10039663b11d76928f40263c318e3-Screenshot_2026-01-27_at_3.45.14_PM.png" />
...
5. (Optional) To replace the uploaded CSV file:
   1. Click **❌** next to the file name.\
      ...
      <Image align="center" border={true} src="https://files.readme.io/0dfd7e04b846e44c17c1b3d01eae67d24e19f2cc80931ba8a22d7a5aae7d0bc6-Screenshot_2026-01-27_at_4.33.17_PM.png" className="border" />
   2. Select **Yes, change file**.\
      The upload area reappears, allowing you to upload or drag a new CSV file.

      <Image align="center" border={true} src="https://files.readme.io/eedf4e0bbf339f8cdd8403b3bfc9af3728dedb71fac27473774895451036cdb8-Screenshot_2026-01-27_at_3.55.28_PM.png" className="border" />
...
6. Click **Add valid user(s)** to update the valid users.
   ...
   <Image align="center" border={true} src="https://files.readme.io/23f720fb29a9b80a9da86d752373521d1daafd4f28fe08b20b4fe5a34a394419-Screenshot_2026-01-27_at_4.27.34_PM.png" className="border" />
...
<Image align="center" border={true} width="75% " src="https://files.readme.io/230bb2181ab759417f36452acdf96ceb2750c7336341c1eb765c3427aea26ff5-Send_Invite_Link.gif" className="border" />
...
<Image align="center" border={true} src="https://files.readme.io/993e67d-users_list.png" className="border" />
...
<Image align="center" border={true} src="https://files.readme.io/d04ca8a-Export_users.png" className="border" />
...
<Image align="center" border={true} width="85% " src="https://files.readme.io/b2fb957034a9234063a0f6eb91537a0f827fe710873fed294acbe82f41ae01c7-Editing_Instructions_Guide.gif" className="border" />
...
Existing access for user <tom@gmail.com>:
...
1. In the User Management UI, hover over **More actions**.\
   ...
   <Image align="center" border={true} src="https://files.readme.io/e278a4ce4d02cdbd7b98ea8ff1f0da6846c3a7c817b2d358b5450a37ba90748a-bulk_update.png" className="border" />
2. Select **Bulk update** users.\
   The bulk update page appears.

   <Image align="center" border={true} src="https://files.readme.io/5f0ed2b1ce0ffde88c7a1ce7ccf8d65ad696f827b136c79ee52c250216bc586d-bulk_update_append_overwrite.png" className="border" />
...
<Image align="center" border={true} width="65% " src="https://files.readme.io/12f0f3cbc93f7b9b4434cd360887a1ada0366c62e231307e79b46a2f0de2d39e-warning-overwrite.png" className="border" />
...
5. Upload the CSV file by dragging it into the upload area or selecting it from your system.\
   ...
   <Image align="center" border={true} src="https://files.readme.io/ce66076a44baea22986c7dd29617b87a8c824b6da87334721e7f1cc8c896de50-Upload_csv.png" className="border" />
...
<Image align="center" border={true} caption="Mix of valid and invalid entries" src="https://files.readme.io/302018d5df79a7925dd3b987307236185f370d34d821f934ab738b010f4e62bf-bulkuserupdateDownloadFile.png" width="80% " />

**All invalid entries**

<Image align="center" border={true} caption="All invalid entries" src="https://files.readme.io/0d759d6bb47847eab1c9a5a22f15e0bc705a04f34e5555c6f59956a6d1a22eae-AllInvalid.png" />
...
7. (Optional) To replace the uploaded CSV file:
   1. Click **❌** next to the file name.\
      ...
      <Image align="center" border={true} src="https://files.readme.io/9d563341e54330cf0cf1c6ac20a5642cdf49ae3947689d16431f5492a7a60446-FileNamecross.png" className="border" />
   2. Click **Yes, change file**.

      <Image align="center" border={true} width="50% " src="https://files.readme.io/578f81f8d33a5e823ea31e81fcf7ae2779f0e8bfe550b4a53f58fe3e53e4b50f-ChangeFileConfirmation.png" className="border" />
   3. Upload the new CSV file by dragging it into the upload area or selecting it from your system.
8. Click **Update valid user(s)** to update the valid users.

<Image align="center" border={true} src="https://files.readme.io/a04b80c12965a3bb0a81a4f277ae932c111923843f28baad50685dccaf2123ff-UpdateValidUsers.png" className="border" />
...
<Image align="center" border={true} src="https://files.readme.io/c61fe72-Screenshot_2024-05-14_at_9.59.43_PM.png" className="border" />
...
1. In the User Management UI, hover over **More actions**.\
   ...
   <Image align="center" border={true} src="https://files.readme.io/d96d22b614b5c89a01ef8502f17bbb73dab01d3fd4f96b2d721f6b10ce980b66-bulk_remove_users.png" className="border" />
2. Select **Bulk remove users**.\
   The bulk removal page opens.

   <Image align="center" border={true} src="https://files.readme.io/9447178663e4db830ae3cb6d13776811f86756fdf6bfbf9bf43bd520886bc441-bulk_remove_users_page.png" className="border" />
3. Upload the CSV file by dragging it into the upload area or selecting it from your system.\
...
<Image align="center" border={true} caption="Scenario with all invalid entries" src="https://files.readme.io/27dd82b42152e194c16ac57c280253e7f67439d42be64c9fb5d1539d899e22c2-complete_failure.png" />

<br />

<Image align="center" border={true} caption="Scenario with a mix of valid and invalid entries" src="https://files.readme.io/f958000cb71632fe6032f75ddee28156941c1d42da921b707b33b963e51f3f98-Validation_partial_fail.png" />
...
4. Click **Remove users** to delete the valid users.\
   ...
   <Image align="center" border={false} width="50% " src="https://files.readme.io/0db75c5c18b0ac0b0bc550ff8ee18b8b014a6552ee203f863bf7c21eeb3b0a12-Confirmation.png" />
