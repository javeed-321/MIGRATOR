...
# Manage Permission for Users in Multiple Organizations
...
Tom does not have access to the Capillary Technologies organization.
...
## Viewing multiple organization users in the new user management
...
2. Click on **Settings** icon at the top-left corner of the page.\
   ...
   <Image align="center" border={true} src="https://files.readme.io/be15f56a3c78e4e8e4d9776652ff5da159fd6c3c49e8552fb700fe444cfca6ae-mutli_org_toggle.png" className="border" />

<br />

3. Use the toggle switch **Include Multiple Organization Users** to enable or disable multiple organization user visibility:

* Toggle OFF → Only original users of the selected organization will be displayed.
* Toggle ON → Users created in another organization, but having access to the current organization, are visible.

<Image align="center" border={true} src="https://files.readme.io/6f1be10616f2351a90069732c54e20468ee36c8fbf4a0fdbd6987bd0c6561141-toggle.png" className="border" />
