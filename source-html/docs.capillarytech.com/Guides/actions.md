...
<Image align="center" border={true} width="80% " src="https://files.readme.io/945631dbaaef1d47405152eb01493ef29b59f69b44e9175fa800d947af081874-image.png" className="border" />
...
<Image align="center" border={true} width="80% " src="https://files.readme.io/dd86435cca08e21427a664169b22e0a801f0e833dfa75f69c2192e68515db395-Screenshot_2025-09-03_at_5.05.47_PM.png" className="border" />
     ...
     <tbody>
       <tr>
         ...
         <td style={{ textAlign: "left" }}>
           ...
           For example, issue 10 points per transaction
         </td>
       </tr>
       ...
       <tr>
         ...
         <td style={{ textAlign: "left" }}>
           Define a points range and reward customers with points and round their balance to the nearest multiple.

           For example, if the points range is from 0-1000 and the **round upto** value is 10 units, a customer with 643 points will receive 7 points, bringing their total balance to 650, irrespective of their transaction amount.
         </td>
       </tr>
       ...
       <tr>
         ...
         <td style={{ textAlign: "left" }}>
           Reward a fixed number of points based on a fixed transaction range. Points issued are multiplied based on the transaction range.

           For example: Issue 5 points on every transaction of $150. This way, a transaction amount between $0-150 receives 5 points, and transactions between 151-300 receive 10 points and so on.
         </td>
       </tr>
     </tbody>
   </Table>
6. To have a common allocation to all tiers, check the **Same for all Tiers**.
   ...
   <Image align="center" border={true} width="80% " src="https://files.readme.io/13edf548ae8aa362f75842740e285dad40b3d7232949263d82f1f56bfc2678be-Screenshot_2025-09-03_at_5.06.40_PM.png" className="border" />
...
* You need to set the number of days after which points are accrued in **Accrue points after**. An example is shown in the following screenshot.
  ...
  <Image align="center" border={true} width="80% " src="https://files.readme.io/f259b594eea7e95e3255a0aca71d26bce667b07ce46eff97231e61a2ec7df595-Screenshot_2025-09-03_at_5.07.16_PM.png" className="border" />
...
<Image alt="Mandatory Channels" border={false} src="https://files.readme.io/a9fb95a-MandatoryChannels.png" />
...
<Image align="center" border={true} width="80% " src="https://files.readme.io/e94128e86fdd7de8f91d7233e7be6bc0de8a02e7e3677926e4fdcafe661695dc-Screenshot_2025-09-03_at_5.05.00_PM.png" className="border" />
...
<Image alt="Forward to Set" border={false} src="https://files.readme.io/ad36405-LDaxbpQ7QHB2TRoU8NrcMjptr-iDoj8IhA.png" />
...
<Table align={["left","left"]}>
  ...
  <tbody>
    <tr>
      ...
      <td>
        Enable this to write conditions for line-items.
      </td>
    </tr>
    ...
    <tr>
      ...
      <td>
        <div>
          Enable this to write conditions for payment methods or tenders.
...
<Image alt="Line Item Unrolling" border={false} src="https://files.readme.io/a93fb85-tog_VIK2U16ig9kWjteXVTznONNU1ybgdA.png" />
...
>
> * When line item unrolling is enabled, the rules in the forwarded set are evaluated once per line item. **Tracker evaluation is not supported in a forwarded set where line item unrolling is enabled** — the tracker requires the original transaction-level context, which is no longer available after unrolling. Configuring a tracker evaluation action in this setup causes the transaction to end in a partial success and the tracker will not update. To use a tracker in this flow, disable line item unrolling in the tracker ruleset.
...
>
> <Image alt="Forward to Set Example" border={false} src="https://files.readme.io/a2102d5-AOWvcueJ4CHnNiL5fMvup2sv_5DuCbPEYg.png" />
...
<Image align="center" border={true} src="https://files.readme.io/1a0581e-fIx04qRUPZhpYHMzJLuKaejGeW-MDtOXVg.png" className="border" />
  ...
  <tbody>
    ...
    <tr>
      ...
      <td>
        ...
        **Note:**  Always ensure the target type in your action matches the target type (individual or unified)defined in your rule logic for successful point issuance.
      </td>
    </tr>
...
<Image align="center" border={true} src="https://files.readme.io/a2893c04e9a3d4d2c2b409ac8ce932c7669672d7742c15d03bbaea4e1834c8df-d7231629c007110aa9ca38236725d23742af525e8bc51994235f4f4393bce754-Untitled-2.gif" className="border" />
...
<Image align="center" border={true} width="30% " src="https://files.readme.io/2eb0fc4-Capture.PNG" className="border" />

2. After you select **Renew Tier**, you will see the following screen. Click on the **Save** option.

<Image align="center" border={true} width="80% " src="https://files.readme.io/3dd470b-Capture2.PNG" className="border" />
...
<Image align="center" border={true} width="30% " src="https://files.readme.io/10e7ae8-Send_mail_action.png" className="border" />

2. Click on **Add creative** to configure the email message.

<Image align="center" border={true} width="30% " src="https://files.readme.io/e8db430-Add_Creative_-_Send_mail.png" className="border" />
...
<Image align="center" border={true} width="80% " src="https://files.readme.io/64b9491-CretiveTemplates.png" className="border" />
...
<Image align="center" border={false} width="30% " src="https://files.readme.io/3c848b1-SenderID_Config.png" />
...
<Image align="center" border={false} width="30% " src="https://files.readme.io/1dd6f79-DelayConfig.png" />
...
7. Select **Save**.
   ...
   <Image align="center" border={true} width="80% " src="https://files.readme.io/3d67ad2ad83baa6bbf357f99f9771717a2f635a6e10f14bb99906243b737f8c0-image.png" className="border" />
...
<Image alt="Send Communication" border={false} src="https://files.readme.io/7ce919255298ddcbfd9737023f053504b9810e348c253632851416560b502ac7-image.png" />
...
<Image alt="Send Mobile Push" border={false} src="https://files.readme.io/868e3d9-Capture.PNG" />

2. Click on **Add creative** to configure the mobile push message.

<Image alt="Add Mobile Push Creative" border={false} src="https://files.readme.io/6d0dc63-Capture1.PNG" />

3. Choose one account for which you want to configure the mobile push message

<Image alt="Choose Account" border={false} src="https://files.readme.io/c0fb84d-Capture2.PNG" />

4. To create the message from scratch, click **Create new**.
   To use an existing template, hover on the desired template and click **Select**.

<Image alt="Mobile Push Templates" border={false} src="https://files.readme.io/9ea1814-Capture3.png" />
...
<Image alt="Mobile Push Message" border={false} src="https://files.readme.io/7a1b6b2-Capture4.PNG" />
...
<Image alt="Add Label" border={false} src="https://files.readme.io/1b08ea6-Capture5.png" />

ii. Select **Upload Image** to set the cover image of the push notification message.

<Image alt="Upload Image" border={false} src="https://files.readme.io/e1c3084-Capture6.PNG" />
...
<Image alt="Action Link" border={false} src="https://files.readme.io/0b84a9a-Capture7.PNG" />

iv. Check **Add primary button to notification** to enter a CTA (Call to action) label.

<Image alt="Primary Button" border={false} src="https://files.readme.io/99b6571-Capture8.PNG" />

v. Check **Add secondary button to notification** to enter a secondary CTA (Call to action) label.

<Image alt="Secondary Button" border={false} src="https://files.readme.io/dd368b8-Capture9.PNG" />
...
<Image alt="Mobile Push Delay" border={false} src="https://files.readme.io/0f2b9ff-Capture11.PNG" />

ii. Choose your preferred period in the drop-down - Sec, Mins, Hours, or Days.
iii. In Delay by entering the duration.

<Image alt="Delay Duration" border={false} src="https://files.readme.io/a82a1ab-Capture10.png" />
...
<Image alt="Send SMS Action" border={false} src="https://files.readme.io/3cdbca7-SMS1.PNG" />

2. Click on **Add creative** to configure the SMS.

<Image alt="Add SMS Creative" border={false} src="https://files.readme.io/fa657b5-SMS2.PNG" />

3. To create the message from scratch, click **Create new**.
   To use an existing template, hover on the desired template and click **Select**.

<Image alt="SMS Templates" border={false} src="https://files.readme.io/b3890f4-SMS3.png" />
...
<Image alt="SMS Configuration" border={false} src="https://files.readme.io/dc0093c-SMS5.PNG" />
...
<Image alt="SMS Sender ID" border={false} src="https://files.readme.io/d4db426-SMS6.PNG" />

6. Select **Shorten all URLs** to shorten links used in SMS,

<Image alt="Shorten URLs" border={false} src="https://files.readme.io/9bce0eb-Capture7.PNG" />
...
<Image alt="SMS Delay" border={false} src="https://files.readme.io/cd07040-SMS4.PNG" />
...
<Image alt="Transaction Point Allocation" border={false} src="https://files.readme.io/fdc9915-Capture.PNG" />
...
<Image alt="Earn Condition Selection" border={false} src="https://files.readme.io/3aaaabf-Untitled1.png" />
...
<Image alt="Zero Earn Condition" border={false} src="https://files.readme.io/5987ed8-Untitled2.png" />
...
<Image alt="Expiry Condition Selection" border={false} src="https://files.readme.io/6841eed-Untitled3.png" />
...
<Image alt="Points Rounding Strategy" border={false} src="https://files.readme.io/086d85e-Untitled5.png" />
...
<Image alt="Transaction Accrual Strategies" border={false} src="https://files.readme.io/aabfd04-Untitled6.png" />

**Following are the accrual strategies available for behavioral event-based activities:**

<Image alt="Behavioral Event Accrual Strategies" border={false} src="https://files.readme.io/9a49bb5-Screenshot_2024-08-07_at_11.18.13_AM.png" />
...
* **Bill Number Prefix:** When the bill number starts with a prefix defined in the `IGNORE_POINTS_FOR_BILL_NUMBER_STARTS_WITH` configuration.
  ...
  <Image alt="Bill Number Config" border={false} src="https://files.readme.io/5989db268d0c55407f1e6ea73b31b3d2e94402a27196a92089c849a3250d197a-Config.png" />
...
<Image align="center" border={true} src="https://files.readme.io/fd72b5d391b9a144455adac5d2f64164d4fe2eb612145dea75e79462ab171cf2-image.png" className="border" />
...
<Image alt="Priority Channels Configuration" border={false} src="https://files.readme.io/e9efd45-Untitled8.png" />
...
<Image alt="Upgrade to Tier" border={false} src="https://files.readme.io/cf128cc-Capture.PNG" />
...
<Image alt="Slab to Upgrade" border={false} src="https://files.readme.io/4ee2e31-Untitled.png" />
...
<Image alt="Upgrade Tier Validity" border={false} src="https://files.readme.io/6cb784489042928185957499c5be7f9efebd65124c68d287d301fa5886d88863-image.png" />
...
<Image alt="Award Points" border={false} src="https://files.readme.io/06fcfcf-Capture3.PNG" />

4. In the **Earn condition**, choose the desired condition from the drop-down list.
   To create a new condition, click on **+ Add Condition**.

<Image alt="Tier Earn Condition" border={false} src="https://files.readme.io/39c48b9-Capture4.png" />

5. Select the **Expiry condition** from the drop-down menu.
   To create a new expiry earn condition from scratch, click **+ Add condition**.

<Image alt="Tier Expiry Condition" border={false} src="https://files.readme.io/d7e139a-Capture5.png" />
...
<Image alt="Tier Prorate On" border={false} src="https://files.readme.io/5d87797-capture6.png" />
...
<Image alt="Tier Mandatory Channels" border={false} src="https://files.readme.io/1aaf99f-capture7.png" />
...
<Image alt="Tier Priority Channels" border={false} src="https://files.readme.io/fb21729-capture8.png" />
...
<Image alt="Upgrade Using Tier" border={false} src="https://files.readme.io/407cf91-Upgrade_using_tiers.png" />
...
<Image alt="Upgrade Using Tier Configuration" border={false} src="https://files.readme.io/652e7eb-Upgrade_using_tiers3.png" />
...
<Image alt="Issue Coupon using Quantity" border={false} src="https://files.readme.io/0f05a18e2275d108382e5a742bd742d184844f3d62efd62cb32935faa2b48537-image.png" />
...
<Image alt="Fixed Quantity Same" border={false} src="https://files.readme.io/4ef794ef99653d8b679cf91c59d0d8efa4bf90f5d57886649400462824c50f52-FixedQuant_Same.png" />

<Image alt="Fixed Quantity Same Process" border={false} src="https://files.readme.io/81a702661fe10f3981078deccd0d90e24c35ca440344bd5dfac702c533d65834-fq-same.gif" />
...
<Image alt="Fixed Quantity Different" border={false} src="https://files.readme.io/93aac7c5ba13debc93cb0bc44f8a1fd31dc4a0f58fa47e7f84040b14a191c6f3-FixedQuant_Diff.png" />

<Image alt="Fixed Quantity Different Process" border={false} src="https://files.readme.io/40295715c74cd3332f35e6663b0881fb5a6601b866b1f4ca064defa5743d7b75-fq-diff.gif" />
...
>
> <Image alt="Transaction Step Function Note" border={false} src="https://files.readme.io/18dc783e50b86523c623ea1a7a95827baf465f0602b1aaa5b8d8521efe439faa-image.png" />
...
<Image alt="Transaction Step Function Same" border={false} src="https://files.readme.io/abb74eeacda9a159ff0943fb38607c585d4ddfb14628af55aa76e0c889941abe-TSF_Same.png" />

<Image alt="Transaction Step Function Same Process" border={false} src="https://files.readme.io/801a868f8aa7fc30feb321b41a2664a4bf6893c5d7d1186b6f7d9efd5c57356c-tsf-same.gif" />
...
<Image alt="Transaction Step Function Different" border={false} src="https://files.readme.io/45612273564622265ed4de30888aff4ac824731a7f75687a03ae8a21157a8a1e-TSF_Diff.png" />

<Image alt="Transaction Step Function Different Process" border={false} src="https://files.readme.io/0d8b94e4fbd4669ae120b57b7e38afd2278bd8af9a8ebf3a73d1578e6c57ce8c-tsf-diff.gif" />

> ❗️ The maximum number of coupon that can be allocated to the customer is **500**.
>
> <Image alt="Maximum Coupon Limit" border={false} src="https://files.readme.io/53d0231113f86e7f5f1a69d1ffb6aab0aa4237b04654988a8c0c3fa60181f552-image.png" />
...
<Image alt="Issue Catalog Reward Action" border={false} src="https://files.readme.io/e69886b22b7847c78591f38b56f754155011af7e5a351a302e30b8b3bbb45665-image.png" />

2. Click **Save**.
   The **Add action: Issue catalog reward** window opens.

   <Image alt="Issue Catalog Reward Note" border={false} src="https://files.readme.io/30ee4ed6c4272691d34b8455d7fe3b81d6347fb971f3b9879a9c5c80d82cba0d-note_issue_catalog.png" />
...
<Image alt="Add Manually" border={false} src="https://files.readme.io/cec3a8f5385d8e2dbf9998d7ea97bdb2095778e8e98d5379c708f388ac6483c3-image.png" />
...
<Image alt="Transaction Extended Field" border={false} src="https://files.readme.io/7e5f872ec980d6e4f1a18f1c5ac5d579967e12e3dd795c73eaa5f695f982a0a7-image.png" />
...
<Image alt="Points Issued on Event" border={false} src="https://files.readme.io/05c1c49e0c1db39b8117711a60284ff8fa1388555f86543f9ee0a71ddd79299b-image.png" />
...
9. Select a mapping type from the **Mapping type** drop down.
   ...
   <Image alt="Mapping Type" border={false} src="https://files.readme.io/9f3a579733ffee58a56cf416dbba54617e24fa86c377b1786877364f902f6bca-image.png" />
...
<Image align="center" border={true} width="40% " src="https://files.readme.io/d248215-Screenshot_2024-01-08_at_5.40.36_PM.png" className="border" />
...
<Image align="center" border={true} width="80% " src="https://files.readme.io/80afd2b-Screenshot_2024-01-08_at_5.40.52_PM.png" className="border" />

You'll find that configured action in the display once it is done.

<Image align="center" border={true} width="80% " src="https://files.readme.io/2452025-Screenshot_2024-01-08_at_5.41.09_PM.png" className="border" />
...
<Image align="center" border={true} width="80% " src="https://files.readme.io/e267f33762b846feaa107ec33b5f40949101c9d081edd6d048050b2e2c79cde6-Untitled.gif" className="border" />
...
<Image align="center" border={true} width="80% " src="https://files.readme.io/c465e1dfe814a3ecc1ccbe7e9a5ffdfd1562f82cda6e098bda67e54e427b9fb3-image.png" className="border" />
