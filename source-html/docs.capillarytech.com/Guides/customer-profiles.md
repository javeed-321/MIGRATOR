...
For customers registered using dataimport,  External IDs will not be generated automatically. </Callout>
...
<Image alt="473" border={false} src="https://files.readme.io/ac7769b-setup_import.png" title="setup import.png" />
...
GOLDPHY2TT12311,GOLDPHY2,NOT\_ISSUED,1234,8765433279,<xyz@abc.com>,WA8765433279,1234234,E34334
...
<Image alt="508" border={false} src="https://files.readme.io/cbf5247-import.png" title="import.png" />
...
<Image alt="503" border={false} src="https://files.readme.io/6a9d8fe-configure.png" title="configure.png" />
...
<Image align="center" border={true} width="smart" src="https://files.readme.io/388f942-TemplateConfiguration.png" className="border" />
...
<Image alt="588" border={false} src="https://files.readme.io/47ef9f7-setup.png" title="setup.png" />
...
<Image alt="450" border={false} src="https://files.readme.io/86613bb-email.png" title="email.png" />
...
> **Note:** The Loyalty Customers import profile updates standard customer fields and custom fields. It does not update tracker values. To import tracker data, use the [Trackers import profile](https://docs.capillarytech.com/docs/other-import-profiles#trackers) instead. Note that the Trackers profile supports only `bill` and `lineitem` tracker types; importing with a `points` tracker type will fail with an "Invalid tracker type" error.
...
Tom,Sawyer,9900111111,<tom.sawyer@capllary.com>,lb67p,mal

**Template Configuration**

<Image alt="820" border={false} src="https://files.readme.io/d8fbb3e-submitttt.png" title="submitttt.png" />
...
Updates made using the Subscription Service import template with `orgUnitId = -1` apply to non-InStore source profiles and do not update the InStore profile’s subscription status in the users table. The Members export template derives subscription data specifically from the InStore profile. As a result, when subscriptions are updated using `orgUnitId = -1`, the Members export may continue to display outdated or `NOT-SET` subscription values, even though the subscription was successfully updated for other profiles. </Callout>

<Image alt="1036" border={false} src="https://files.readme.io/ae88265-profit.png" title="profit.png" />

**Template Configuration**

<Image alt="273" border={false} src="https://files.readme.io/01d6804-subm.png" title="subm.png" />
...
<Table align={["left","left"]}>
  ...
  <tbody>
    ...
    <tr>
      ...
      <td>
        Mobile number of the customer. This is required if  Select the user input type in _Template Configuration is Mobile._
      </td>
    </tr>
...
<Image align="center" alt="450" border={true} src="https://files.readme.io/1142374-none.png" className="border" />
...
<Image align="center" border={true} width="75% " src="https://files.readme.io/7f4389144d304529a32f78bc39df01ed5a3bdb8cb55c63473a4f68682ad5c472-v.png" className="border" />
...
<Table align={["left","left"]}>
  <thead>
    <tr>
      <th>
        Field (Fields marked with an asterisk (*) are mandatory)
      </th>
  ...
  <tbody>
    ...
    <tr>
      ...
      <td>
        The source where the customer was created.
      </td>
    </tr>
    ...
    <tr>
      ...
      <td>
        The unique account ID of the customer.
      </td>
    </tr>
    ...
    <tr>
      ...
      <td>
        ...
        The valid identifier types are: `wechat, martjackId, cuid, fbid, unionId, fcmToken, line.`  
        For WebEngage, use the cuid identifier type, which represents the mobile number.
      </td>
    </tr>
