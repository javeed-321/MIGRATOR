...
<Image alt="Step Function Points Allocation" border={false} src="https://files.readme.io/a67215c-1.png" />
...
<Image alt="Step Function Coupon Allocation" border={false} src="https://files.readme.io/ee8db07-2.png" />
...
<Image alt="Points Transfer Limits" border={false} src="https://files.readme.io/d84dc4d-3.1.png" />
...
<Image border={false} src="https://files.readme.io/f8c2671-screen-capture_1.gif" />
...
You can use the /v2/referral/validate API to check if a referral code is valid for a campaign. This API validates the referral code based on its creation date and the campaign's start and end dates.

**How it works**

* When you call the /v2/referral/validate API with a referral code, the system checks if the code exists and if its creation date falls within the campaign's active period.
* If the referral code's creation date is outside the campaign's start and end dates, the API returns the code as invalid, even if the code exists.
* This validation is enforced at runtime for every request.

**API response**

* If the referral code is valid:
  ```json
  {"valid": true, "referrer": <referrer_id>}
  ```
* If the referral code is invalid due to date validation or does not exist:
  ```json
...
* Use this API to confirm referral code validity before applying rewards or benefits in your referral program workflows.
* This helps prevent the use of expired or future-dated referral codes.

**Recommendation**

* Always validate referral codes using this API before processing referrals to ensure compliance with campaign rules.
...
<Image alt="Delayed Accrual 0 Days" border={false} src="https://files.readme.io/fbd6620-unnamed.png" />
...
<Image alt="Expire Promised Points" border={false} src="https://files.readme.io/f94e9ee-Screenshot_2023-03-07_at_5.45.01_PM.png" />
...
<Image alt="Milestone Return Notification" border={false} src="https://files.readme.io/dde59a4-Screenshot_2023-04-03_at_3.37.26_PM.png" />
...
<Image alt="Milestone Achieved Value" border={false} src="https://files.readme.io/96f43fd-Screenshot_2023-04-03_at_4.04.33_PM.png" />
...
<Image alt="Behavioral Event UserGroup2" border={false} src="https://files.readme.io/a824e34-Screenshot_2023-04-03_at_4.04.47_PM.png" />
...
<Image alt="PointsIssued Remarks" border={false} src="https://files.readme.io/9f7c51a-Screenshot_2023-04-03_at_4.05.03_PM.png" />
...
<Image alt="Coalition Subscription UI" border={false} src="https://files.readme.io/b3be50e-Screenshot_2023-04-03_at_4.05.15_PM.png" />
...
<Image border={false} src="https://files.readme.io/4d9cb38-screen-capture-_19__1.gif" />
...
<Image alt="Retro Transaction Date" border={false} src="https://files.readme.io/48ba7e5-Screenshot_2023-04-13_at_12.12.46_PM.png" />
...
<Image alt="Target Inactive Periods" border={false} src="https://files.readme.io/b51daf2-Screenshot_2023-04-14_at_10.28.20_AM.png" />
...
<Image alt="Sub-target Points Issued" border={false} src="https://files.readme.io/53b690f-image_1.png" />
...
<Image align="center" alt="Above images are mere samples to indicate possible customer views and not product view" border={false} caption="Above images are mere samples to indicate possible customer views and not product view" src="https://files.readme.io/4d66269-Screenshot_2023-02-14_at_6.14.54_PM.png" />
...
<Image align="center" alt="Above image is indicative and final product views can be completely different" border={false} caption="Above image is indicative and final product views can be completely different" src="https://files.readme.io/31bae74-Screenshot_2023-02-14_at_6.42.32_PM.png" />
...
<Image align="center" alt="Above images are mere samples to indicate possible customer views and not product view" border={false} caption="Above images are mere samples to indicate possible customer views and not product view" src="https://files.readme.io/e448499-Screenshot_2023-02-14_at_6.46.36_PM.png" />
...
<Image alt="Rewards Catalog Member Care" border={false} src="https://files.readme.io/a9cc18f-image1.png" />
...
<Image border={false} src="https://files.readme.io/3d0e126-Screenshot_2023-03-21_at_12.26.33_PM.png" />

Top 10 rewards based on decreasing order of currency redeemed

<Image border={false} src="https://files.readme.io/4093e5c-image2.png" />

Top 10 rewards based on decreasing order of number of rewards purchased

<Image border={false} src="https://files.readme.io/5803148-image4.png" />
...
<Image align="center" alt="Image 1: Evaluation log of the cart, option to release the cart" border={false} caption="Image 1: Evaluation log of the cart, option to release the cart" src="https://files.readme.io/9b10b5f-Screenshot_2023-02-14_at_6.54.37_PM.png" />

<Image align="center" alt="Image 2: Cart discarded/released" border={false} caption="Image 2: Cart discarded/released" src="https://files.readme.io/2ccee30-Screenshot_2023-02-14_at_6.54.43_PM.png" />
...
<Image alt="Promotion Stacking Order" border={false} src="https://files.readme.io/98c399e-Screenshot_2023-04-10_at_8.20.23_PM.png" />

<Image border={false} src="https://files.readme.io/f81c124-Screenshot_2023-04-10_at_8.22.45_PM.png" />

For orgs that are not using promotion stacking order, all types of promotions will be available for stacking.

<Image border={false} src="https://files.readme.io/048f5a6-Screenshot_2023-04-10_at_8.43.01_PM.png" />
...
<Image alt="Coupon Reversal Status" border={false} src="https://files.readme.io/07c971a-Screenshot_2023-02-14_at_7.06.42_PM.png" />
...
<Image alt="Offers by Region" border={false} src="https://files.readme.io/700e6a1-Screenshot_2023-04-10_at_7.31.35_PM.png" />

<Image alt="Offers by Region 2" border={false} src="https://files.readme.io/3a74b95-Screenshot_2023-04-10_at_7.31.55_PM.png" />
...
<Image border={false} src="https://files.readme.io/03d76bf-1.png" />

* At any step of the journey, add a jump action. Add a block name and a destination journey

<Image border={false} src="https://files.readme.io/37dd94c-2.png" />
...
<Image align="center" alt="Status, Entry trigger and Duration of the destination journey will be displayed upon selecting the journey. You can click on ‘Go to journey’ to open the destination journey in a new tab." border={false} caption="Status, Entry trigger and Duration of the destination journey will be displayed upon selecting the journey. You can click on ‘Go to journey’ to open the destination journey in a new tab." src="https://files.readme.io/9153799-3.png" />
...
<Image border={false} src="https://files.readme.io/155f0b9-4.png" />
...
<Image border={false} src="https://files.readme.io/7d1b09c-5.png" />
...
<Image border={false} src="https://files.readme.io/b18c34e-6.png" />
...
<Image border={false} src="https://files.readme.io/a2b9818-7.png" />
...
<Image align="center" alt="Note that you cannot delete or change the name of event/attribute supported by Capillary" border={false} caption="Note that you cannot delete or change the name of event/attribute supported by Capillary" src="https://files.readme.io/72e7843-8.png" />
...
<Image border={false} src="https://files.readme.io/e4c5637-9.png" />
...
<Image border={false} src="https://files.readme.io/b6e3bb7-10.png" />
...
<Image align="center" alt="You can either select the stores from the drop-down or upload with the help of csv. Both cannot be done simultaneously" border={false} caption="You can either select the stores from the drop-down or upload with the help of csv. Both cannot be done simultaneously" src="https://files.readme.io/b93d7d4-11.png" />
...
<Image border={false} src="https://files.readme.io/d6bfd06-12.png" />
...
<Image border={false} src="https://files.readme.io/1039a0e-13.png" />
...
<Image align="center" alt="These settings are configurable only in draft/edit state and not when a journey is live" border={false} caption="These settings are configurable only in draft/edit state and not when a journey is live" src="https://files.readme.io/694a93c-14.png" />
...
<Image border={false} src="https://files.readme.io/eb5bfe9-image.png" />
...
<Image border={false} src="https://files.readme.io/1908800-image.png" />
...
<Image border={false} src="https://files.readme.io/fa3b4e6-image.png" />
...
<Image alt="PII Deletion Template" border={false} src="https://files.readme.io/fdcb5fb-Connect_PII_deletion.gif" />
...
<Image alt="SFTP Migration Template" border={false} src="https://files.readme.io/15e86d7-SFTP.gif" />
