...
An **email template** refers to a pre-designed email layout that includes predefined structure, formatting, and placeholders such as <Anchor label="tags" target="_blank" href="https://docs.capillarytech.com/docs/custom-tags">tags</Anchor> and <Anchor label="labels" target="_blank" href="https://docs.capillarytech.com/docs/labels">labels</Anchor>, and sometimes sample content. Templates help maintain brand consistency and reduce the time required to create emails.
...
The ability to save an email template without an unsubscribe tag depends on the `EMAIL_UNSUBSCRIBE_TAG_MANDATORY` configuration. If this setting is disabled, you must include a valid unsubscribe tag to save the template. If enabled, the template can be saved without it. To make any changes to this setting, raise a Jira ticket to the Product Support team. </Callout>
...
3. **Select the editor for creating the template.** You can choose from the following options:
   ...
   * <Anchor label="**HTML Editor**" target="_blank" href="https://docs.capillarytech.com/docs/configure-email#creating-an-email-using-the-html-editor">**HTML Editor**</Anchor> –  Use the basic HTML editor to write and format your email content. If you already have ready HTML, you can copy and paste it directly into the editor.
   * <Anchor label="**Drag and drop Editor**" target="_blank" href="https://docs.capillarytech.com/docs/configure-email#creating-an-email-using-the-drag--drop-editor">**Drag and drop Editor**</Anchor> –Create the email template using the visual drag-and-drop editor. This editor is disabled by default. Raise a ticket with the PST team to enable this option for your organization.
   * <Anchor label="**Upload ZIP File**" target="_blank" href="https://docs.capillarytech.com/docs/configure-email#creating-an-email-by-uploading-a-zip-file">**Upload ZIP File**</Anchor> –  Upload a ZIP file containing the HTML file and associated images for the template.

   <Image align="center" border={true} width="75% " src="https://files.readme.io/a116093402b3c45425e51a98e99dd3900c09e2c2dd10a472c851a20b3e36138f-email-html-editor-google-docs.png" className="border" />
4. Select **Start from Scratch**.
5. Enter the subject and configure the email content based on the editor selected.
6. Click **Create**. To see a preview, select <Anchor label="**Preview and Test**" target="_blank" href="https://docs.capillarytech.com/docs/test-and-preview-across-engagement-channels">**Preview and Test**</Anchor>.
...
3. Click **update**. To see a preview, select <Anchor label="**Preview and Test**" target="_blank" href="https://docs.capillarytech.com/docs/test-and-preview-across-engagement-channels">**Preview and Test**</Anchor>.

The email template has been edited successfully.

<Image align="center" border={true} width="75% " src="https://files.readme.io/9eb232b0d80e13269b6a3b6af04b5894b7c3eec09997a31e02692c4f5a4781b4-gif_18.gif" className="border" />

# Creating an Email using the HTML editor

You can create an email template using the HTML editor either from the **Creatives** section or from the **campaign message creation flow**. The HTML editor allows you to write email content directly in HTML or paste prebuilt HTML and preview it in real time. You can also write or paste <Anchor label="Liquid expressions" target="_blank" href="https://docs.capillarytech.com/docs/add-dynamic-content-using-liquid">Liquid expressions</Anchor> within the HTML to personalize the email content.

**Note**: If you want to switch to the CK editor, raise a Jira ticket to the Product Support team to enable it for your organization.

<Callout icon="🚧" theme="warn">
  **Important**

Use **email-compatible** **HTML** when creating templates. Follow standard email best practices such as [table-based layouts](https://www.geeksforgeeks.org/html/html-tables/) and [inline CSS](https://www.geeksforgeeks.org/css/inline-css/) to ensure consistent rendering across email clients. Avoid CSS frameworks, external stylesheets, and scripts. </Callout>
...
4. Enter the email subject in the **Subject** field. To insert dynamic values, select **<Anchor label="+ Add label" target="_blank" href="https://docs.capillarytech.com/docs/labels">+ Add label</Anchor>** to include the required labels in the subject.
...
<Image align="center" border={true} width="75% " src="https://files.readme.io/c7be9db3ed52029d92ecc439f44284f5f1b9e742ad8a89dace5b90aade3d9f9d-Untitled_design_13.gif" className="border" />

6. Select **<Anchor label="+ Add label" target="_blank" href="https://docs.capillarytech.com/docs/labels">+ Add label</Anchor>** and place the label at the required position in the HTML code to insert dynamic values in the email body.
...
7. Review validation warnings displayed at the bottom of the editor. For each issue listed, select the **arrow icon** next to the warning to navigate directly to the corresponding line in the HTML editor where the fix is required.
   ...
   * **Warnings**: Displays HTML and content-level validation warnings, including formatting issues such as indentation, spacing, or syntax-related recommendations, unclosed CSS rules, and missing required attributes (for example, missing `alt` attributes for `<img>` elements)
   ...
   <Image align="center" border={true} width="75% " src="https://files.readme.io/3ee2a73c2017e2159528466caf6b078756024f2fe723df6a2ea4ff9041227606-giffs.gif" className="border" />
...
4. The HTML Editor modal opens. The options available in this modal are the same as those provided when <Anchor label="creating an email template using the HTML Editor" target="_blank" href="https://docs.capillarytech.com/docs/configure-email#creating-an-email-using-the-html-editor">creating an email template using the HTML Editor</Anchor>.
...
<Image align="center" border={true} width="80% " src="https://files.readme.io/3a8c980ff895251bccf0edaaa161c5953fdd7351949af8d85e89d107145f185c-gifyyzzx.gif" className="border" />
...
**Note**: If required, inbuilt templates in the **Drag & drop editor**can be hidden for your organization. Raise a Jira ticket to the PST team to configure this setting.

<Image align="center" border={true} width="75% " src="https://files.readme.io/b30442162fbfb9ac329ea74615d74be719417626c529e6a6b2c3376494c054ee-image.png" className="border" />

To create an email template using the drag and drop editor, follow the steps below:

### <Anchor label="Step 1:Build the Email layout and content" target="_blank" href="https://docs.capillarytech.com/docs/configure-email#building-the-email-layout-and-content">Step 1:Build the Email layout and content</Anchor>

### <Anchor label="Step 2: Add Personalization and dynamic content" target="_blank" href="https://docs.capillarytech.com/docs/configure-email#add-personalization-and-dynamic-content">Step 2: Add Personalization and dynamic content</Anchor>

### <Anchor label="Step 3: Configure Email appearance (Settings tab)" target="_blank" href="https://docs.capillarytech.com/docs/configure-email#configuring-email-appearance-settings-tab">Step 3: Configure Email appearance (Settings tab)</Anchor>

### <Anchor label="Step 4: Review and save the email template" target="_blank" href="https://docs.capillarytech.com/docs/configure-email#review-and-save-the-email-template">Step 4: Review and save the email template</Anchor>
...
<Image align="center" border={true} width="75% " src="https://files.readme.io/efdd87ca13721a40bc281f0a2b3cdb9ef761d6f57159e5e4878a88fd90ea12b3-email-html-editor-google-docs_2.png" className="border" />
...
<Image align="center" border={true} width="75% " src="https://files.readme.io/8ede991413f910531a0992573e83913cb296b2aa276cdd171c015368e3758586-image.png" className="border" />
...
* Add text with <Anchor label="labels" target="_blank" href="https://docs.capillarytech.com/docs/labels">labels</Anchor> and tags, and then apply formatting. You must include an unsubscribe tag in all email content. You can also customize the unsubscribe message's landing page using [Vulcan](https://docs.capillarytech.com/docs/creating-a-microsite-using-vulcan#/).
  ...
  iv. Ensure that Liquid loops and dynamic tags remain within the correct HTML structure and that all required variables are present in the payload. If dynamic tags (for example, `coupon.standard_image_1`) cannot be resolved due to template changes or missing variables, email delivery may fail. </Callout>
* Add images
* Personalize the message with the <Anchor label="Liquid language" target="_blank" href="https://docs.capillarytech.com/docs/add-dynamic-content-using-liquid#/">Liquid language</Anchor>. Applicable for the email subject and body. When writing Liquid code, use straight quotes (' or ") only. Curly quotes (“ ”) will break your template.

  For example -\
  Correct expression: `{% if slab_name == 'Platinum' %}`\
  Incorrect expression: `{% if slab_name == “Platinum” %}`
* Add dynamic headers and footers. Add dynamic headers and footers. You can also use an organisation's custom fields to apply dynamic elements, such as headers and footers, that are specific to that organisation. This is helpful in a connected organisation setup. For more information, refer to the documentation on <Anchor label="Adding Dynamic Content Using Custom Fields" target="_blank" href="https://docs.capillarytech.com/docs/add-dynamic-content-using-custom-fields">Adding Dynamic Content Using Custom Fields</Anchor>.
* Add a <Anchor label="barcode" target="_blank" href="https://docs.capillarytech.com/docs/configure-email#barcode-in-email">barcode</Anchor> that contains the customer's loyalty identification information. You can include this barcode in customer registration emails, updates, or campaign messages. For more information, refer to the section on <Anchor label="Adding barcodes for emails" target="_blank" href="https://docs.capillarytech.com/docs/configure-email-content#barcode-in-email">Adding barcodes for emails</Anchor>.

<Image align="center" border={true} width="75% " src="https://files.readme.io/629af1fe418a5c3d2caf030625cb6a4c4ff848220398f0d4be3a46a57eb6d131-email-html-editor-google-docs_4.png" className="border" />
...
<Image align="center" border={true} width="75% " src="https://files.readme.io/4ae02cf70ecba80ab0e3a5fb412dfa5fb345e217d802c4898847e36cf7427992-image.png" className="border" />
...
1. Select **<Anchor label="Preview and Test" target="_blank" href="https://docs.capillarytech.com/docs/test-and-preview-across-engagement-channels">Preview and Test</Anchor>** to populate values for any tags and labels, review the rendered content, and send test messages to test customers before sending the email.
...
<Image align="center" border={true} width="65% " src="https://files.readme.io/4be352ad4081d8ee246e92b04d8da99838ef1623910c37cdf2a7f8c59bd84aad-image.png" className="border" />

2. Select **New message** to create a new email creative.

<Image align="center" border={true} width="65% " src="https://files.readme.io/e9a055806609f4c5a60615ca0b42f10afb358cd8fc171529c14b2704391c1072-image.png" className="border" />

3. In the **Content** section, select **Add creative**.

<Image align="center" border={true} width="65% " src="https://files.readme.io/1c6aca9720da6cb3c144ddf35ffcb714d0da588c67c2322083149af6b4e18c66-image.png" className="border" />

4. Navigate to the **Email** tab and click **Create new**.

<Image align="center" border={true} width="65% " src="https://files.readme.io/d020a7a68091d72b4d3a7e6b7b7d175c2d2e09634a088917040867aac7f02c75-image.png" className="border" />

5. Click **Drag & drop editor** and click **Continue**.

<Image align="center" border={true} width="75% " src="https://files.readme.io/d1d992f83823db4df7c147bd948b0b62218d245f5b608d5a79030e2a4d72c388-image.png" className="border" />

6. Select a template of your choice.

<Image align="center" border={true} width="65% " src="https://files.readme.io/119d0e479581826e793ba63ec8ca75b7f664b85d7b3b26dfb449ea78a13cf4ff-image.png" className="border" />

7. In the email body, click **Add label** and select Customer barcode label.

<Image align="center" border={true} width="75% " src="https://files.readme.io/f174f918b4c66cecf1d6e51fd875840ffdb6319dcc88d31f3ad70073d355c5b6-image.png" className="border" />

8. Embed the `{{customer_barcode}}` tag in your email template.

<Image align="center" border={true} width="180px" src="https://files.readme.io/01a62dc4c0ff74986957539fedd107858d038c798caf338be4c144309fd11a52-image.png" className="border" />
...
<Image align="center" border={true} caption="An example of how the unsubscribe landing page will look when customized for French language." src="https://files.readme.io/09002de767ba7d045df072b1c1e7a23f19017c2f89d6e1c59414511ac32d8e21-image_4.png" width="50% " />
