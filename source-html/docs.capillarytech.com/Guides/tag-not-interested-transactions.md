...
<Image align="center" className="border" width="50% " border={true} src="https://files.readme.io/d469cee-Billing_config.png" />
...
<Image align="center" className="border" width="smart" border={true} src="https://files.readme.io/638c493-_Hhb8hKGcQAXPEihkpc00MF5i5LNQqHeJA.png" />
...
<Image align="center" className="border" width="smart" border={true} src="https://files.readme.io/3f62a80-QMC55daTQsIVu7lzTcKvxp6frx8FlMfQqQ.png" />

5. Click **Search**.

<Image align="center" className="border" width="smart" border={true} src="https://files.readme.io/aa4290f-U6oZpgLg6vMf40nz1RcRR8zL-eromU_wCw.png" />
...
<Image align="center" className="border" width="smart" border={true} src="https://files.readme.io/fe4f42e-ablAtIflpN4weGAfxkD1saL49aDP3ppirw.png" />
...
<Image align="center" className="border" width="smart" border={true} src="https://files.readme.io/d53e44c-5gL18DHEaUbl72ZMaRAK_h1VbKYUZ4aIog.png" />
...
<Image align="center" className="border" width="smart" border={true} src="https://files.readme.io/aa274af-PvoKu3_l4CRjsVrnVSORPbKF8ZAyRC6oDw.png" />
...
<Image align="center" width="70% " src="https://files.readme.io/86f04f3-Screenshot_2023-04-14_at_11.32.51_AM.png" />

Now, let's take the above same scenario, however this time the claim happens in next year.

<Image align="center" className="border" width="70% " border={true} src="https://files.readme.io/f51f741-Screenshot_2023-04-14_at_11.33.37_AM.png" />