...
1. In the **Connect-to-FTP** <Glossary>Block</Glossary>, enter the FTP location where the file is present and the location for saving the processed file. For information on this block. Refer to the <Anchor label="Connect to source" target="_blank" href="https://docs.capillarytech.com/docs/connect-to-source#/">Connect to source</Anchor> documentation.

<Image align="center" border={true} width="75% " src="https://files.readme.io/2adce57e1b604d1c346a03d02ec8c946159532a2fb63ea0e6dfef04e11cc7ba8-Screenshot_2025-12-10_at_4.27.18_PM.png" className="border" />
...
2. In the **Push-To-S3**, enter the S3 block details. For more information, refer to <Anchor label="Push to S3 " target="_blank" href="https://docs.capillarytech.com/docs/push-to-s3#/">Push to S3 </Anchor>.

<Image align="center" border={true} src="https://files.readme.io/bf9c0a2145f4bd85138473ea484a0c063623cfdc3fdc8f45990f5d0bbf3d1937-Screenshot_2025-12-10_at_4.46.22_PM.png" className="border" />
...
<Image align="center" border={true} width="80% " src="https://files.readme.io/b4bf045ec993b0ad815857ac94772ab3fbe8153f4818213d2b7c9bccaeb40063-Screenshot_2025-12-10_at_5.03.12_PM.png" className="border" />
...
<Image align="center" border={true} width="75% " src="https://files.readme.io/b658f9ffdc157951e760f0cd5e587f9868d5e12f89310d8ccc921fefabea2b2c-Screenshot_2025-12-10_at_5.22.32_PM.png" className="border" />
