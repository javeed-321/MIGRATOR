...
1. In **Customers can modify preference by**, choosing *Sending an SMS* and configuring other fields as explained in the table below
...
![NcFVlGu7gtc7\_7DhrtQKqGdqcZWrknysvg.jfif ](https://files.readme.io/cd180e6-NcFVlGu7gtc7_7DhrtQKqGdqcZWrknysvg.jfif)

1. **Define the trans\_unsub\_shortcode to be given a missed call**: Specify the shortcode to which customers want to give a missed call to out out of transactional SMSs
...
![uxJvJEho-HQnpGSoE\_GStxThHWBV\_Vc7Gw.png ](https://files.readme.io/ee2a148-uxJvJEho-HQnpGSoE_GStxThHWBV_Vc7Gw.png)
...
![n70sH\_zjttOUnFABs3otZNQ\_PwsVnxyceA.png ](https://files.readme.io/04821bf-n70sH_zjttOUnFABs3otZNQ_PwsVnxyceA.png)
...
When a user clicks a *Subscribe* or *Unsubscribe* link in an email, a success or failure message is sent. You can control the language of these messages using the config CONF\_ORG\_SUBSCRIPTION\_UPDATE\_MSG. By default, this config is not enabled. To enable, create a ticket with the Capillary Product Support team.
