...
| dim_campaign_delivery_status_id | bigint | Unique identifier assigned to the campaign delivery status. Possible values are - Sent, Delivered, Not_delivered, Failed, etc. | campaign_ delivery_statusLink | Yes; Dimension Name: Campaign Delivery Status > Status Id |
...
| dim_communication_type_id | bigint | Type of communication. Possible values are - Test and Control. | communication_type Link | Yes; Dimension Name: Communication Type > Id |
...
| dim_unsubscription_status_id | bigint | Unique id generated by the system for the unsubscription status. Indicates if the customer has unsubscribed or not. | unsubscription_status Link | Yes; Dimension Name: Unsubscription Status > Id |
